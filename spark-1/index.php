...
<head>
  ...
  <title><?= tr('meta.spark1.title') ?></title>
  <meta name="description" content="<?= tr('meta.spark1.desc') ?>" data-i18n-meta="meta.spark1.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.spark1.title'),'desc'=>tr('meta.spark1.desc')]); ?>
</head>
<body>
...
<header class="hero" style="background:var(--bg-off);">
  <div>
    ...
    <div class="hero-chips" style="display:flex;flex-wrap:nowrap;gap:12px;align-items:center;margin-top:20px;">
      <span class="chip" style="white-space:nowrap;"><span class="chip-dot"></span><span data-i18n="s1.chip1"><?= tr('s1.chip1') ?></span></span>
      <span class="chip" style="white-space:nowrap;"><span class="chip-dot"></span><span data-i18n="s1.chip2"><?= tr('s1.chip2') ?></span></span>
...
<div class="trust-bar">
  ...
  <div class="trust-item"><strong data-i18n="s1.trust1"><?= tr('s1.trust1') ?></strong> · <span data-i18n="s1.trust1.suf"><?= tr('s1.trust1.suf') ?></span></div>
  <div class="trust-item"><strong data-i18n="s1.trust2"><?= tr('s1.trust2') ?></strong> · <span data-i18n="s1.trust2.suf"><?= tr('s1.trust2.suf') ?></span></div>
  <div class="trust-item"><strong data-i18n="s1.nantes"><?= tr('s1.nantes') ?></strong></div>
...
<section class="intro-section">
  <div class="intro-text reveal">
    ...
    <h2><span data-i18n="s1.intro.h1a"><?= tr('s1.intro.h1a') ?></span> <em data-i18n="s1.intro.h1b"><?= tr('s1.intro.h1b') ?></em></h2>
<div style="display:flex;align-items:center;gap:8px;margin-top:12px;font-size:14px;color:var(--text-mid);">
          ...
          <span data-i18n="s1.intro.range"><?= tr('s1.intro.range') ?></span>
        </div>
    <p data-i18n="s1.intro.body"><?= tr('s1.intro.body') ?></p>
...
<section class="pillars-section" style="background:var(--bg-off);">
  <div class="pillars-header reveal">
    ...
    <p class="section-body" data-i18n="s1.why.body"><?= tr('s1.why.body') ?></p>
  </div>
  <div class="pillars-grid">
    <div class="pillar-card reveal"><div class="pillar-icon">🔗</div><h3 data-i18n="s1.p1.title"><?= tr('s1.p1.title') ?></h3><p data-i18n="s1.p1.desc"><?= tr('s1.p1.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">🌱</div><h3 data-i18n="s1.p2.title"><?= tr('s1.p2.title') ?></h3><p data-i18n="s1.p2.desc"><?= tr('s1.p2.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">⚡</div><h3 data-i18n="s1.p3.title"><?= tr('s1.p3.title') ?></h3><p data-i18n="s1.p3.desc"><?= tr('s1.p3.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">🔌</div><h3 data-i18n="s1.p4.title"><?= tr('s1.p4.title') ?></h3><p data-i18n="s1.p4.desc"><?= tr('s1.p4.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">📱</div><h3 data-i18n="s1.p5.title"><?= tr('s1.p5.title') ?></h3><p data-i18n="s1.p5.desc"><?= tr('s1.p5.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">📊</div><h3 data-i18n="s1.p6.title"><?= tr('s1.p6.title') ?></h3><p data-i18n="s1.p6.desc"><?= tr('s1.p6.desc') ?></p></div>
  </div>
</section>
...
<section class="specs-section" id="spark1-specs">
  <div class="specs-layout">
    <div class="specs-list">
      ...
      <div class="spec-row"><span class="spec-name" data-i18n="s1.spec.temp"><?= tr('s1.spec.temp') ?></span><span class="spec-val"><?= tr('s1.spec.temp.v') ?></span></div>
      <div class="spec-row"><span class="spec-name" data-i18n="s1.spec.mount"><?= tr('s1.spec.mount') ?></span><span class="spec-val"><?= tr('s1.spec.mount.v') ?></span></div>
      ...
      <div class="spec-row"><span class="spec-name" data-i18n="s1.spec.warranty"><?= tr('s1.spec.warranty') ?></span><span class="spec-val"><?= tr('s1.spec.warranty.v') ?></span></div>
    </div>
  ...
  <div class="sk-wrap">
    <div class="pilot-layout">
      ...
      <div class="pilot-features">
        ...
        <p data-i18n="s1.pilot.body"><?= tr('s1.pilot.body') ?></p>
        <ul class="feature-list">
          <li data-i18n="s1.pilot.li1"><?= tr('s1.pilot.li1') ?></li>
          <li data-i18n="s1.pilot.li2"><?= tr('s1.pilot.li2') ?></li>
          <li data-i18n="s1.pilot.li3"><?= tr('s1.pilot.li3') ?></li>
          <li data-i18n="s1.pilot.li4"><?= tr('s1.pilot.li4') ?></li>
        </ul>
...
<section class="compare-banner">
  <div class="compare-banner-text">
    <h3 data-i18n="s1.cmp.h3"><?= tr('s1.cmp.h3') ?></h3>
    <p data-i18n="s1.cmp.body"><?= tr('s1.cmp.body') ?></p>
  </div>
  <div class="compare-cards">
    <div class="compare-card current"><div class="compare-card-name" data-i18n="gamme.s1.name"><?= tr('gamme.s1.name') ?></div><div class="compare-card-sub" data-i18n="pilot.cmp.sub1"><?= tr('pilot.cmp.sub1') ?></div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);" data-i18n="s1.cmp.current"><?= tr('s1.cmp.current') ?></div></div>
    <a class="compare-card" href="/spark-plus/"><div class="compare-card-name" data-i18n="gamme.s2.name"><?= tr('gamme.s2.name') ?></div><div class="compare-card-sub" data-i18n="pilot.cmp.sub2"><?= tr('pilot.cmp.sub2') ?></div><div class="compare-card-badge" data-i18n="ui.discover"><?= tr('ui.discover') ?></div></a>
    <a class="compare-card" href="/spark-go-e/"><div class="compare-card-name" data-i18n="gamme.s3.name"><?= tr('gamme.s3.name') ?></div><div class="compare-card-sub" data-i18n="pilot.cmp.sub3"><?= tr('pilot.cmp.sub3') ?></div><div class="compare-card-badge" data-i18n="ui.discover"><?= tr('ui.discover') ?></div></a>
  </div>
</section>
...
<section class="faq-section" style="background:var(--bg-off);padding:72px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    ...
    <h2 class="section-title" style="margin-bottom:36px;" data-i18n="s1.faq.h2"><?= tr('s1.faq.h2') ?></h2>
    <div class="faq-list">
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="s1.faq.q1"><?= tr('s1.faq.q1') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="s1.faq.a1"><?= tr('s1.faq.a1') ?></p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="s1.faq.q2"><?= tr('s1.faq.q2') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="s1.faq.a2"><?= tr('s1.faq.a2') ?></p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="s1.faq.q3"><?= tr('s1.faq.q3') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="s1.faq.a3"><?= tr('s1.faq.a3') ?></p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="s1.faq.q4"><?= tr('s1.faq.q4') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="s1.faq.a4"><?= tr('s1.faq.a4') ?></p></div></div>
    </div>
  </div>
</section>
<section class="cta-close">
  <div class="made-tag" data-i18n="s1.cta.tag"><?= tr('s1.cta.tag') ?></div>
  <h2 class="section-title" data-i18n="s1.cta.h2a"><?= tr('s1.cta.h2a') ?><br><em data-i18n="s1.cta.h2b"><?= tr('s1.cta.h2b') ?></em></h2>
  <p class="section-body" data-i18n="s1.cta.body"><?= tr('s1.cta.body') ?></p>
