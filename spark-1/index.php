...
<head>
  ...
  <title>Spark 1 — Prise renforcée supervisée 3,7 kW | Sparklin</title>
...
<header class="hero" style="background:var(--bg-off);">
  <div>
    ...
    <h1 data-i18n="s1.hero.h1"><?= tr('s1.hero.h1') ?><em data-i18n="s1.hero.h1b"><?= tr('s1.hero.h1b') ?></em> du marché.</h1>
    <p class="hero-sub">La Spark 1 est la prise de recharge lente de Sparklin : connectée, supervisée via Spark Pilot, et pensée pour accompagner la mobilité douce et décarbonée. Charge lente, impact faible, service complet.</p>
    <div class="hero-actions">
      <a href="/contact/" class="btn-primary" data-i18n="pilot.hero.cta1"><?= tr('pilot.hero.cta1') ?></a>
      <a href="#spark1-specs" class="btn-outline" data-i18n="splus.hero.cta2"><?= tr('splus.hero.cta2') ?></a>
    </div>
    <div class="hero-chips" style="display:flex;flex-wrap:nowrap;gap:12px;align-items:center;margin-top:20px;">
      <span class="chip" style="white-space:nowrap;"><span class="chip-dot"></span>Prise connectée renforcée</span>
      <span class="chip" style="white-space:nowrap;"><span class="chip-dot"></span>90% des incidents r&eacute;solus &agrave; distance</span>
      
    </div>
  </div>
  <div class="hero-visual">
    <img class="hero-img-main" src="/assets/images/prise-connectee-8.jpg" alt="Spark 1 — Prise renforcée connectée 3,7 kW Sparklin"/>
  </div>
</header>

<!-- ══ TRUST BAR ══ -->
<div class="trust-bar">
  <div class="trust-item"><strong data-i18n="gamme.s1.chip2"><?= tr('gamme.s1.chip2') ?></strong></div>
  <div class="trust-item"><strong data-i18n="s1.trust1"><?= tr('s1.trust1') ?></strong> · Supervisée</div>
  <div class="trust-item"><strong data-i18n="s1.trust2"><?= tr('s1.trust2') ?></strong> · Cycle de vie ×6</div>
  <div class="trust-item"><strong data-i18n="s1.trust3"><?= tr('s1.trust3') ?></strong></div>
  <div class="trust-item"><strong data-i18n="gamme.s1.chip1"><?= tr('gamme.s1.chip1') ?></strong> · Charge lente</div>
</div>
...
<section class="intro-section">
  <div class="intro-text reveal">
    <span class="section-label" data-i18n="s1.intro.h2"><?= tr('s1.intro.h2') ?></span>
    <h2>La recharge lente, <em data-i18n="s1.intro.h1b"><?= tr('s1.intro.h1b') ?></em></h2>
<div style="display:flex;align-items:center;gap:8px;margin-top:12px;font-size:14px;color:var(--text-mid);">
          <span style="color:var(--orange);font-weight:700;">✓</span>
          100 km d'autonomie récupérés en 4h
        </div>
    <p>La Spark 1 n'est pas une simple prise renforcée. Elle est connectée à Spark Pilot pour être supervisée à distance, redémarrée sans intervention, et intégrée dans un load balancing global avec toutes vos autres bornes.</p>
    <ul class="feature-list">
      <li data-i18n="s1.trust.c1"><?= tr('s1.trust.c1') ?></li>
      <li data-i18n="s1.trust.c2"><?= tr('s1.trust.c2') ?></li>
      <li data-i18n="s1.trust.c3"><?= tr('s1.trust.c3') ?></li>
      <li data-i18n="s1.trust.c4"><?= tr('s1.trust.c4') ?></li>
    </ul>
  </div>
  <div class="intro-image reveal">
    <img src="/assets/images/borne-exterieur-entree.jpg" alt="Spark 1 installée à l'entrée d'un parking" loading="lazy"/>
  </div>
</section>
...
<section class="pillars-section" style="background:var(--bg-off);">
  <div class="pillars-header reveal">
    <div>
      <span class="section-label" data-i18n="s1.why.h2"><?= tr('s1.why.h2') ?></span>
      <h2 class="section-title" data-i18n="s1.why.sub"><?= tr('s1.why.sub') ?></h2>
    </div>
    <p class="section-body">La Spark 1 ne cherche pas à maximiser la puissance. Elle cherche à maximiser l'utilité — pour le bon usage, au bon endroit, avec le bon niveau de technologie.</p>
  </div>
  <div class="pillars-grid">
    <div class="pillar-card reveal"><div class="pillar-icon">🔗</div><h3 data-i18n="s1.p1.title"><?= tr('s1.p1.title') ?></h3><p>Contrairement aux prises classiques, la Spark 1 est connectée en temps réel. Supervision, redémarrage à distance, historique de sessions — tout depuis Spark Pilot.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">🌱</div><h3 data-i18n="s1.p2.title"><?= tr('s1.p2.title') ?></h3><p>Cycle de vie 6&times; moins impactant qu'une borne de charge acc&eacute;l&eacute;r&eacute;e. La Spark 1 est la borne la plus durable de l'&eacute;cosyst&egrave;me.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">⚡</div><h3 data-i18n="s1.p3.title"><?= tr('s1.p3.title') ?></h3><p>Déployez 50 Spark 1 sans renforcement EDF. Spark Pilot répartit automatiquement la puissance entre toutes vos prises selon les sessions actives.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">🔌</div><h3 data-i18n="s1.p4.title"><?= tr('s1.p4.title') ?></h3><p>Compatible avec toutes les voitures électriques et deux-roues électriques du marché français et européen — voitures, scooters, vélos cargo.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">📱</div><h3 data-i18n="s1.p5.title"><?= tr('s1.p5.title') ?></h3><p>Vos utilisateurs démarrent leur session depuis l'app Sparklin — sans badge, sans manipulation. QR code sur la borne ou Plug &amp; charge.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">📊</div><h3 data-i18n="s1.p6.title"><?= tr('s1.p6.title') ?></h3><p>Supervisez vos Spark 1 aux côtés de vos Spark Plus et go-e depuis un seul tableau de bord Spark Pilot — load balancing cross-borne inclus.</p></div>
  </div>
</section>

<!-- ══ SPECS ══ -->
<section class="specs-section" id="spark1-specs">
  <div class="specs-layout">
    <div class="specs-list">
      <span class="section-label" data-i18n="s1.specs.h2"><?= tr('s1.specs.h2') ?></span>
      <h2 class="section-title" data-i18n="gamme.s1.name"><?= tr('gamme.s1.name') ?></h2>
      <div class="spec-row"><span class="spec-name">Puissance</span><span class="spec-val">3,7 kW monophasé · 16 A</span></div>
      <div class="spec-row"><span class="spec-name">Connecteur</span><span class="spec-val">Type E (FR) / Type F (EU)</span></div>
      <div class="spec-row"><span class="spec-name">Communication</span><span class="spec-val">WiFi + 4G</span></div>
      <div class="spec-row"><span class="spec-name">Protocole</span><span class="spec-val">OCPP 1.6 &amp; 2.0</span></div>
      <div class="spec-row"><span class="spec-name">Identification</span><span class="spec-val">QR code · App Sparklin · badge RFID</span></div>
      <div class="spec-row"><span class="spec-name">Protection</span><span class="spec-val">IP66 et IK10</span></div>
      <div class="spec-row"><span class="spec-name">Certifications</span><span class="spec-val">CE, NF C 61-314, IEC 60884-1, …</span></div>
      <div class="spec-row"><span class="spec-name">Température</span><span class="spec-val">-20°C à 40°C</span></div>
      <div class="spec-row"><span class="spec-name">Montage</span><span class="spec-val">Mural ou sur potelet</span></div>
      <div class="spec-row"><span class="spec-name" data-i18n="contact.certs"><?= tr('contact.certs') ?></span><span class="spec-val">CE · EDF Pulse</span></div>
      <div class="spec-row"><span class="spec-name">Garantie</span><span class="spec-val">2 ans · Support inclus</span></div>
    </div>
    <div class="specs-images">
      <img src="/assets/images/prise-connectee-6.jpg" alt="Spark 1 — vue produit" loading="lazy"/>
      <img src="/assets/images/prise-connectee-7.jpg" alt="Spark 1 — détail connecteur" loading="lazy"/>
    </div>
  </div>
</section>
  ...
  <div class="sk-wrap">
    <div class="pilot-layout">
      <div class="pilot-screens">
        <div class="pilot-screen"><img src="/assets/images/dashboard-imac.jpg" alt="Spark Pilot — supervision iMac" loading="lazy"/></div>
      ...
      <div class="pilot-features">
        <span class="section-label">Spark Pilot inclus</span>
        <h2>Supervisée depuis<br><em>votre tableau de bord.</em></h2>
        <p>La Spark 1 remonte toutes ses données en temps réel vers Spark Pilot : sessions, consommation, alertes. Redémarrez à distance, planifiez des plages de charge, exportez vos données.</p>
        <ul class="feature-list">
          <li>✓ Sessions et consommation par borne</li>
          <li>✓ Alertes et redémarrage à distance</li>
          <li>✓ Load balancing avec Spark Plus et go-e</li>
          <li>✓ Export CSV et rapports mensuels</li>
        </ul>
        <div style="margin-top:24px;text-align:center;">
          <a href="/spark-pilot/" class="btn-primary" style="display:inline-block;" data-i18n="feat.cta"><?= tr('feat.cta') ?></a>
        </div>
      </div>
    </div>
  </div>
...
<section class="compare-banner">
  <div class="compare-banner-text">
    ...
    <p>La Spark 1 est idéale pour les stationnements longue durée. Pour des fonctionnalités premium (MID, QR anti-fraude, écran), découvrez la Spark Plus.</p>
  </div>
  <div class="compare-cards">
    <div class="compare-card current"><div class="compare-card-name" data-i18n="gamme.s1.name"><?= tr('gamme.s1.name') ?></div><div class="compare-card-sub">3,7 kW · Prise supervisée</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);">Votre page</div></div>
    ...
    <a class="compare-card" href="/spark-go-e/"><div class="compare-card-name" data-i18n="gamme.s3.name"><?= tr('gamme.s3.name') ?></div><div class="compare-card-sub">7–22 kW · Accélérée</div><div class="compare-card-badge" data-i18n="ui.discover"><?= tr('ui.discover') ?></div></a>
  </div>
</section>
...
<section class="faq-section" style="background:var(--bg-off);padding:72px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    ...
    <div class="faq-list">
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>La Spark 1 est-elle supervisée ou simplement connectée ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>La Spark 1 est pleinement supervisée depuis Spark Pilot : sessions en temps réel, consommation, alertes de panne, redémarrage à distance. Elle va bien au-delà d'une simple prise connectée.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Peut-on mixer des Spark 1 avec des Spark Plus sur un même site ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Oui. Toutes les bornes Sparklin partagent la même plateforme Spark Pilot. Le load balancing fonctionne entre Spark 1, Spark Plus et go-e — quel que soit le mix de votre parc.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>La Spark 1 est-elle compatible avec les deux-roues électriques ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Oui. La Spark 1 propose un connecteur Type E (standard français) et Type F (standard européen) — compatibles avec toutes les voitures électriques, scooters et vélos cargo.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Quelle est la différence avec la Spark Plus ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>La Spark Plus ajoute un compteur MID certifié (facturation opposable), un écran e-ink, et le Plug &amp; charge . La Spark 1 est l'option éco-conçue pour les cas où la supervision suffit sans besoin de facturation au kWh.</p></div></div>
    </div>
  </div>
</section>
<section class="cta-close">
  <div class="made-tag">🔌 Spark 1 &nbsp;·&nbsp; Éco-conçue à Nantes, France</div>
  <h2 class="section-title">Équipez votre parking.<br><em>Demandez un devis.</em></h2>
  <p class="section-body">Nos équipes vous répondent sous 48h.</p>
