...
.ev-future {
  ...
  border-radius: 20px;
  overflow: hidden;
  box-shadow: 0 8px 32px rgba(232,86,58,.08);
  transition: box-shadow .2s, transform .2s;
}
.ev-future:hover {
  box-shadow: 0 16px 48px rgba(232,86,58,.14);
...
.ev-badge-future { background: rgba(232,86,58,.1); color: var(--orange); border: 1px solid rgba(232,86,58,.25); }
.ev-badge-soon { background: rgba(59,130,246,.08); color: #2563EB; border: 1px solid rgba(59,130,246,.2); }
.ev-h3 {
  font-family: 'Wix Madefor Display', sans-serif;
  font-size: 1.35rem;
  font-weight: 800;
...
.ev-past-card:hover {
  box-shadow: 0 6px 24px rgba(26,26,46,.08);
}
.ev-past-top {
  display: flex;
  align-items: center;
...
.ev-future { grid-template-columns: 1fr !important; }
.ev-date-col { flex-direction: row; gap: 12px; padding: 16px 20px; justify-content: flex-start; }
.ev-date-day { font-size: 1.8rem; }
...
<header class="hero" id="ev-hero">
  <div>
    ...
    <p class="hero-sub">L'équipe Sparklin participe aux principaux événements IRVE, mobilité électrique et environnement de travail. Venez découvrir nos bornes, échanger avec nos experts et explorer les solutions de recharge pour votre organisation.</p>
    ...
    <div class="hero-chips">
      <span class="chip"><span class="chip-dot"></span>Salons IRVE</span>
      <span class="chip"><span class="chip-dot"></span>Démo live des bornes</span>
      <span class="chip"><span class="chip-dot"></span>Rencontres B2B</span>
      <span class="chip"><span class="chip-dot"></span>Collectivités &amp; Entreprises</span>
    </div>
  </div>
        ...
        <div class="ev-body">
          <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
            ...
            <span style="font-size:12px;color:var(--text-mid);">
              ...
              Munich, Allemagne &mdash; Messe München
            </span>
          </div>
          <h3 class="ev-h3">Power To Drive — International EV Charging Expo 2026</h3>
          <p class="ev-desc">Le salon international de référence dédié à l'infrastructure de recharge pour véhicules électriques revient à Munich en 2026. Sparklin y présente ses solutions connectées à destination des gestionnaires de flottes, opérateurs CPO et distributeurs européens. OCPP 2.0, interopérabilité GIREVE, Spark Plus et go-e Pro.</p>
          <div class="ev-tags">
  ...
  <div class="sk-wrap" style="max-width:1060px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:20px;">
      ...
      <div class="ev-past-card">
        ...
        <p style="font-size:13px;color:var(--text-mid);line-height:1.65;margin-bottom:16px;">Porte de Versailles, Paris. Sparklin a présenté ses solutions IRVE pour collectivités et opérateurs CPO. Forts échanges avec élus et directeurs des services techniques.</p>
        <ul class="ev-li">
          <li class="ev-result">🤝 Contacts qualifiés collectivités</li>
          <li class="ev-result">🔌 Demo Spark Plus &amp; Spark Pilot live</li>
          <li class="ev-result">📋 Dossiers ADEME &amp; CSPE présentés</li>
        </ul>
      </div>
      ...
      <div class="ev-past-card">
        ...
        <p style="font-size:13px;color:var(--text-mid);line-height:1.65;margin-bottom:16px;">Salon dédié aux décideurs RH, DAF et DSI. Sparklin y a démontré comment intégrer les bornes de recharge dans la politique mobilité d'entreprise et simplifier les remboursements URSSAF.</p>
        <ul class="ev-li">
          <li class="ev-result">💼 DRH &amp; DAF rencontrés</li>
          <li class="ev-result">📊 Demo remboursement URSSAF automatisé</li>
          <li class="ev-result">🔌 Spark Plus &amp; go-e Pro en présentation</li>
        </ul>
      </div>
...
<section class="cta-close">
  <div class="made-tag">🇫🇷 Nantes &middot; IRVE certifiée EDF &middot; OCPP 1.6/2.0</div>
  <h2 class="section-title">Envie d'un échange <em style="font-style:normal;color:var(--orange)">avant le salon&nbsp;?</em></h2>
  <p class="section-body">Nos experts planifient des créneaux de démonstration sur chaque salon. Contactez-nous pour bloquer un rendez-vous ou obtenir un accès visiteur.</p>
  <div class="cta-close-actions">
    <a href="/contact/" class="btn-primary-light">Contacter l'équipe &rarr;</a>
