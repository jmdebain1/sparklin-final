...
<head>
  ...
  <title><?= tr('meta.pilot.title') ?></title>
  <meta name="description" content="<?= tr('meta.pilot.desc') ?>" data-i18n-meta="meta.pilot.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.pilot.title'),'desc'=>tr('meta.pilot.desc')]); ?>
</head>
<body>
...
<header class="hero pilot-hero">
  <div>
    ...
    <p class="hero-sub" data-i18n="pilot.hero.lead"><?= tr('pilot.hero.lead') ?></p>
    <div style="margin:24px 0;display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
      <span style="font-size:14px;font-weight:600;color:var(--text-mid);" data-i18n="pilot.trust1"><?= tr('pilot.trust1') ?></span>
      <span style="color:var(--border);font-size:14px;">·</span>
      <span style="font-size:14px;font-weight:600;color:var(--text-mid);" data-i18n="pilot.trust2"><?= tr('pilot.trust2') ?></span>
      <span style="color:var(--border);font-size:14px;">·</span>
      <span style="font-size:14px;font-weight:600;color:var(--text-mid);" data-i18n="pilot.trust3"><?= tr('pilot.trust3') ?></span>
    </div>
    <div class="hero-actions">
      <a href="/contact/" class="btn-primary" data-i18n="ui.request_demo"><?= tr('ui.request_demo') ?></a>
      <a href="/app/" class="btn-outline" data-i18n="pilot.app_mobile"><?= tr('pilot.app_mobile') ?></a>
    </div>
  </div>
  ...
  <div class="sk-wrap">
    <div class="pilot-layout">
      ...
      <div class="pilot-features">
        ...
        <p data-i18n="pilot.dash.body"><?= tr('pilot.dash.body') ?></p>
        <ul class="feature-list">
          <li data-i18n="pilot.dash.li1"><?= tr('pilot.dash.li1') ?></li>
          <li data-i18n="pilot.dash.li2"><?= tr('pilot.dash.li2') ?></li>
          <li data-i18n="pilot.dash.li3"><?= tr('pilot.dash.li3') ?></li>
          <li data-i18n="pilot.dash.li4"><?= tr('pilot.dash.li4') ?></li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="intro-section">
  <div class="intro-text reveal">
    ...
    <p data-i18n="pilot.lb.body"><?= tr('pilot.lb.body') ?></p>
    <ul class="feature-list">
      <li data-i18n="pilot.lb.li1"><?= tr('pilot.lb.li1') ?></li>
      <li data-i18n="pilot.lb.li2"><?= tr('pilot.lb.li2') ?></li>
      <li data-i18n="pilot.lb.li3"><?= tr('pilot.lb.li3') ?></li>
    </ul>
  </div>
...
<section class="pillars-section" style="background:var(--bg-off);">
  <div class="pillars-header reveal">
    ...
    <p class="section-body" data-i18n="pilot.feat.body"><?= tr('pilot.feat.body') ?></p>
  </div>
  <div class="pillars-grid">
    <div class="pillar-card reveal"><div class="pillar-icon">📊</div><h3 data-i18n="pilot.f1.title"><?= tr('pilot.f1.title') ?></h3><p data-i18n="pilot.f1.desc"><?= tr('pilot.f1.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">⚡</div><h3 data-i18n="pilot.f2.title"><?= tr('pilot.f2.title') ?></h3><p data-i18n="pilot.f2.desc"><?= tr('pilot.f2.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">💳</div><h3 data-i18n="pilot.f3.title"><?= tr('pilot.f3.title') ?></h3><p data-i18n="pilot.f3.desc"><?= tr('pilot.f3.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">🔗</div><h3 data-i18n="pilot.f4.title"><?= tr('pilot.f4.title') ?></h3><p data-i18n="pilot.f4.desc"><?= tr('pilot.f4.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">👥</div><h3 data-i18n="pilot.f5.title"><?= tr('pilot.f5.title') ?></h3><p data-i18n="pilot.f5.desc"><?= tr('pilot.f5.desc') ?></p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">📱</div><h3 data-i18n="pilot.f6.title"><?= tr('pilot.f6.title') ?></h3><p data-i18n="pilot.f6.desc"><?= tr('pilot.f6.desc') ?></p></div>
  </div>
</section>
...
<section class="compare-banner">
  <div class="compare-banner-text">
    <h3 data-i18n="pilot.cmp.h3"><?= tr('pilot.cmp.h3') ?></h3>
    <p data-i18n="pilot.cmp.body"><?= tr('pilot.cmp.body') ?></p>
    <div style="display:flex;justify-content:center;margin-top:20px;">
      <a href="/contact/" class="btn-primary" style="font-size:14px;padding:12px 24px;" data-i18n="pilot.cmp.cta"><?= tr('pilot.cmp.cta') ?></a>
    </div>
  </div>
  <div class="compare-cards">
    <a class="compare-card" href="/spark-1/"><div class="compare-card-name" data-i18n="gamme.s1.name"><?= tr('gamme.s1.name') ?></div><div class="compare-card-sub" data-i18n="pilot.cmp.sub1"><?= tr('pilot.cmp.sub1') ?></div><div class="compare-card-badge" data-i18n="ui.discover"><?= tr('ui.discover') ?></div></a>
...
<section class="faq-section" style="background:var(--bg-off);padding:72px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    ...
    <h2 class="section-title" style="margin-bottom:36px;" data-i18n="pilot.faq.h2"><?= tr('pilot.faq.h2') ?></h2>
    <div class="faq-list">
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="pilot.faq.q1"><?= tr('pilot.faq.q1') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="pilot.faq.a1"><?= tr('pilot.faq.a1') ?></p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="pilot.faq.q2"><?= tr('pilot.faq.q2') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="pilot.faq.a2"><?= tr('pilot.faq.a2') ?></p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="pilot.faq.q3"><?= tr('pilot.faq.q3') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="pilot.faq.a3"><?= tr('pilot.faq.a3') ?></p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="pilot.faq.q4"><?= tr('pilot.faq.q4') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="pilot.faq.a4"><?= tr('pilot.faq.a4') ?></p></div></div>
    </div>
  </div>
</section>
<section class="cta-close">
  <div class="made-tag" data-i18n="pilot.cta.tag"><?= tr('pilot.cta.tag') ?></div>
  <h2 class="section-title" data-i18n="pilot.cta.h1a"><?= tr('pilot.cta.h1a') ?><br><em data-i18n="pilot.cta.h1b"><?= tr('pilot.cta.h1b') ?></em></h2>
  <p class="cta-close-body" data-i18n="pilot.cta.body"><?= tr('pilot.cta.body') ?></p>
  <div class="cta-close-actions">
    <a href="/contact/" class="btn-primary-light" data-i18n="ui.request_demo"><?= tr('ui.request_demo') ?></a>
    <a href="/app/" class="btn-ghost" data-i18n="pilot.app_mobile"><?= tr('pilot.app_mobile') ?></a>
  </div>
</section>
