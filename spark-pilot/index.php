<?php
/* ══════════════════════════════════════════════════════════════
   sparklin.io — Spark Pilot — Dashboard SaaS
...
<!-- ══ HERO ══ -->
<header class="hero pilot-hero">
  <div>
    <div class="hero-badge" data-i18n="pilot.hero.badge"><?= tr('pilot.hero.badge') ?></div>
    <h1 data-i18n="pilot.hero.h1a"><?= tr('pilot.hero.h1a') ?><br><em data-i18n="pilot.hero.h1b"><?= tr('pilot.hero.h1b') ?></em></h1>
    <p class="hero-sub">Spark Pilot est la plateforme SaaS de Sparklin pour superviser, gérer et optimiser vos bornes de recharge. Tableau de bord en temps réel, load balancing, facturation automatique, gestion des accès — tout depuis une interface unique.</p>
    <div style="margin:24px 0;display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
      <span style="font-size:14px;font-weight:600;color:var(--text-mid);">Gestion de la puissance</span>
      <span style="color:var(--border);font-size:14px;">·</span>
      <span style="font-size:14px;font-weight:600;color:var(--text-mid);">Tarification flexible</span>
      <span style="color:var(--border);font-size:14px;">·</span>
      <span style="font-size:14px;font-weight:600;color:var(--text-mid);">Exports &amp; KPI</span>
    </div>
    <div class="hero-actions">
      <a href="/contact/" class="btn-primary" data-i18n="ui.request_demo"><?= tr('ui.request_demo') ?></a>
      <a href="/app/" class="btn-outline">Voir l'app mobile</a>
    </div>
  </div>
  ...
  <div class="sk-wrap">
    <div class="pilot-layout">
      ...
      <div class="pilot-features">
        ...
        <h2 data-i18n="pilot.dash.h2b"><?= tr('pilot.dash.h2b') ?><br><em data-i18n="pilot.dash.h2c"><?= tr('pilot.dash.h2c') ?></em></h2>
        <p>Nombre de sessions, consommation totale, taux d'usage, revenus, alertes — tout est visible en temps réel.</p>
        <ul class="feature-list">
          <li>✓ Sessions en cours et historique complet</li>
          <li>✓ Consommation par utilisateur et par borne</li>
          <li>✓ Export comptable et rapports URSSAF</li>
          <li>✓ Alertes instantanées par email ou SMS</li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="intro-section">
  <div class="intro-text reveal">
    ...
    <h2 data-i18n="pilot.zero1"><?= tr('pilot.zero1') ?><br><em data-i18n="pilot.zero2"><?= tr('pilot.zero2') ?></em></h2>
    <p>Spark Pilot répartit intelligemment la puissance disponible entre toutes vos bornes en temps réel. Quand 8 voitures chargent simultanément, la puissance s'adapte automatiquement — sans jamais dépasser la capacité souscrite.</p>
    <ul class="feature-list">
      <li>Répartition dynamique et priorisation d'usages</li>
      <li>Compatible avec toutes les bornes Sparklin</li>
      <li>Intégration à votre installation pour un monitoring instantané</li>
    </ul>
  </div>
...
<section class="pillars-section" style="background:var(--bg-off);">
  <div class="pillars-header reveal">
    <div>
      ...
      <h2 class="section-title" data-i18n="pilot.feat.sub"><?= tr('pilot.feat.sub') ?></h2>
    </div>
    <p class="section-body">Spark Pilot centralise l'ensemble des opérations liées à votre parc de recharge — de la supervision temps réel à la conformité réglementaire.</p>
  </div>
  <div class="pillars-grid">
    <div class="pillar-card reveal"><div class="pillar-icon">📊</div><h3 data-i18n="pilot.f1.title"><?= tr('pilot.f1.title') ?></h3><p>Tableau de bord live : sessions actives, consommation, revenus, état de chaque borne, taux de service. Alertes instantanées en cas d'anomalie.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">⚡</div><h3 data-i18n="pilot.f2.title"><?= tr('pilot.f2.title') ?></h3><p>Répartition dynamique de la puissance — aucun renforcement EDF requis, aucun risque de disjonction même en pic de charge.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">💳</div><h3 data-i18n="pilot.f3.title"><?= tr('pilot.f3.title') ?></h3><p>Facturation par kWh, ou forfaitaire. Téléchargez les factures au format numérique en 1 clic.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">🔗</div><h3>Gestion des notes de frais</h3><p>Politique de remboursement et export pour un remboursement des charges à domicile, conforme avec les exigences actuelles et futures de l'URSSAF.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">👥</div><h3>Gestion des accès</h3><p>Créez des communautés de charge, définissez les autorisations par communauté, les conditions de paiement, depuis une interface unique.</p></div>
    <div class="pillar-card reveal"><div class="pillar-icon">📱</div><h3>App mobile incluse</h3><p>L'app Sparklin iOS et Android est incluse pour tous vos utilisateurs — démarrage, suivi et paiement sans badge physique.</p></div>
  </div>
</section>
...
<section class="compare-banner">
  <div class="compare-banner-text">
    <h3>Spark Pilot fonctionne avec toute la gamme</h3>
    <p>Une seule plateforme pour superviser vos prises Spark 1, Spark Plus et bornes go-e — quel que soit le mix de votre parc. Vous avez déjà des bornes et souhaitez les superviser ?</p>
    <div style="text-align:center;margin-top:20px;">
      <a href="/contact/" class="btn-primary" style="font-size:14px;padding:12px 24px;">Migrer mes bornes →</a>
    </div>
  </div>
...
<section class="faq-section" style="background:var(--bg-off);padding:72px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    ...
    <div class="faq-list">
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Spark Pilot est-il inclus dans l'achat d'une borne Sparklin ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>La connectivité de base est incluse. Spark Pilot en version complète — load balancing, facturation automatique, notes de frais — est facturé par borne active.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Puis-je gérer plusieurs sites depuis un seul compte Spark Pilot ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Oui. Spark Pilot prend en charge la gestion multi-sites — chaque site peut avoir ses propres règles de tarification, ses utilisateurs et ses rapports.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Spark Pilot est-il compatible OCPP ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Spark Pilot est compatible OCPP 1.6 et 2.0, et ainsi avec l\'ensemble des bornes connectées.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Comment fonctionne le load balancing ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Spark Pilot monitore en permanence la consommation globale du site et répartit dynamiquement la puissance entre toutes les bornes — sans jamais dépasser la puissance souscrite EDF, sans aucune intervention manuelle.</p></div></div>
    </div>
  </div>
</section>
<section class="cta-close">
  <div class="made-tag">🖥️ Spark Pilot &nbsp;·&nbsp; SaaS IRVE · Made in France</div>
  <h2 class="section-title">Pilotez votre parc.<br><em>Demandez une démo.</em></h2>
  <p class="cta-close-body">Nos équipes vous montrent Spark Pilot en conditions réelles sur votre type de parc.</p>
  <div class="cta-close-actions">
    <a href="/contact/" class="btn-primary-light" data-i18n="ui.request_demo"><?= tr('ui.request_demo') ?></a>
    <a href="/app/" class="btn-ghost">Voir l'app mobile</a>
  </div>
</section>
