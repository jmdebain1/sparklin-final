...
<head>
  ...
  <title><?= tr('blog.lom26.meta_title') ?></title>
  <meta name="description" content="<?= tr('blog.lom26.meta_desc') ?>" data-i18n-meta="blog.lom26.meta_desc"/>
  ...
  <meta name="keywords" content="loi LOM borne recharge entreprise 2026, amende parking non conforme IRVE, obligation borne tertiaire 2026, contrôle DREAL borne"/>
  <script type="application/ld+json">
  {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "headline": "Loi LOM 2026 : ce que votre entreprise risque vraiment si elle n'agit pas avant juillet",
    "description": "Contrôles DREAL actifs, 3 phases de sanctions cumulatives, amendes renouvelables chaque année : le calendrier réel des risques LOM 2026 pour les entreprises.",
    "image": "https://sparklin.io/assets/images/parking-right-web.png",
    "datePublished": "2026-08-12",
    "author": {"@type": "Person", "name": "Mhaia"},
    "publisher": {"@type": "Organization", "name": "Sparklin", "url": "https://sparklin.io"},
    "mainEntityOfPage": {"@type": "WebPage", "@id": "https://sparklin.io/blog/loi-lom-2026-obligations-entreprise-sanctions/"}
  }
  </script>
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('blog.lom26.meta_title'),'desc'=>tr('blog.lom26.meta_desc'),'type'=>'article','image'=>'https://sparklin.io/assets/images/parking-right-web.png','imageAlt'=>tr('blog.lom26.img_hero_alt')]); ?>
</head>
<body>
...
<div style="height:340px;background:#1a1a2e;display:flex;align-items:flex-end;padding:0;position:relative;overflow:hidden;">
  <img src="/assets/images/parking-right-web.png" alt="<?= t('blog.lom26.img_hero_alt') ?>" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.55;"/>
...
<article style="padding:60px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow blog-body">
    <div style="font-size:12px;font-weight:600;color:var(--text-light);letter-spacing:.08em;text-transform:uppercase;margin-bottom:16px;" data-i18n="blog.lom26.div1"><?= tr('blog.lom26.div1') ?></div>

    <h1 style="font-family:var(--font-display);font-size:clamp(1.8rem,3vw,2.6rem);font-weight:800;color:var(--dark);line-height:1.2;margin-bottom:20px;" data-i18n="blog.lom26.h1"><?= tr('blog.lom26.h1') ?></h1>
    ...
    <div data-i18n="blog.lom26.p_intro" style="margin-bottom:32px;"><?= tr('blog.lom26.p_intro') ?></div>

    <h2 id="tableau" data-i18n="blog.lom26.h2_loi"><?= tr('blog.lom26.h2_loi') ?></h2>
    <div data-i18n="blog.lom26.body_loi"><?= tr('blog.lom26.body_loi') ?></div>

    <figure style="margin:32px 0;">
      <img src="/assets/images/prise-connectee-3.jpg" alt="<?= t('blog.lom26.img_inline_alt') ?>" style="width:100%;border-radius:12px;display:block;"/>
      <figcaption style="font-size:12px;color:var(--text-light);margin-top:8px;">Point de charge connecté Sparklin, supervisé en temps réel via Spark Pilot.</figcaption>
    </figure>

    <h2 id="calendrier" data-i18n="blog.lom26.h2_calendrier"><?= tr('blog.lom26.h2_calendrier') ?></h2>
    <div data-i18n="blog.lom26.body_calendrier"><?= tr('blog.lom26.body_calendrier') ?></div>

    <h2 id="erreurs" data-i18n="blog.lom26.h2_erreurs"><?= tr('blog.lom26.h2_erreurs') ?></h2>
    <div data-i18n="blog.lom26.body_erreurs"><?= tr('blog.lom26.body_erreurs') ?></div>

    <h2 id="accompagnement" data-i18n="blog.lom26.h2_accompagnement"><?= tr('blog.lom26.h2_accompagnement') ?></h2>
    <div data-i18n="blog.lom26.body_accompagnement"><?= tr('blog.lom26.body_accompagnement') ?></div>

    <p style="font-size:13px;color:var(--text-light);margin-top:24px;">Pour aller plus loin sur le calendrier complet 2024–2030 et le croisement avec le Décret Tertiaire et la Loi APER, consultez notre <a href="/blog/irve-reglementation-lom-2024/" style="color:var(--orange);">guide de référence sur les obligations LOM</a>.</p>

    <div style="background:var(--dark);border-radius:16px;padding:32px;margin-top:40px;text-align:center;">
      <div style="font-family:var(--font-display);font-size:20px;font-weight:800;color:#fff;margin-bottom:8px;" data-i18n="blog.lom26.cta_title"><?= tr('blog.lom26.cta_title') ?></div>
      <p style="color:rgba(255,255,255,.6);font-size:14px;margin-bottom:20px;line-height:1.7;" data-i18n="blog.lom26.cta_text"><?= tr('blog.lom26.cta_text') ?></p>
      <a href="/contact/" style="display:inline-block;background:var(--orange);color:#fff;padding:14px 28px;border-radius:10px;font-weight:700;text-decoration:none;font-size:15px;" data-i18n="blog.lom26.cta_btn"><?= tr('blog.lom26.cta_btn') ?></a>
    </div>
