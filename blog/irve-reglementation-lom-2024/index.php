...
<head>
  ...
  <title><?= tr('meta.blog_lom.title') ?></title>
  <meta name="description" content="<?= tr('meta.blog_lom.desc') ?>" data-i18n-meta="meta.blog_lom.desc"/>
  ...
  <meta name="keywords" content="loi LOM IRVE, obligations bornes recharge entreprise, décret tertiaire, loi APER, sanctions LOM"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.blog_lom.title'),'desc'=>tr('meta.blog_lom.desc'),'type'=>'article']); ?>
</head>
<body>
...
<article style="padding:60px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow blog-body">
    <div style="font-size:12px;font-weight:600;color:var(--text-light);letter-spacing:.08em;text-transform:uppercase;margin-bottom:16px;" data-i18n="blog.lom.div1"><?= tr('blog.lom.div1') ?></div>

<h1 style="font-family:var(--font-display);font-size:clamp(1.8rem,3vw,2.6rem);font-weight:800;color:var(--dark);line-height:1.2;margin-bottom:20px;" data-i18n="blog.lom.h11"><?= tr('blog.lom.h11') ?></h1>
<div class="blog-byline"><div class="blog-byline-avatar">M</div><span>Par <strong>Mhaia</strong></span><span class="blog-byline-dot"></span><span>2 octobre 2025</span></div>
<p style="font-size:17px;color:var(--text-mid);line-height:1.75;margin-bottom:40px;font-weight:300;" data-i18n="blog.lom.p1"><?= tr('blog.lom.p1') ?></p>

<nav style="background:var(--bg-off);border-radius:12px;padding:20px 24px;margin-bottom:40px;">
  <div style="font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--text-light);margin-bottom:12px;" data-i18n="blog.lom.div2"><?= tr('blog.lom.div2') ?></div>
  <ol style="margin:0;padding-left:20px;display:flex;flex-direction:column;gap:6px;">
    <li style="font-size:14px;" data-i18n="blog.lom.li1"><?= tr('blog.lom.li1') ?></li>
    <li style="font-size:14px;" data-i18n="blog.lom.li2"><?= tr('blog.lom.li2') ?></li>
    <li style="font-size:14px;" data-i18n="blog.lom.li3"><?= tr('blog.lom.li3') ?></li>
    <li style="font-size:14px;" data-i18n="blog.lom.li4"><?= tr('blog.lom.li4') ?></li>
    <li style="font-size:14px;" data-i18n="blog.lom.li5"><?= tr('blog.lom.li5') ?></li>
    <li style="font-size:14px;" data-i18n="blog.lom.li6"><?= tr('blog.lom.li6') ?></li>
    <li style="font-size:14px;" data-i18n="blog.lom.li7"><?= tr('blog.lom.li7') ?></li>
  </ol>
</nav>

<h2 id="lom-presentation" data-i18n="blog.lom.h21"><?= tr('blog.lom.h21') ?></h2>
<p data-i18n="blog.lom.p2"><?= tr('blog.lom.p2') ?></p>
<p data-i18n="blog.lom.p3"><?= tr('blog.lom.p3') ?></p>
<ul>
  <li data-i18n="blog.lom.li8"><?= tr('blog.lom.li8') ?></li>
  <li data-i18n="blog.lom.li9"><?= tr('blog.lom.li9') ?></li>
  <li data-i18n="blog.lom.li10"><?= tr('blog.lom.li10') ?></li>
  <li data-i18n="blog.lom.li11"><?= tr('blog.lom.li11') ?></li>
  <li data-i18n="blog.lom.li12"><?= tr('blog.lom.li12') ?></li>
  <li data-i18n="blog.lom.li13"><?= tr('blog.lom.li13') ?></li>
</ul>
<p data-i18n="blog.lom.p4"><?= tr('blog.lom.p4') ?></p>

<h2 id="calendrier" data-i18n="blog.lom.h22"><?= tr('blog.lom.h22') ?></h2>

<div style="overflow-x:auto;margin:32px 0;">
<table style="width:100%;border-collapse:collapse;font-size:14px;">
  <thead>
    <tr style="background:var(--dark);color:#fff;">
      <th style="padding:12px 16px;text-align:left;border-radius:8px 0 0 0;" data-i18n="blog.lom.th1"><?= tr('blog.lom.th1') ?></th>
      <th style="padding:12px 16px;text-align:left;" data-i18n="blog.lom.th2"><?= tr('blog.lom.th2') ?></th>
      <th style="padding:12px 16px;text-align:left;border-radius:0 8px 0 0;" data-i18n="blog.lom.th3"><?= tr('blog.lom.th3') ?></th>
    </tr>
  </thead>
  <tbody>
    <tr style="border-bottom:1px solid var(--border);">
      <td style="padding:12px 16px;font-weight:700;color:var(--orange);">01/01/2025</td>
      <td style="padding:12px 16px;color:var(--dark);" data-i18n="blog.lom.td1"><?= tr('blog.lom.td1') ?></td>
      <td style="padding:12px 16px;color:var(--text-mid);" data-i18n="blog.lom.td2"><?= tr('blog.lom.td2') ?></td>
    </tr>
    <tr style="border-bottom:1px solid var(--border);background:var(--bg-off);">
      ...
      <td style="padding:12px 16px;color:var(--dark);" data-i18n="blog.lom.td3"><?= tr('blog.lom.td3') ?></td>
      <td style="padding:12px 16px;color:var(--text-mid);" data-i18n="blog.lom.td4"><?= tr('blog.lom.td4') ?></td>
    </tr>
    <tr style="border-bottom:1px solid var(--border);">
      <td style="padding:12px 16px;font-weight:700;color:#DC2626;">01/07/2026</td>
      <td style="padding:12px 16px;color:var(--dark);" data-i18n="blog.lom.td5"><?= tr('blog.lom.td5') ?></td>
      <td style="padding:12px 16px;color:var(--text-mid);" data-i18n="blog.lom.td6"><?= tr('blog.lom.td6') ?></td>
    </tr>
    <tr style="border-bottom:1px solid var(--border);background:var(--bg-off);">
      <td style="padding:12px 16px;font-weight:700;color:var(--orange);">01/01/2027</td>
      <td style="padding:12px 16px;color:var(--dark);" data-i18n="blog.lom.td7"><?= tr('blog.lom.td7') ?></td>
      <td style="padding:12px 16px;color:var(--text-mid);" data-i18n="blog.lom.td8"><?= tr('blog.lom.td8') ?></td>
    </tr>
    <tr style="background:rgba(232,86,58,.06);">
      <td style="padding:12px 16px;font-weight:700;color:var(--orange);">01/01/2030</td>
      <td style="padding:12px 16px;color:var(--dark);" data-i18n="blog.lom.td9"><?= tr('blog.lom.td9') ?></td>
      <td style="padding:12px 16px;color:var(--text-mid);" data-i18n="blog.lom.td10"><?= tr('blog.lom.td10') ?></td>
    </tr>
  </tbody>
</table>
</div>
...
<div style="background:rgba(220,38,38,.06);border-left:4px solid #DC2626;border-radius:0 8px 8px 0;padding:20px 24px;margin:32px 0;">
  <div style="font-weight:700;color:#DC2626;margin-bottom:6px;" data-i18n="blog.lom.div3"><?= tr('blog.lom.div3') ?></div>
  <p style="margin:0;color:var(--text-mid);font-size:14px;line-height:1.7;" data-i18n="blog.lom.p5"><?= tr('blog.lom.p5') ?></p>
</div>

<h2 id="sanctions" data-i18n="blog.lom.h23"><?= tr('blog.lom.h23') ?></h2>
<p data-i18n="blog.lom.p6"><?= tr('blog.lom.p6') ?></p>
<h3 data-i18n="blog.lom.h31"><?= tr('blog.lom.h31') ?></h3>
<p data-i18n="blog.lom.p7"><?= tr('blog.lom.p7') ?></p>
<h3 data-i18n="blog.lom.h32"><?= tr('blog.lom.h32') ?></h3>
<p data-i18n="blog.lom.p8"><?= tr('blog.lom.p8') ?></p>
<h3 data-i18n="blog.lom.h33"><?= tr('blog.lom.h33') ?></h3>
<p data-i18n="blog.lom.p9"><?= tr('blog.lom.p9') ?></p>

<h2 id="decret-tertiaire" data-i18n="blog.lom.h24"><?= tr('blog.lom.h24') ?></h2>
<p data-i18n="blog.lom.p10"><?= tr('blog.lom.p10') ?></p>
<ul>
  <li data-i18n="blog.lom.li14"><?= tr('blog.lom.li14') ?></li>
  <li data-i18n="blog.lom.li15"><?= tr('blog.lom.li15') ?></li>
</ul>
<p data-i18n="blog.lom.p11"><?= tr('blog.lom.p11') ?></p>

<h2 id="loi-aper" data-i18n="blog.lom.h25"><?= tr('blog.lom.h25') ?></h2>
<p data-i18n="blog.lom.p12"><?= tr('blog.lom.p12') ?></p>
<ul>
  <li data-i18n="blog.lom.li16"><?= tr('blog.lom.li16') ?></li>
  <li data-i18n="blog.lom.li17"><?= tr('blog.lom.li17') ?></li>
</ul>
<p data-i18n="blog.lom.p13"><?= tr('blog.lom.p13') ?></p>

<h2 id="financement" data-i18n="blog.lom.h26"><?= tr('blog.lom.h26') ?></h2>
<p data-i18n="blog.lom.p14"><?= tr('blog.lom.p14') ?></p>
<ul>
  <li data-i18n="blog.lom.li18"><?= tr('blog.lom.li18') ?></li>
  <li data-i18n="blog.lom.li19"><?= tr('blog.lom.li19') ?></li>
  <li data-i18n="blog.lom.li20"><?= tr('blog.lom.li20') ?></li>
  <li data-i18n="blog.lom.li21"><?= tr('blog.lom.li21') ?></li>
</ul>

<h2 id="conformite" data-i18n="blog.lom.h27"><?= tr('blog.lom.h27') ?></h2>
<p data-i18n="blog.lom.p15"><?= tr('blog.lom.p15') ?></p>
<ul>
  <li data-i18n="blog.lom.li22"><?= tr('blog.lom.li22') ?></li>
  <li data-i18n="blog.lom.li23"><?= tr('blog.lom.li23') ?></li>
  <li data-i18n="blog.lom.li24"><?= tr('blog.lom.li24') ?></li>
  <li data-i18n="blog.lom.li25"><?= tr('blog.lom.li25') ?></li>
  <li data-i18n="blog.lom.li26"><?= tr('blog.lom.li26') ?></li>
</ul>

<div style="background:var(--dark);border-radius:16px;padding:32px;margin-top:40px;text-align:center;">
  <div style="font-family:var(--font-display);font-size:20px;font-weight:800;color:#fff;margin-bottom:8px;" data-i18n="blog.lom.div4"><?= tr('blog.lom.div4') ?></div>
  <p style="color:rgba(255,255,255,.6);font-size:14px;margin-bottom:20px;line-height:1.7;" data-i18n="blog.lom.p16"><?= tr('blog.lom.p16') ?></p>
  <a href="/contact/" style="display:inline-block;background:var(--orange);color:#fff;padding:14px 28px;border-radius:10px;font-weight:700;text-decoration:none;font-size:15px;" data-i18n="blog.lom.cta_btn"><?= tr('blog.lom.cta_btn') ?></a>
</div>
