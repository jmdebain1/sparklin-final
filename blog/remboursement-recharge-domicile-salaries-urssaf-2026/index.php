...
<head>
  ...
  <title><?= tr('blog.urssaf26.meta_title') ?></title>
  <meta name="description" content="<?= tr('blog.urssaf26.meta_desc') ?>" data-i18n-meta="blog.urssaf26.meta_desc"/>
  ...
  <meta name="keywords" content="remboursement recharge domicile URSSAF, avantage en nature borne recharge, note de frais voiture électrique employeur, MID justificatif recharge"/>
  <script type="application/ld+json">
  {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "headline": "Rembourser la recharge à domicile de vos salariés en 2026 : ce que l'URSSAF accepte, ce qu'elle refuse",
    "description": "Forfait au kilomètre ou remboursement au kWh réel ? Le cadre exact de l'URSSAF pour rembourser la recharge à domicile en 2026.",
    "image": "https://sparklin.io/assets/images/spark1-potelet-hd.jpg",
    "datePublished": "2026-08-12",
    "author": {"@type": "Person", "name": "Mhaia"},
    "publisher": {"@type": "Organization", "name": "Sparklin", "url": "https://sparklin.io"},
    "mainEntityOfPage": {"@type": "WebPage", "@id": "https://sparklin.io/blog/remboursement-recharge-domicile-salaries-urssaf-2026/"}
  }
  </script>
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('blog.urssaf26.meta_title'),'desc'=>tr('blog.urssaf26.meta_desc'),'type'=>'article','image'=>'https://sparklin.io/assets/images/spark1-potelet-hd.jpg','imageAlt'=>tr('blog.urssaf26.img_hero_alt')]); ?>
</head>
<body>
...
<div style="height:340px;background:#1a1a2e;display:flex;align-items:flex-end;padding:0;position:relative;overflow:hidden;">
  <img src="/assets/images/spark1-potelet-hd.jpg" alt="<?= t('blog.urssaf26.img_hero_alt') ?>" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.55;"/>
...
<article style="padding:60px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow blog-body">
    <div style="font-size:12px;font-weight:600;color:var(--text-light);letter-spacing:.08em;text-transform:uppercase;margin-bottom:16px;" data-i18n="blog.urssaf26.div1"><?= tr('blog.urssaf26.div1') ?></div>

    <h1 style="font-family:var(--font-display);font-size:clamp(1.8rem,3vw,2.6rem);font-weight:800;color:var(--dark);line-height:1.2;margin-bottom:20px;" data-i18n="blog.urssaf26.h1"><?= tr('blog.urssaf26.h1') ?></h1>
    ...
    <div data-i18n="blog.urssaf26.p_intro" style="margin-bottom:32px;"><?= tr('blog.urssaf26.p_intro') ?></div>

    <h2 id="accepte" data-i18n="blog.urssaf26.h2_accepte"><?= tr('blog.urssaf26.h2_accepte') ?></h2>
    <div data-i18n="blog.urssaf26.body_accepte"><?= tr('blog.urssaf26.body_accepte') ?></div>

    <h2 id="refuse" data-i18n="blog.urssaf26.h2_refuse"><?= tr('blog.urssaf26.h2_refuse') ?></h2>
    <div data-i18n="blog.urssaf26.body_refuse"><?= tr('blog.urssaf26.body_refuse') ?></div>

    <figure style="margin:32px 0;">
      <img src="/assets/images/prise-connectee-5.jpg" alt="<?= t('blog.urssaf26.img_inline_alt') ?>" style="width:100%;border-radius:12px;display:block;"/>
      <figcaption style="font-size:12px;color:var(--text-light);margin-top:8px;">Chaque session de recharge est horodatée et mesurée au kWh près, exportable pour la paie.</figcaption>
    </figure>

    <h2 id="avantage" data-i18n="blog.urssaf26.h2_avantage"><?= tr('blog.urssaf26.h2_avantage') ?></h2>
    <div data-i18n="blog.urssaf26.body_avantage"><?= tr('blog.urssaf26.body_avantage') ?></div>

    <h2 id="mid" data-i18n="blog.urssaf26.h2_mid"><?= tr('blog.urssaf26.h2_mid') ?></h2>
    <div data-i18n="blog.urssaf26.body_mid"><?= tr('blog.urssaf26.body_mid') ?></div>

    <h2 id="automatisation" data-i18n="blog.urssaf26.h2_automatisation"><?= tr('blog.urssaf26.h2_automatisation') ?></h2>
    <div data-i18n="blog.urssaf26.body_automatisation"><?= tr('blog.urssaf26.body_automatisation') ?></div>

    <div style="background:var(--dark);border-radius:16px;padding:32px;margin-top:40px;text-align:center;">
      <div style="font-family:var(--font-display);font-size:20px;font-weight:800;color:#fff;margin-bottom:8px;" data-i18n="blog.urssaf26.cta_title"><?= tr('blog.urssaf26.cta_title') ?></div>
      <p style="color:rgba(255,255,255,.6);font-size:14px;margin-bottom:20px;line-height:1.7;" data-i18n="blog.urssaf26.cta_text"><?= tr('blog.urssaf26.cta_text') ?></p>
      <a href="/contact/" style="display:inline-block;background:var(--orange);color:#fff;padding:14px 28px;border-radius:10px;font-weight:700;text-decoration:none;font-size:15px;" data-i18n="blog.urssaf26.cta_btn"><?= tr('blog.urssaf26.cta_btn') ?></a>
    </div>
