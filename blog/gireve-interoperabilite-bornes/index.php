...
<head>
  ...
  <title>GIREVE et l'interopérabilité des bornes de recharge en France | Blog Sparklin</title>
  <meta name="description" content="GIREVE connecte 180 000+ bornes via OCPI. Guide CPO/eMSP, itinérance véhicule électrique, facturation centralisée flottes." data-i18n-meta="meta.home.desc"/>
...
@media (max-width: 380px) {
  ...
  <link rel="canonical" href="https://sparklin.io/blog/gireve-interoperabilite-bornes/"/>
...
<article style="padding:60px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    <div style="font-size:12px;font-weight:600;color:var(--text-light);letter-spacing:.08em;text-transform:uppercase;margin-bottom:16px;">🔗 Technique · 8 min de lecture</div>
    
<h1 style="font-family:var(--font-display);font-size:clamp(1.8rem,3vw,2.6rem);font-weight:800;color:var(--dark);line-height:1.2;margin-bottom:20px;">GIREVE et l'interopérabilité des bornes de recharge en France : guide complet</h1>
<p style="font-size:17px;color:var(--text-mid);line-height:1.75;margin-bottom:40px;font-weight:300;">GIREVE est la plateforme nationale d'itinérance pour les véhicules électriques. Pour les gestionnaires de flottes et les opérateurs IRVE, comprendre son fonctionnement est essentiel pour offrir à leurs utilisateurs un accès à 180 000+ points de charge sans multiplier les contrats.</p>
...
<nav style="background:var(--bg-off);border-radius:12px;padding:20px 24px;margin-bottom:40px;">
  ...
  <ol style="margin:0;padding-left:20px;display:flex;flex-direction:column;gap:6px;">
    <li style="font-size:14px;"><a href="#gireve-definition" style="color:var(--orange);text-decoration:none;">Qu'est-ce que GIREVE ?</a></li>
    <li style="font-size:14px;"><a href="#ocpi" style="color:var(--orange);text-decoration:none;">OCPI : le protocole d'itinérance standardisé</a></li>
    <li style="font-size:14px;"><a href="#acteurs" style="color:var(--orange);text-decoration:none;">CPO, eMSP, HPC : qui fait quoi ?</a></li>
    <li style="font-size:14px;"><a href="#interoperabilite" style="color:var(--orange);text-decoration:none;">Comment fonctionne l'itinérance concrètement ?</a></li>
    <li style="font-size:14px;"><a href="#facturation" style="color:var(--orange);text-decoration:none;">Facturation centralisée : comment ça marche ?</a></li>
    <li style="font-size:14px;"><a href="#sparklin-gireve" style="color:var(--orange);text-decoration:none;">Sparklin et GIREVE : un opérateur certifié</a></li>
    <li style="font-size:14px;"><a href="#checklist-cpo" style="color:var(--orange);text-decoration:none;">Checklist pour devenir opérateur CPO conforme</a></li>
  </ol>
</nav>

<h2 id="gireve-definition">Qu'est-ce que GIREVE ?</h2>
<p><strong>GIREVE</strong> (Groupement pour l'Itinérance des Recharges Électriques de Véhicules) est un hub national de données créé en 2013 à l'initiative d'EDF, Total, Michelin et de la Caisse des Dépôts. Son rôle est d'assurer l'<strong>interopérabilité entre tous les réseaux de bornes de recharge en France</strong> — ce qui permet à un conducteur de recharger n'importe où avec un seul badge ou une seule application, quelle que soit la marque de la borne.</p>
<p>En 2026, GIREVE connecte :</p>
<ul>
  <li><strong>180 000+ points de charge</strong> en France (soit plus de 85% des bornes accessibles au public)</li>
  <li><strong>40+ opérateurs de mobilité</strong> (eMSP : Chargemap, TotalEnergies, Engie, Shell, etc.)</li>
  <li><strong>200+ opérateurs de bornes</strong> (CPO) certifiés, dont Sparklin</li>
  <li>Un réseau européen via <strong>Hubject</strong> et <strong>EMSP</strong> couvrant 15+ pays</li>
</ul>

<h2 id="ocpi">OCPI : le protocole d'itinérance standardisé</h2>
<p>L'interopérabilité repose sur le protocole <strong>OCPI (Open Charge Point Interface)</strong>, actuellement en version 2.2.1. C'est le standard qui permet aux systèmes des CPO (opérateurs de bornes) et des eMSP (opérateurs de mobilité) d'échanger en temps réel les informations nécessaires à une session de recharge en itinérance :</p>
<ul>
  <li><strong>Disponibilité</strong> des bornes et statut en temps réel (libre/occupée/hors service)</li>
  <li><strong>Tarifs</strong> applicables à l'utilisateur en itinérance</li>
  <li><strong>Authentification</strong> de l'utilisateur (badge RFID, QR code, application)</li>
  <li><strong>Session</strong> : démarrage, consommation, arrêt</li>
  <li><strong>CDR (Charge Detail Record)</strong> : compte-rendu de session pour facturation</li>
</ul>
<p>La différence avec OCPP (protocole borne↔logiciel de gestion) : OCPI gère le dialogue entre opérateurs, OCPP gère le dialogue entre la borne physique et son logiciel de supervision. Les deux protocoles sont complémentaires et indispensables dans un écosystème IRVE moderne.</p>

<h2 id="acteurs">CPO, eMSP, HPC : qui fait quoi dans l'écosystème IRVE ?</h2>
...
<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin:32px 0;">
  <div style="background:var(--bg-off);border-radius:12px;padding:20px;">
    <div style="font-weight:800;color:var(--dark);font-size:15px;margin-bottom:8px;">CPO</div>
    <div style="font-size:12px;color:var(--text-light);margin-bottom:12px;font-weight:600;text-transform:uppercase;letter-spacing:.05em;">Charge Point Operator</div>
    <p style="font-size:13px;color:var(--text-mid);line-height:1.6;margin:0;">L'opérateur qui déploie et exploite les bornes de recharge. Sparklin est CPO. Il est responsable de la disponibilité des bornes et de leur connexion à GIREVE via OCPI.</p>
  </div>
  <div style="background:rgba(232,86,58,.06);border-radius:12px;padding:20px;border:1px solid rgba(232,86,58,.15);">
    <div style="font-weight:800;color:var(--dark);font-size:15px;margin-bottom:8px;">eMSP</div>
    <div style="font-size:12px;color:var(--text-light);margin-bottom:12px;font-weight:600;text-transform:uppercase;letter-spacing:.05em;">e-Mobility Service Provider</div>
    <p style="font-size:13px;color:var(--text-mid);line-height:1.6;margin:0;">L'opérateur qui fournit les badges et applications aux utilisateurs finaux (Chargemap, TotalEnergies Charge+, Engie, etc.). Il facture le service à l'utilisateur et reverse au CPO.</p>
  </div>
  <div style="background:var(--bg-off);border-radius:12px;padding:20px;">
    <div style="font-weight:800;color:var(--dark);font-size:15px;margin-bottom:8px;">HPC</div>
    <div style="font-size:12px;color:var(--text-light);margin-bottom:12px;font-weight:600;text-transform:uppercase;letter-spacing:.05em;">Hub Platfom Coordinator</div>
    <p style="font-size:13px;color:var(--text-mid);line-height:1.6;margin:0;">Le hub d'interopérabilité (GIREVE en France) qui connecte tous les CPO et eMSP via un point d'échange unique, évitant les connexions bilatérales entre chaque paire d'opérateurs.</p>
  </div>
</div>

<h2 id="interoperabilite">Comment fonctionne l'itinérance concrètement ?</h2>
<p>Prenons le cas d'un salarié d'une entreprise cliente Sparklin qui se retrouve sur l'autoroute et doit recharger sur une borne TotalEnergies :</p>
<ol>
  <li>Le salarié présente son badge Sparklin (RFID) sur la borne TotalEnergies</li>
  <li>La borne TotalEnergies interroge <strong>GIREVE</strong> pour authentifier le badge</li>
  <li>GIREVE contacte Sparklin (le CPO du badge) pour vérifier les droits d'accès</li>
  <li>Sparklin valide l'autorisation — la borne démarre la charge</li>
  <li>En fin de session, un CDR est transmis à Sparklin via GIREVE</li>
  <li>Sparklin facture l'entreprise du salarié et reverse la part TotalEnergies</li>
</ol>
<p>L'ensemble de ce processus se déroule en <strong>moins de 3 secondes</strong>. L'utilisateur n'a aucune démarche à effectuer — son badge unique fonctionne sur 180 000+ points de charge.</p>

<h2 id="facturation">Facturation centralisée : l'avantage pour les gestionnaires de flotte</h2>
<p>Sans itinérance GIREVE, une entreprise gérant 50 véhicules électriques devrait :</p>
<ul>
  <li>Souscrire des abonnements auprès de chaque réseau (TotalEnergies, Engie, Shell, Chargemap...)</li>
  <li>Gérer plusieurs factures mensuelles et plusieurs badges par véhicule</li>
  <li>Faire valider les notes de frais de recharge en déplacement manuellement</li>
</ul>
<p>Avec Sparklin (certifié GIREVE), l'entreprise dispose d'<strong>une seule facture mensuelle</strong> consolidant toutes les recharges : sur site, à domicile via la Sparklin by go-e, et en itinérance sur les 180 000+ points de charge du réseau. Spark Pilot présente un tableau de bord unifié par véhicule, par conducteur et par site.</p>

<h2 id="sparklin-gireve">Sparklin : opérateur certifié GIREVE depuis 2023</h2>
<p>Sparklin est certifié opérateur CPO sur la plateforme GIREVE depuis 2023. Cette certification implique :</p>
<ul>
  <li>Une <strong>connexion OCPI 2.2.1</strong> directe à la plateforme GIREVE</li>
  <li>Un <strong>temps de réponse garanti</strong> pour l'authentification des badges en itinérance (&lt;2 s)</li>
  <li>La <strong>remontée en temps réel</strong> de la disponibilité de toutes les bornes Sparklin sur les applications de navigation (PlugShare, ABRP, ChargeMap, etc.)</li>
  <li>La <strong>facturation centralisée</strong> mensuelle pour les entreprises multi-sites</li>
  <li>L'<strong>accès au réseau européen</strong> via Hubject pour les déplacements transfrontaliers</li>
</ul>

<h2 id="checklist-cpo">Checklist pour devenir opérateur CPO conforme via GIREVE</h2>
<p>Si vous souhaitez ouvrir votre parking privé au public (facturé) et rejoindre le réseau GIREVE, voici les prérequis techniques :</p>
<ol>
  <li>✅ <strong>Bornes compatibles OCPP 2.0.1</strong> — obligatoire pour la communication avec le logiciel de gestion</li>
  <li>✅ <strong>Logiciel de supervision CSMS</strong> certifié OCPI 2.2.1 — Spark Pilot est nativement compatible</li>
  <li>✅ <strong>Compteurs MID certifiés</strong> sur les bornes — obligatoire pour la facturation à l'énergie au public</li>
  <li>✅ <strong>Contrat GIREVE</strong> ou accès via un opérateur certifié (Sparklin peut vous apporter la connectivité GIREVE sans que vous deveniez vous-même CPO)</li>
  <li>✅ <strong>Identifiants EVSE</strong> (format EVSE-ID normalisé) assignés à chaque point de charge</li>
  <li>✅ <strong>Affichage du prix</strong> sur ou à proximité de la borne (obligation légale depuis 2022)</li>
</ol>

<div style="background:var(--dark);border-radius:16px;padding:32px;margin-top:40px;text-align:center;">
  <div style="font-family:var(--font-display);font-size:20px;font-weight:800;color:#fff;margin-bottom:8px;">Accédez à 180 000+ points de charge</div>
  <p style="color:rgba(255,255,255,.6);font-size:14px;margin-bottom:20px;line-height:1.7;">En tant qu'opérateur certifié GIREVE, Sparklin vous donne accès à l'ensemble du réseau européen de recharge via un seul contrat et une seule facture mensuelle.</p>
  <a href="/contact/" style="display:inline-block;background:var(--orange);color:#fff;padding:14px 28px;border-radius:10px;font-weight:700;text-decoration:none;font-size:15px;">Activer l'itinérance GIREVE →</a>
</div>
