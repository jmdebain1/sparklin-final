...
<head>
  ...
  <title><?= tr('blog.lb26.meta_title') ?></title>
  <meta name="description" content="<?= tr('blog.lb26.meta_desc') ?>" data-i18n-meta="blog.lb26.meta_desc"/>
  ...
  <meta name="keywords" content="load balancing borne recharge, répartition puissance IRVE, pilotage intelligent recharge entreprise, Spark Pilot économies"/>
  <script type="application/ld+json">
  {
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "headline": "Load balancing IRVE : comment 20 bornes Spark Plus consomment autant qu'une installation non pilotée de 8 bornes",
...
<div style="height:340px;background:#1a1a2e;display:flex;align-items:flex-end;padding:0;position:relative;overflow:hidden;">
  <img src="/assets/images/parking-left-web.png" alt="<?= t('blog.lb26.img_hero_alt') ?>" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;opacity:.55;"/>
...
<article style="padding:60px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow blog-body">
    ...
    <div data-i18n="blog.lb26.body_puissance"><?= tr('blog.lb26.body_puissance') ?></div>

    <h2 id="catastrophe" data-i18n="blog.lb26.h2_catastrophe"><?= tr('blog.lb26.h2_catastrophe') ?></h2>
    <div data-i18n="blog.lb26.body_catastrophe"><?= tr('blog.lb26.body_catastrophe') ?></div>

    <figure style="margin:32px 0;">
      <img src="/assets/images/spark-plus-onsite-hd.jpg" alt="<?= t('blog.lb26.img_inline_alt') ?>" style="width:100%;border-radius:12px;display:block;"/>
      <figcaption style="font-size:12px;color:var(--text-light);margin-top:8px;">Bornes Spark Plus sur site, alimentation régulée dynamiquement par Spark Pilot.</figcaption>
    </figure>

    <h2 id="economies" data-i18n="blog.lb26.h2_economies"><?= tr('blog.lb26.h2_economies') ?></h2>
    <div data-i18n="blog.lb26.body_economies"><?= tr('blog.lb26.body_economies') ?></div>

    <h2 id="roi" data-i18n="blog.lb26.h2_roi"><?= tr('blog.lb26.h2_roi') ?></h2>
    <div data-i18n="blog.lb26.body_roi"><?= tr('blog.lb26.body_roi') ?></div>

    <div style="background:var(--dark);border-radius:16px;padding:32px;margin-top:40px;text-align:center;">
      <div style="font-family:var(--font-display);font-size:20px;font-weight:800;color:#fff;margin-bottom:8px;" data-i18n="blog.lb26.cta_title"><?= tr('blog.lb26.cta_title') ?></div>
      <p style="color:rgba(255,255,255,.6);font-size:14px;margin-bottom:20px;line-height:1.7;" data-i18n="blog.lb26.cta_text"><?= tr('blog.lb26.cta_text') ?></p>
      <a href="/contact/" style="display:inline-block;background:var(--orange);color:#fff;padding:14px 28px;border-radius:10px;font-weight:700;text-decoration:none;font-size:15px;" data-i18n="blog.lb26.cta_btn"><?= tr('blog.lb26.cta_btn') ?></a>
    </div>
