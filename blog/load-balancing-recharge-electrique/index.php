...
<head>
  ...
  <title><?= tr('meta.blog_loadbalancing.title') ?></title>
  <meta name="description" content="<?= tr('meta.blog_loadbalancing.desc') ?>" data-i18n-meta="meta.blog_loadbalancing.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.blog_loadbalancing.title'),'desc'=>tr('meta.blog_loadbalancing.desc'),'type'=>'article']); ?>
</head>
<body>
...
<nav style="background:var(--bg-off);border-radius:12px;padding:20px 24px;margin-bottom:40px;">
  <div style="font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--text-light);margin-bottom:12px;" data-i18n="blog.lb.div2"><?= tr('blog.lb.div2') ?></div>
  <ol style="margin:0;padding-left:20px;display:flex;flex-direction:column;gap:6px;">
    <li style="font-size:14px;color:var(--dark);" data-i18n="blog.lb.li1"><?= tr('blog.lb.li1') ?></li>
    <li style="font-size:14px;color:var(--dark);" data-i18n="blog.lb.li2"><?= tr('blog.lb.li2') ?></li>
    <li style="font-size:14px;color:var(--dark);" data-i18n="blog.lb.li3"><?= tr('blog.lb.li3') ?></li>
    <li style="font-size:14px;color:var(--dark);" data-i18n="blog.lb.li4"><?= tr('blog.lb.li4') ?></li>
    <li style="font-size:14px;color:var(--dark);" data-i18n="blog.lb.li5"><?= tr('blog.lb.li5') ?></li>
    <li style="font-size:14px;color:var(--dark);" data-i18n="blog.lb.li6"><?= tr('blog.lb.li6') ?></li>
    <li style="font-size:14px;color:var(--dark);" data-i18n="blog.lb.li7"><?= tr('blog.lb.li7') ?></li>
  </ol>
</nav>

<h2 id="definition" data-i18n="blog.lb.h21"><?= tr('blog.lb.h21') ?></h2>
<p data-i18n="blog.lb.p2"><?= tr('blog.lb.p2') ?></p>
<ul>
  <li data-i18n="blog.lb.li8"><?= tr('blog.lb.li8') ?></li>
  <li data-i18n="blog.lb.li9"><?= tr('blog.lb.li9') ?></li>
  <li data-i18n="blog.lb.li10"><?= tr('blog.lb.li10') ?></li>
  <li data-i18n="blog.lb.li11"><?= tr('blog.lb.li11') ?></li>
</ul>
<p data-i18n="blog.lb.p3"><?= tr('blog.lb.p3') ?></p>
...
<div style="background:rgba(232,86,58,.06);border-left:4px solid var(--orange);border-radius:0 8px 8px 0;padding:20px 24px;margin:32px 0;">
  <div style="font-weight:700;color:var(--dark);margin-bottom:6px;" data-i18n="blog.lb.div3"><?= tr('blog.lb.div3') ?></div>
  <p style="margin:0;color:var(--text-mid);font-size:14px;line-height:1.7;" data-i18n="blog.lb.p4"><?= tr('blog.lb.p4') ?></p>
</div>

<h2 id="fonctionnement" data-i18n="blog.lb.h22"><?= tr('blog.lb.h22') ?></h2>
<p data-i18n="blog.lb.p5"><?= tr('blog.lb.p5') ?></p>

<h3 data-i18n="blog.lb.h31"><?= tr('blog.lb.h31') ?></h3>
<p data-i18n="blog.lb.p6"><?= tr('blog.lb.p6') ?></p>

<h3 data-i18n="blog.lb.h32"><?= tr('blog.lb.h32') ?></h3>
<p data-i18n="blog.lb.p7"><?= tr('blog.lb.p7') ?></p>

<h3 data-i18n="blog.lb.h33"><?= tr('blog.lb.h33') ?></h3>
<p data-i18n="blog.lb.p8"><?= tr('blog.lb.p8') ?></p>

<h2 id="exemple" data-i18n="blog.lb.h23"><?= tr('blog.lb.h23') ?></h2>
<p data-i18n="blog.lb.p9"><?= tr('blog.lb.p9') ?></p>

<div style="overflow-x:auto;margin:32px 0;">
<table style="width:100%;border-collapse:collapse;font-size:14px;">
  <thead>
    <tr style="background:var(--dark);color:#fff;">
      <th style="padding:12px 16px;text-align:left;border-radius:8px 0 0 0;" data-i18n="blog.lb.th1"><?= tr('blog.lb.th1') ?></th>
      <th style="padding:12px 16px;text-align:right;" data-i18n="blog.lb.th2"><?= tr('blog.lb.th2') ?></th>
      <th style="padding:12px 16px;text-align:right;border-radius:0 8px 0 0;" data-i18n="blog.lb.th3"><?= tr('blog.lb.th3') ?></th>
    </tr>
  </thead>
  <tbody>
    <tr style="border-bottom:1px solid var(--border);">
      <td style="padding:12px 16px;color:var(--dark);font-weight:500;" data-i18n="blog.lb.td1"><?= tr('blog.lb.td1') ?></td>
      <td style="padding:12px 16px;text-align:right;color:var(--text-mid);" data-i18n="blog.lb.td2"><?= tr('blog.lb.td2') ?></td>
      <td style="padding:12px 16px;text-align:right;color:var(--dark);font-weight:600;" data-i18n="blog.lb.td3"><?= tr('blog.lb.td3') ?></td>
    </tr>
    <tr style="border-bottom:1px solid var(--border);background:var(--bg-off);">
      <td style="padding:12px 16px;color:var(--dark);font-weight:500;" data-i18n="blog.lb.td4"><?= tr('blog.lb.td4') ?></td>
      <td style="padding:12px 16px;text-align:right;color:var(--text-mid);" data-i18n="blog.lb.td5"><?= tr('blog.lb.td5') ?></td>
      <td style="padding:12px 16px;text-align:right;color:var(--dark);font-weight:600;" data-i18n="blog.lb.td6"><?= tr('blog.lb.td6') ?></td>
    </tr>
    <tr style="border-bottom:1px solid var(--border);">
      <td style="padding:12px 16px;color:var(--dark);font-weight:500;" data-i18n="blog.lb.td7"><?= tr('blog.lb.td7') ?></td>
      <td style="padding:12px 16px;text-align:right;color:#DC2626;font-weight:600;" data-i18n="blog.lb.td8"><?= tr('blog.lb.td8') ?></td>
      <td style="padding:12px 16px;text-align:right;color:#16A34A;font-weight:600;" data-i18n="blog.lb.td9"><?= tr('blog.lb.td9') ?></td>
    </tr>
    <tr style="border-bottom:1px solid var(--border);background:var(--bg-off);">
      <td style="padding:12px 16px;color:var(--dark);font-weight:500;" data-i18n="blog.lb.td10"><?= tr('blog.lb.td10') ?></td>
    ...
    <tr style="border-bottom:1px solid var(--border);">
      <td style="padding:12px 16px;color:var(--dark);font-weight:500;" data-i18n="blog.lb.td11"><?= tr('blog.lb.td11') ?></td>
      <td style="padding:12px 16px;text-align:right;color:#DC2626;font-weight:600;" data-i18n="blog.lb.td12"><?= tr('blog.lb.td12') ?></td>
      <td style="padding:12px 16px;text-align:right;color:#16A34A;font-weight:600;">0</td>
    </tr>
    <tr style="background:rgba(232,86,58,.06);">
      <td style="padding:12px 16px;color:var(--dark);font-weight:700;" data-i18n="blog.lb.td13"><?= tr('blog.lb.td13') ?></td>
      <td style="padding:12px 16px;text-align:right;color:var(--text-mid);">—</td>
      <td style="padding:12px 16px;text-align:right;color:var(--orange);font-weight:700;" data-i18n="blog.lb.td14"><?= tr('blog.lb.td14') ?></td>
    </tr>
  </tbody>
</table>
</div>

<p data-i18n="blog.lb.p10"><?= tr('blog.lb.p10') ?></p>

<h2 id="financier" data-i18n="blog.lb.h24"><?= tr('blog.lb.h24') ?></h2>
<p data-i18n="blog.lb.p11"><?= tr('blog.lb.p11') ?></p>
<ul>
  <li data-i18n="blog.lb.li12"><?= tr('blog.lb.li12') ?></li>
  <li data-i18n="blog.lb.li13"><?= tr('blog.lb.li13') ?></li>
</ul>
<p data-i18n="blog.lb.p12"><?= tr('blog.lb.p12') ?></p>
<p data-i18n="blog.lb.p13"><?= tr('blog.lb.p13') ?></p>

<h2 id="statique-dynamique" data-i18n="blog.lb.h25"><?= tr('blog.lb.h25') ?></h2>
<p data-i18n="blog.lb.p14"><?= tr('blog.lb.p14') ?></p>

<h3 data-i18n="blog.lb.h34"><?= tr('blog.lb.h34') ?></h3>
<p data-i18n="blog.lb.p15"><?= tr('blog.lb.p15') ?></p>

<h3 data-i18n="blog.lb.h35"><?= tr('blog.lb.h35') ?></h3>
<p data-i18n="blog.lb.p16"><?= tr('blog.lb.p16') ?></p>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin:32px 0;">
  <div style="background:var(--bg-off);border-radius:12px;padding:20px;">
    <div style="font-weight:700;color:var(--text-mid);margin-bottom:8px;font-size:13px;" data-i18n="blog.lb.div4"><?= tr('blog.lb.div4') ?></div>
    <ul style="margin:0;padding-left:16px;font-size:13px;color:var(--text-mid);display:flex;flex-direction:column;gap:4px;">
      <li data-i18n="blog.lb.li14"><?= tr('blog.lb.li14') ?></li>
      <li data-i18n="blog.lb.li15"><?= tr('blog.lb.li15') ?></li>
      <li data-i18n="blog.lb.li16"><?= tr('blog.lb.li16') ?></li>
      <li data-i18n="blog.lb.li17"><?= tr('blog.lb.li17') ?></li>
    </ul>
  </div>
  <div style="background:rgba(232,86,58,.06);border-radius:12px;padding:20px;border:1px solid rgba(232,86,58,.2);">
    <div style="font-weight:700;color:var(--orange);margin-bottom:8px;font-size:13px;" data-i18n="blog.lb.div5"><?= tr('blog.lb.div5') ?></div>
    <ul style="margin:0;padding-left:16px;font-size:13px;color:var(--text-mid);display:flex;flex-direction:column;gap:4px;">
      <li data-i18n="blog.lb.li18"><?= tr('blog.lb.li18') ?></li>
      <li data-i18n="blog.lb.li19"><?= tr('blog.lb.li19') ?></li>
      <li data-i18n="blog.lb.li20"><?= tr('blog.lb.li20') ?></li>
      <li data-i18n="blog.lb.li21"><?= tr('blog.lb.li21') ?></li>
    </ul>
  </div>
</div>

<h2 id="obligations" data-i18n="blog.lb.h26"><?= tr('blog.lb.h26') ?></h2>
<p data-i18n="blog.lb.p17"><?= tr('blog.lb.p17') ?></p>
<p data-i18n="blog.lb.p18"><?= tr('blog.lb.p18') ?></p>

<h2 id="checklist" data-i18n="blog.lb.h27"><?= tr('blog.lb.h27') ?></h2>
<p data-i18n="blog.lb.p19"><?= tr('blog.lb.p19') ?></p>
<ol>
  <li data-i18n="blog.lb.li22"><?= tr('blog.lb.li22') ?></li>
  <li data-i18n="blog.lb.li23"><?= tr('blog.lb.li23') ?></li>
  <li data-i18n="blog.lb.li24"><?= tr('blog.lb.li24') ?></li>
  <li data-i18n="blog.lb.li25"><?= tr('blog.lb.li25') ?></li>
  <li data-i18n="blog.lb.li26"><?= tr('blog.lb.li26') ?></li>
</ol>
<p data-i18n="blog.lb.p20"><?= tr('blog.lb.p20') ?></p>

<div style="background:var(--dark);border-radius:16px;padding:32px;margin-top:40px;text-align:center;">
  <div style="font-family:var(--font-display);font-size:20px;font-weight:800;color:#fff;margin-bottom:8px;" data-i18n="blog.lb.div6"><?= tr('blog.lb.div6') ?></div>
  <p style="color:rgba(255,255,255,.6);font-size:14px;margin-bottom:20px;line-height:1.7;" data-i18n="blog.lb.p21"><?= tr('blog.lb.p21') ?></p>
  <a href="/contact/" style="display:inline-block;background:var(--orange);color:#fff;padding:14px 28px;border-radius:10px;font-weight:700;text-decoration:none;font-size:15px;" data-i18n="blog.lb.cta_btn"><?= tr('blog.lb.cta_btn') ?></a>
</div>
