...
<head>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('blog.wallbox.meta_title'),'desc'=>tr('blog.wallbox.meta_desc'),'type'=>'article','image'=>'https://sparklin.io/assets/images/spark1-render-hd.png','imageAlt'=>tr('blog.wallbox.img_hero_alt')]); ?>
</head>
<body>
