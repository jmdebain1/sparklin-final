...
<!-- HERO -->
  <header class="hero">
    <div>
      <div class="hero-badge">Application Sparklin &middot; iOS &amp; Android — gratuit</div>
      <h1 data-i18n="app.hero.h1a"><?= tr('app.hero.h1a') ?><em data-i18n="app.hero.h1b"><?= tr('app.hero.h1b') ?></em>, o&ugrave; que vous soyez.</h1>
      <p class="hero-sub">L&rsquo;application Sparklin accompagne l&rsquo;utilisateur lors de ses recharges en entreprise, en vacances et &agrave; domicile. Ergonomique, intuitive, disponible gratuitement sur l&rsquo;App Store et le Play Store — pour une exp&eacute;rience de charge fluide et sans soucis.</p>
      <div class="hero-actions">
        <a href="https://apps.apple.com/fr/app/sparklin/id1615738603" class="btn-primary">Télécharger sur l&rsquo;App Store →</a>
        <a href="https://play.google.com/store/apps/details?id=io.sparklin.app&gl=FR" class="btn-outline">Google Play</a>
      </div>
      <div class="hero-chips">
        <span class="chip"><span class="chip-dot"></span>iOS &amp; Android</span>
        <span class="chip"><span class="chip-dot"></span>Gratuit</span>
        <span class="chip"><span class="chip-dot"></span>Charge en 1 clic</span>
        <span class="chip"><span class="chip-dot"></span>Paiement s&eacute;curis&eacute;</span>
        <span class="chip"><span class="chip-dot"></span>Notes de frais auto</span>
      </div>
    </div>
  ...
  <section class="intro-section">
    <div class="intro-text reveal">
      ...
      <p>L&rsquo;application Sparklin est l&rsquo;interface utilisateur de l&rsquo;&eacute;cosyst&egrave;me Sparklin. Elle compl&egrave;te le Spark Pilot — le portail web destin&eacute; aux gestionnaires — en donnant &agrave; chaque utilisateur le contr&ocirc;le de ses propres sessions de recharge.</p>
      <p>Lors de la premi&egrave;re connexion, l&rsquo;utilisateur cr&eacute;e un compte en quelques &eacute;tapes et s&rsquo;identifie gr&acirc;ce &agrave; son num&eacute;ro de mobile. Ensuite, chaque session de recharge se lance, se suit et se termine depuis l&rsquo;application — sans badge, sans manipulation physique sur la borne.</p>
      <p>Pour les bornes Spark Plus &eacute;quip&eacute;es du plug &amp; charge, l&rsquo;application peut m&ecirc;me &ecirc;tre facultative&nbsp;: le v&eacute;hicule et la borne se reconnaissent automatiquement d&egrave;s la connexion du c&acirc;ble.</p>
    </div>
  ...
  <section class="pillars-section">
    <div class="pillars-header reveal">
      ...
      <p class="section-body">De la premi&egrave;re connexion au remboursement mensuel des frais de charge, l&rsquo;application g&egrave;re l&rsquo;ensemble du parcours utilisateur.</p>
    </div>
    <div class="app-feats-grid reveal" style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px;">

      <div class="pillar-card">
        <div class="pillar-icon">⚡</div>
        <h3>Lancement, suivi et arr&ecirc;t &agrave; distance</h3>
        <p>L&rsquo;utilisateur branche son v&eacute;hicule et contr&ocirc;le sa session &agrave; distance depuis l&rsquo;application. En temps r&eacute;el, il retrouve la consommation &eacute;lectrique en kWh, la dur&eacute;e de charge &eacute;coul&eacute;e et l&rsquo;estimation d&rsquo;autonomie r&eacute;cup&eacute;r&eacute;e. Il peut arr&ecirc;ter la session &agrave; tout moment, depuis n&rsquo;importe o&ugrave;.</p>
      </div>

      <div class="pillar-card">
        <div class="pillar-icon">🔲</div>
        <h3>Charge en 1 clic — flashez, branchez, go</h3>
        <p>Sur les bornes &eacute;quip&eacute;es d&rsquo;un QR code, l&rsquo;utilisateur flashe le code avec son smartphone, branche son v&eacute;hicule, et la session d&eacute;marre imm&eacute;diatement. Pas de badge, pas de manipulation suppl&eacute;mentaire. Le contr&ocirc;le d&rsquo;acc&egrave;s et l&rsquo;authentification s&rsquo;effectuent enti&egrave;rement depuis l&rsquo;application.</p>
      </div>

      <div class="pillar-card">
        <div class="pillar-icon">⏱️</div>
        <h3>Planification des recharges</h3>
        <p>&Agrave; domicile, l'utilisateur programme ses heures de charge en fonction de ses besoins et des tarifs d'&eacute;lectricit&eacute;. La recharge s'enclenche automatiquement aux heures d&eacute;finies &mdash; sans que l'utilisateur ait &agrave; intervenir, pour une recharge &agrave; petit prix.</p>
      </div>

      <div class="pillar-card">
        <div class="pillar-icon">💳</div>
        <h3>Paiement s&eacute;curis&eacute; sans wallet</h3>
        <p>Avec Sparklin, pas besoin d&rsquo;alimenter un wallet ou de pr&eacute;-charger un solde. L&rsquo;utilisateur enregistre une ou plusieurs cartes bancaires et paie facilement, en toute s&eacute;curit&eacute;. La facturation est r&eacute;alis&eacute;e &agrave; la fin de chaque session, selon le tarif d&eacute;fini par le gestionnaire du site.</p>
      </div>

      <div class="pillar-card">
        <div class="pillar-icon">🧾</div>
        <h3>Notes de frais automatis&eacute;es</h3>
        <p>Plus de factures &agrave; traiter ni de compteur &agrave; relever. Sparklin remonte automatiquement les informations de chaque session et facilite le remboursement pour les v&eacute;hicules de fonction. Les donn&eacute;es mensuelles sont export&eacute;es pour un traitement simplifi&eacute;.</p>
      </div>

      <div class="pillar-card">
        <div class="pillar-icon">📊</div>
        <h3>Historique et suivi de consommation</h3>
        <p>L'utilisateur acc&egrave;de &agrave; l'int&eacute;gralit&eacute; de son historique de sessions depuis l'application&nbsp;: dates, dur&eacute;es, kWh consomm&eacute;s, montants pay&eacute;s. Il retrouve en un coup d'&oelig;il toutes les informations des points de charge accessibles.</p>
      </div>

      <div class="pillar-card">
        <div class="pillar-icon">🔔</div>
        <h3>Notifications intelligentes</h3>
        <p>L&rsquo;utilisateur re&ccedil;oit des notifications au fil de sa recharge, l&rsquo;informant de son statut. Une notification de fin de charge l&rsquo;enjoint &agrave; lib&eacute;rer le stationnement d&egrave;s que possible — optimisant ainsi la disponibilit&eacute; des bornes pour les autres utilisateurs du site.</p>
      </div>

      <div class="pillar-card">
        <div class="pillar-icon">🏘️</div>
        <h3>Acc&egrave;s aux communaut&eacute;s de recharge</h3>
        <p>L'utilisateur acc&egrave;de depuis l'application aux sites sur lesquels il est autoris&eacute; &agrave; se charger &ndash; parking d'entreprise, r&eacute;sidence, camping. Il retrouve les disponibilit&eacute;s, le type de chargeur, la puissance, les prix.</p>
      </div>

      <div class="pillar-card">
        <div class="pillar-icon">🌐</div>
        <h3>R&eacute;servation</h3>
        <p>Sur les parkings priv&eacute;s, l'utilisateur peut r&eacute;server un point de charge. Un calendrier de r&eacute;servation est disponible pour l'ensemble des utilisateurs ayant acc&egrave;s au site.</p>
      </div>
  ...
  <section class="specs-section" style="background:var(--bg-off);">
    <div class="sk-wrap">
      <div class="reveal" style="text-align:center;margin-bottom:48px;">
        ...
        <h2 class="section-title">L&rsquo;application Sparklin et le Spark Pilot&nbsp;: chaque interface &agrave; son r&ocirc;le.</h2>
        <p class="section-body" style="max-width:600px;margin:0 auto;">Le gestionnaire pilote depuis le web. L&rsquo;utilisateur recharge depuis l&rsquo;app. Les deux sont synchronis&eacute;s en temps r&eacute;el sur la plateforme Spark Pilot.</p>
      </div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;" class="reveal">
        <div style="background:var(--bg-white);border:1.5px solid rgba(232,86,58,0.25);border-radius:16px;padding:32px;">
          ...
          <h3 style="font-family:var(--font-display);font-size:19px;font-weight:700;color:var(--dark);margin-bottom:8px;">Application Sparklin</h3>
          <p style="font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:var(--orange);margin-bottom:16px;">Pour l&rsquo;utilisateur final</p>
          <div style="display:flex;flex-direction:column;gap:8px;">
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--orange);font-weight:700;flex-shrink:0;">✓</span>Lancer et arr&ecirc;ter une session de charge</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--orange);font-weight:700;flex-shrink:0;">✓</span>Suivre sa consommation en temps r&eacute;el</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--orange);font-weight:700;flex-shrink:0;">✓</span>Payer ses sessions de recharge</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--orange);font-weight:700;flex-shrink:0;">✓</span>Consulter son historique et ses factures</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--orange);font-weight:700;flex-shrink:0;">✓</span>G&eacute;rer ses notes de frais automatis&eacute;es</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--orange);font-weight:700;flex-shrink:0;">✓</span>Programmer ses recharges &agrave; domicile</div>
          </div>
        </div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:16px;padding:32px;">
          ...
          <p style="font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-light);margin-bottom:16px;">Pour le gestionnaire de parc</p>
          <div style="display:flex;flex-direction:column;gap:8px;">
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--text-light);font-weight:700;flex-shrink:0;">→</span>Superviser l&rsquo;ensemble du parc de bornes</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--text-light);font-weight:700;flex-shrink:0;">→</span>G&eacute;rer les utilisateurs et leurs droits d&rsquo;acc&egrave;s</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--text-light);font-weight:700;flex-shrink:0;">→</span>D&eacute;finir la politique tarifaire</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--text-light);font-weight:700;flex-shrink:0;">→</span>Configurer le load balancing</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--text-light);font-weight:700;flex-shrink:0;">→</span>Exporter les rapports RSE et d&eacute;cret tertiaire</div>
            <div style="font-size:13.5px;color:var(--text-mid);display:flex;gap:8px;align-items:flex-start;"><span style="color:var(--text-light);font-weight:700;flex-shrink:0;">→</span>Suivre les revenus et les flux de paiement</div>
          </div>
  ...
  <section class="pilot-section" style="background:var(--bg-white);">
    <div class="pilot-layout">
      <div>
        <span class="section-label reveal">Exp&eacute;rience utilisateur</span>
        <h2 class="section-title reveal">Pens&eacute;e pour &ecirc;tre simple. Pas simpliste.</h2>
        <p class="section-body reveal">L&rsquo;application Sparklin est con&ccedil;ue pour que n&rsquo;importe quel utilisateur — qu&rsquo;il ait charg&eacute; cent fois ou jamais — puisse d&eacute;marrer une session de recharge sans aide. Interface &eacute;pur&eacute;e, &eacute;tapes minimis&eacute;es, retours visuels clairs.</p>
        <div class="pilot-features reveal">
          <div class="pilot-feature">
            <div class="pilot-feature-icon">🔐</div>
            <div class="pilot-feature-text">
              <h4>Cr&eacute;ation de compte en quelques &eacute;tapes</h4>
              <p>Num&eacute;ro de mobile, v&eacute;rification par SMS, carte bancaire enregistr&eacute;e. L&rsquo;utilisateur est op&eacute;rationnel en moins de deux minutes.</p>
            </div>
          </div>
          <div class="pilot-feature">
            <div class="pilot-feature-icon">🎯</div>
            <div class="pilot-feature-text">
              <h4>Interface adapt&eacute;e au contexte</h4>
              <p>L&rsquo;application d&eacute;tecte si l&rsquo;utilisateur est sur un site d&rsquo;entreprise, &agrave; son domicile ou en d&eacute;placement, et adapte les options disponibles en cons&eacute;quence.</p>
            </div>
          </div>
          <div class="pilot-feature">
            <div class="pilot-feature-icon">🔋</div>
            <div class="pilot-feature-text">
              <h4>Suivi de charge en temps r&eacute;el</h4>
              <p>Affichage dynamique des kWh charg&eacute;s, de la dur&eacute;e &eacute;coul&eacute;e et du montant facturable. Visualisation graphique de la progression de charge.</p>
            </div>
          </div>
          <div class="pilot-feature">
            <div class="pilot-feature-icon">💬</div>
            <div class="pilot-feature-text">
              <h4>Support int&eacute;gr&eacute;</h4>
              <p>En cas de probl&egrave;me avec une borne, l&rsquo;utilisateur peut signaler l&rsquo;incident directement depuis l&rsquo;application. La t&eacute;l&eacute;maintenance Sparklin prend le relais automatiquement.</p>
            </div>
          </div>
        </div>
        <div style="display:flex;gap:12px;margin-top:32px;" class="reveal">
          <a href="https://apps.apple.com/fr/app/sparklin/id1615738603" class="btn-primary">T&eacute;l&eacute;charger sur l&rsquo;App Store →</a>
          <a href="https://play.google.com/store/apps/details?id=io.sparklin.app&gl=FR" class="btn-outline">Google Play</a>
        </div>
      </div>
...
<section class="faq-section" style="background:var(--bg-off);padding:72px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    ...
    <h2 class="section-title" style="margin-bottom:36px;">Questions fréquentes</h2>
    <div class="faq-list">
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>L'application Sparklin est-elle disponible sur iOS et Android ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Oui, l'application Sparklin est disponible gratuitement sur l'App Store (iOS) et le Google Play Store (Android). Aucun abonnement n'est requis pour l'utiliser.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Faut-il créer un compte pour recharger ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Pour les bornes publiques, un simple scan du QR Code depuis l\'application suffit, sans création de compte. Pour les bornes privées, un compte permet de gérer les accès et le paiement.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Quels moyens de paiement sont acceptés ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>L\'app accepte les cartes bancaires (Visa, Mastercard, CB), Apple Pay et Google Pay. Les reçus sont générés automatiquement et disponibles dès la fin de la session dans votre historique.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Peut-on suivre une session à distance depuis l'app ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Oui. L'app affiche en temps réel la puissance instantanée, l'énergie délivrée et la durée restante estimée. Une notification est envoyée en fin de session.</p></div></div>
    </div>
  </div>
</section>
<section class="cta-close">
    <div class="made-tag">📱 Sparklin App &nbsp;&middot;&nbsp; iOS &amp; Android — gratuit</div>
    <h2 class="section-title">T&eacute;l&eacute;chargez l&rsquo;application Sparklin.</h2>
    <p class="section-body">Disponible gratuitement sur l&rsquo;App Store et le Google Play Store. Commencez &agrave; recharger en moins de deux minutes.</p>
    <div class="cta-close-actions">
      <a href="https://apps.apple.com/fr/app/sparklin/id1615738603" class="btn-primary-light">App Store →</a>
      <a href="https://play.google.com/store/apps/details?id=io.sparklin.app&gl=FR" class="btn-ghost">Google Play →</a>
    </div>
  </section>
</main>
