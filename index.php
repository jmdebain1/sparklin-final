...
<head>
  ...
  <title><?= tr('meta.home.title') ?></title>
  <meta name="description" content="<?= tr('meta.home.desc') ?>" data-i18n-meta="meta.home.desc"/>
...
<section style="background:var(--bg-off);padding:80px 0;border-top:1px solid var(--border);">
  <div class="sk-wrap" style="max-width:1280px;">
    ...
    <div class="home-net-feats" style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:24px;margin-top:56px;margin-bottom:36px;">
...
<section class="home-pitch">
  <div class="home-pitch-wrap">
    <div class="h-reveal-left">
      ...
      <h2 class="home-pitch-h2" data-i18n="pitch.h2"><?= tr('pitch.h2') ?></h2>
