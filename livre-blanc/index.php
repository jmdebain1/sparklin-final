...
<header class="livre-blanc-hero" style="background:var(--dark);padding:100px clamp(20px,5vw,80px);">
  <div class="sk-wrap" style="display:grid;grid-template-columns:1.2fr 0.8fr;gap:64px;align-items:center;">
    <div>
      <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(232,86,58,.15);border:1px solid rgba(232,86,58,.3);border-radius:100px;padding:4px 14px;margin-bottom:20px;">
        <span style="font-size:13px;">📘</span>
        <span style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:var(--orange);" data-i18n="lb.title"><?= tr('lb.title') ?></span>
      </div>
      <h1 style="font-family:var(--font-display);font-size:clamp(2rem,3.5vw,2.8rem);font-weight:800;color:#fff;line-height:1.15;margin-bottom:16px;" data-i18n="lb.h1a"><?= tr('lb.h1a') ?><em style="color:var(--orange);" data-i18n="lb.h1b"><?= tr('lb.h1b') ?></em></h1>
      <p style="font-size:15px;color:rgba(255,255,255,.6);line-height:1.75;margin-bottom:28px;">15 pages d'expertise terrain : réglementation LOM 2026, load balancing, remboursement URSSAF, roaming GIREVE. Le seul guide écrit par des déployeurs IRVE pour des gestionnaires de parc.</p>
      <div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:28px;">
        <span style="background:rgba(255,255,255,.1);color:rgba(255,255,255,.7);font-size:12px;padding:4px 12px;border-radius:100px;" data-i18n="lb.chip1"><?= tr('lb.chip1') ?></span>
        <span style="background:rgba(255,255,255,.1);color:rgba(255,255,255,.7);font-size:12px;padding:4px 12px;border-radius:100px;" data-i18n="lb.chip2"><?= tr('lb.chip2') ?></span>
        <span style="background:rgba(255,255,255,.1);color:rgba(255,255,255,.7);font-size:12px;padding:4px 12px;border-radius:100px;" data-i18n="lb.chip3"><?= tr('lb.chip3') ?></span>
        <span style="background:rgba(255,255,255,.1);color:rgba(255,255,255,.7);font-size:12px;padding:4px 12px;border-radius:100px;" data-i18n="lb.chip4"><?= tr('lb.chip4') ?></span>
      </div>
      <a href="#telechargement" class="btn-primary">📥 Télécharger gratuitement →</a>
    </div>
    <div style="display:flex;justify-content:center;">
      <div style="position:relative;">
        <div style="width:200px;height:280px;background:linear-gradient(135deg,#1a1a2e 0%,#2d2d48 100%);border-radius:8px 16px 16px 8px;box-shadow:6px 6px 0 rgba(232,86,58,.4),12px 12px 0 rgba(232,86,58,.15),0 32px 80px rgba(0,0,0,.5);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:28px;border-left:5px solid var(--orange);">
          <div style="font-size:40px;">📘</div>
          <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:var(--orange);text-align:center;line-height:1.4;" data-i18n="lb.cover.label"><?= tr('lb.cover.label') ?><br>Entreprise 2026</div>
          <div style="font-size:11px;color:rgba(255,255,255,.5);text-align:center;">15 pages · Gratuit</div>
          <div style="font-size:9px;font-weight:600;color:rgba(255,255,255,.3);text-transform:uppercase;letter-spacing:.12em;margin-top:8px;">sparklin</div>
        </div>
        <div style="position:absolute;top:-10px;right:-10px;background:var(--orange);color:#fff;font-size:10px;font-weight:700;padding:5px 10px;border-radius:100px;text-transform:uppercase;letter-spacing:.08em;" data-i18n="lb.free"><?= tr('lb.free') ?></div>
      </div>
    </div>
  </div>
</header>
...
<!-- ══ FORM ══ -->
<section id="telechargement" style="padding:80px clamp(20px,5vw,80px);">
  <div class="sk-wrap" style="display:grid;grid-template-columns:1fr 1fr;gap:64px;align-items:start;">
    <div>
      <span class="section-label">Téléchargement</span>
      <h2 style="font-family:var(--font-display);font-size:1.8rem;font-weight:800;color:var(--dark);margin-bottom:12px;" data-i18n="lb.f.label"><?= tr('lb.f.label') ?></h2>
      <p style="color:var(--text-mid);margin-bottom:32px;font-size:14px;" data-i18n="lb.f.nospam"><?= tr('lb.f.nospam') ?></p>
      <form name="livre-blanc" data-netlify="true" method="POST" action="/livre-blanc/merci/" id="lb-form" style="display:flex;flex-direction:column;gap:16px;" onsubmit="return handleLbSubmit(event)">
        <input type="hidden" name="form-name" value="livre-blanc"/>
        <div><label style="display:block;font-size:12px;font-weight:600;color:var(--text-mid);margin-bottom:6px;" data-i18n="contact.form.email"><?= tr('contact.form.email') ?></label><input required type="email" name="email" id="lb-email" placeholder="vous@entreprise.fr" style="width:100%;padding:12px 16px;border:1.5px solid var(--border);border-radius:10px;font-family:inherit;font-size:14px;outline:none;" onfocus="this.style.borderColor='var(--orange)'" onblur="this.style.borderColor='var(--border)'"/></div>
        <div><label style="display:block;font-size:12px;font-weight:600;color:var(--text-mid);margin-bottom:6px;" data-i18n="lb.form.name"><?= tr('lb.form.name') ?></label><input type="text" name="prenom" id="lb-prenom" placeholder="Jean" style="width:100%;padding:12px 16px;border:1.5px solid var(--border);border-radius:10px;font-family:inherit;font-size:14px;outline:none;" onfocus="this.style.borderColor='var(--orange)'" onblur="this.style.borderColor='var(--border)'"/></div>
        ...
        <button type="submit" id="lb-btn" style="background:var(--orange);color:#fff;border:none;padding:14px 28px;border-radius:10px;font-family:inherit;font-size:15px;font-weight:700;cursor:pointer;" onmouseover="this.style.background='#c94b31'" onmouseout="this.style.background='var(--orange)'">📥 Recevoir le guide gratuit →</button>
      ...
      async function handleLbSubmit(e) {
        ...
        var prenom = document.getElementById('lb-prenom').value.trim();
        var btn = document.getElementById('lb-btn');
        var errEl = document.getElementById('lb-error');
        ...
        btn.disabled = true;
        btn.innerHTML = '<span style="display:inline-block;width:16px;height:16px;border:2px solid rgba(255,255,255,.3);border-top-color:#fff;border-radius:50%;animation:lb-spin .7s linear infinite;margin-right:8px;"></span>Envoi en cours…';
    ...
    <div>
      ...
      <h3 style="font-family:var(--font-display);font-size:1.3rem;font-weight:700;color:var(--dark);margin-bottom:24px;">5 chapitres pour tout savoir sur l'IRVE.</h3>
      <div style="display:flex;flex-direction:column;gap:12px;">
        <div style="background:var(--bg-off);border-radius:12px;padding:16px 20px;border-left:3px solid var(--orange);"><div style="font-weight:700;color:var(--dark);font-size:14px;" data-i18n="lb.ch1.title"><?= tr('lb.ch1.title') ?></div><div style="font-size:13px;color:var(--text-mid);margin-top:4px;" data-i18n="lb.ch1.sub"><?= tr('lb.ch1.sub') ?></div></div>
        <div style="background:var(--bg-off);border-radius:12px;padding:16px 20px;border-left:3px solid var(--orange);"><div style="font-weight:700;color:var(--dark);font-size:14px;" data-i18n="lb.ch2.title"><?= tr('lb.ch2.title') ?></div><div style="font-size:13px;color:var(--text-mid);margin-top:4px;" data-i18n="lb.ch2.sub"><?= tr('lb.ch2.sub') ?></div></div>
        <div style="background:var(--bg-off);border-radius:12px;padding:16px 20px;border-left:3px solid var(--orange);"><div style="font-weight:700;color:var(--dark);font-size:14px;" data-i18n="lb.ch3.title"><?= tr('lb.ch3.title') ?></div><div style="font-size:13px;color:var(--text-mid);margin-top:4px;" data-i18n="lb.ch3.sub"><?= tr('lb.ch3.sub') ?></div></div>
        <div style="background:var(--bg-off);border-radius:12px;padding:16px 20px;border-left:3px solid var(--orange);"><div style="font-weight:700;color:var(--dark);font-size:14px;" data-i18n="lb.ch4.title"><?= tr('lb.ch4.title') ?></div><div style="font-size:13px;color:var(--text-mid);margin-top:4px;" data-i18n="lb.ch4.sub"><?= tr('lb.ch4.sub') ?></div></div>
        <div style="background:var(--bg-off);border-radius:12px;padding:16px 20px;border-left:3px solid var(--orange);"><div style="font-weight:700;color:var(--dark);font-size:14px;" data-i18n="lb.ch5.title"><?= tr('lb.ch5.title') ?></div><div style="font-size:13px;color:var(--text-mid);margin-top:4px;" data-i18n="lb.ch5.sub"><?= tr('lb.ch5.sub') ?></div></div>
      </div>
    </div>
  </div>
</section>
