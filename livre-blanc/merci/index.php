...
<head>
  ...
  <title><?= tr('meta.lb_merci.title') ?></title>
  <meta name="description" content="<?= tr('meta.lb_merci.desc') ?>" data-i18n-meta="meta.lb_merci.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.lb_merci.title'),'desc'=>tr('meta.lb_merci.desc'),'noindex'=>true]); ?>
</head>
<body>
