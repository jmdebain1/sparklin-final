...
<section style="padding:100px clamp(20px,5vw,80px);min-height:60vh;display:flex;align-items:center;justify-content:center;">
  <div style="max-width:520px;text-align:center;">
    ...
    <h1 style="font-family:var(--font-display);font-size:clamp(1.8rem,3.5vw,2.6rem);font-weight:800;color:var(--dark);margin-bottom:16px;line-height:1.15;">
      Votre guide est en route&nbsp;!
    </h1>
    <p style="font-size:15px;color:var(--text-mid);line-height:1.75;margin-bottom:32px;font-weight:300;">
      Un email avec le guide complet vous a été envoyé. Vérifiez votre boîte de réception — et vos spams si vous ne le voyez pas dans les prochaines minutes.
    </p>
      ...
      <div style="display:flex;align-items:center;gap:16px;justify-content:center;flex-wrap:wrap;">
        ...
        <div style="text-align:left;">
          ...
          <a href="/assets/livre-blanc-sparklin-2026.pdf" download="Guide-IRVE-Sparklin-2026.pdf"
             style="display:inline-flex;align-items:center;gap:6px;background:var(--orange);color:#fff;font-size:13px;font-weight:700;text-decoration:none;padding:9px 18px;border-radius:8px;">
