...
<head>
  ...
  <title><?= tr('meta.goe.title') ?></title>
  <meta name="description" content="<?= tr('meta.goe.desc') ?>" data-i18n-meta="meta.goe.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.goe.title'),'desc'=>tr('meta.goe.desc')]); ?>
</head>
<body>
...
<header class="hero">
  <div>
    ...
    <p class="hero-sub" data-i18n="goe.hero.sub"><?= t('goe.hero.sub') ?></p>
    <div class="hero-actions">
      <a href="/contact/" class="btn-primary" data-i18n="pilot.hero.cta1"><?= tr('pilot.hero.cta1') ?></a>
      <a href="#goe-versions" class="btn-outline" data-i18n="goe.hero.cta2"><?= t('goe.hero.cta2') ?></a>
    </div>
    <div class="hero-chips" style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;margin-top:20px;">
      <span class="chip"><span class="chip-dot"></span><span data-i18n="goe.power_range"><?= t('goe.power_range') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="goe.chip1"><?= t('goe.chip1') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="goe.chip2"><?= t('goe.chip2') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="goe.chip3"><?= t('goe.chip3') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="goe.chip4"><?= t('goe.chip4') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="goe.chip5"><?= t('goe.chip5') ?></span></span>
    </div>
  </div>
...
<section id="goe-versions" style="padding:80px clamp(20px,5vw,80px);background:var(--bg-off);">
  <div class="sk-wrap">
    <div style="text-align:center;margin-bottom:48px;">
      <span class="section-label" data-i18n="goe.versions.label"><?= t('goe.versions.label') ?></span>
      ...
      <p style="font-size:15px;color:var(--text-mid);max-width:560px;margin:16px auto 0;line-height:1.75;" data-i18n="goe.core_pro.desc"><?= t('goe.core_pro.desc') ?></p>
    </div>
    ...
    <div class="goe-versions-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:24px;max-width:900px;margin:0 auto;">
      ...
      <div style="background:#fff;border:2px solid var(--border);border-radius:20px;padding:36px;display:flex;flex-direction:column;gap:20px;">
        ...
        <p style="font-size:14px;color:var(--text-mid);line-height:1.7;" data-i18n="goe.core.desc"><?= t('goe.core.desc') ?></p>
        <ul style="list-style:none;display:flex;flex-direction:column;gap:10px;">
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;"><span style="color:#22C55E;font-weight:700;">✓</span> <span data-i18n="goe.versions.li_power"><?= t('goe.versions.li_power') ?></span></li>


          <li style="display:flex;align-items:center;gap:10px;font-size:13px;"><span style="color:#22C55E;font-weight:700;">✓</span> <span data-i18n="goe.versions.li_cable"><?= t('goe.versions.li_cable') ?></span></li>
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;"><span style="color:#22C55E;font-weight:700;">✓</span> <span data-i18n="goe.versions.li_app"><?= t('goe.versions.li_app') ?></span></li>
        ...
        <div style="margin-top:auto;padding:14px 18px;background:var(--bg-off);border-radius:12px;font-size:12px;color:var(--text-mid);">
          <strong style="color:var(--dark);" data-i18n="ui.ideal_for"><?= tr('ui.ideal_for') ?></strong> <span data-i18n="goe.core.ideal"><?= t('goe.core.ideal') ?></span>
        </div>
      </div>
      ...
      <div style="background:var(--dark);border:2px solid var(--orange);border-radius:20px;padding:36px;display:flex;flex-direction:column;gap:20px;position:relative;overflow:hidden;">
        ...
        <p style="font-size:14px;color:rgba(255,255,255,.65);line-height:1.7;" data-i18n="goe.pro.desc"><?= t('goe.pro.desc') ?></p>
        <ul style="list-style:none;display:flex;flex-direction:column;gap:10px;">
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;color:#fff;"><span style="color:var(--orange);font-weight:700;">✓</span> <span data-i18n="goe.versions.li_power"><?= t('goe.versions.li_power') ?></span></li>


          <li style="display:flex;align-items:center;gap:10px;font-size:13px;color:#fff;"><span style="color:var(--orange);font-weight:700;">✓</span> <span data-i18n="goe.versions.li_cable"><?= t('goe.versions.li_cable') ?></span></li>
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;color:#fff;"><span style="color:var(--orange);font-weight:700;">✓</span> <span data-i18n="goe.versions.li_app"><?= t('goe.versions.li_app') ?></span></li>
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;color:#fff;"><span style="color:var(--orange);font-weight:800;">✦</span> <strong data-i18n="gamme.s2.chip2"><?= tr('gamme.s2.chip2') ?></strong> <span data-i18n="goe.pro.li_mid"><?= t('goe.pro.li_mid') ?></span></li>
        </ul>
        <div style="margin-top:auto;padding:14px 18px;background:rgba(255,255,255,.07);border-radius:12px;font-size:12px;color:rgba(255,255,255,.6);">
          <strong style="color:#fff;" data-i18n="ui.ideal_for"><?= tr('ui.ideal_for') ?></strong> <span data-i18n="goe.pro.ideal"><?= t('goe.pro.ideal') ?></span>
        </div>
      </div>
    ...
    <div style="text-align:center;margin-top:32px;">
      <p style="font-size:13px;color:var(--text-light);margin-bottom:16px;" data-i18n="goe.versions.help"><?= t('goe.versions.help') ?></p>
...
<section class="intro-section">
  <div class="intro-text reveal">
    ...
    <p data-i18n="goe.eco.body"><?= t('goe.eco.body') ?></p>
    <ul class="feature-list">
      <li>✓ <span data-i18n="goe.eco.li1"><?= t('goe.eco.li1') ?></span></li>
      <li>✓ <span data-i18n="goe.eco.li2"><?= t('goe.eco.li2') ?></span></li>
      <li>✓ <span data-i18n="goe.eco.li3"><?= t('goe.eco.li3') ?></span></li>
...
<section class="pillars-section" style="background:var(--bg-off);">
  <div class="pillars-header reveal">
    <div>
      <span class="section-label" data-i18n="goe.why.label"><?= t('goe.why.label') ?></span>
      <h2 class="section-title" data-i18n="goe.why.h2"><?= t('goe.why.h2') ?></h2>
    </div>
    <p class="section-body" data-i18n="goe.why.body"><?= t('goe.why.body') ?></p>
  </div>
  <div class="pillars-grid">
    <div class="pillar-card reveal">
      <h3 data-i18n="goe.p1.title"><?= t('goe.p1.title') ?></h3>
      <p data-i18n="goe.p1.desc"><?= t('goe.p1.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <h3 data-i18n="goe.p2.title"><?= t('goe.p2.title') ?></h3>
      <p data-i18n="goe.p2.desc"><?= t('goe.p2.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <h3 data-i18n="goe.p3.title"><?= t('goe.p3.title') ?></h3>
      <p data-i18n="goe.p3.desc"><?= t('goe.p3.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <h3 data-i18n="goe.p4.title"><?= t('goe.p4.title') ?></h3>
      <p data-i18n="goe.p4.desc"><?= t('goe.p4.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <h3 data-i18n="goe.p5.title"><?= t('goe.p5.title') ?></h3>
      <p data-i18n="goe.p5.desc"><?= t('goe.p5.desc') ?></p>
    </div>
  </div>
</section>
...
<section class="specs-section" id="goe-specs">
  <div class="specs-layout">
    <div class="specs-list">
      ...
      <div class="spec-row"><span class="spec-name" data-i18n="s1.spec.power"><?= t('s1.spec.power') ?></span><span class="spec-val" data-i18n="goe.spec.power_v"><?= t('goe.spec.power_v') ?></span></div>
      <div class="spec-row"><span class="spec-name" data-i18n="s1.spec.connector"><?= t('s1.spec.connector') ?></span><span class="spec-val" data-i18n="goe.spec.connector_v"><?= t('goe.spec.connector_v') ?></span></div>
...
<section class="compare-banner">
  <div class="compare-banner-text">
    <h3 data-i18n="goe.cmp.h3"><?= t('goe.cmp.h3') ?></h3>
    <p data-i18n="goe.cmp.body"><?= t('goe.cmp.body') ?></p>
  </div>
  <div class="compare-cards">
    <a class="compare-card" href="/spark-1/"><div class="compare-card-name" data-i18n="gamme.s1.name"><?= tr('gamme.s1.name') ?></div><div class="compare-card-sub" data-i18n="goe.cmp.s1sub"><?= t('goe.cmp.s1sub') ?></div><div class="compare-card-badge" data-i18n="ui.discover"><?= tr('ui.discover') ?></div></a>
    <a class="compare-card" href="/spark-plus/"><div class="compare-card-name" data-i18n="gamme.s2.name"><?= tr('gamme.s2.name') ?></div><div class="compare-card-sub" data-i18n="goe.cmp.s2sub"><?= t('goe.cmp.s2sub') ?></div><div class="compare-card-badge" data-i18n="ui.discover"><?= tr('ui.discover') ?></div></a>
    <div class="compare-card current"><div class="compare-card-name" data-i18n="gamme.s3.name"><?= tr('gamme.s3.name') ?></div><div class="compare-card-sub" data-i18n="goe.cmp.s3sub"><?= t('goe.cmp.s3sub') ?></div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);" data-i18n="goe.cmp.current"><?= t('goe.cmp.current') ?></div></div>
  </div>
</section>
...
<section class="faq-section" style="background:var(--bg-off);padding:80px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    ...
    <h2 class="section-title" style="margin-bottom:40px;" data-i18n="s1.faq.h2"><?= t('s1.faq.h2') ?></h2>
    <div class="faq-list">
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="goe.faq.q1"><?= t('goe.faq.q1') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="goe.faq.a1"><?= t('goe.faq.a1') ?></p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="goe.faq.q2"><?= t('goe.faq.q2') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="goe.faq.a2"><?= t('goe.faq.a2') ?></p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="goe.faq.q3"><?= t('goe.faq.q3') ?></span><span class="faq-icon">+</span></button><div class="faq-answer"><p data-i18n="goe.faq.a3"><?= t('goe.faq.a3') ?></p></div></div>
    </div>
  </div>
</section>

<section class="cta-close">
  <div class="made-tag" data-i18n="goe.cta.tag"><?= t('goe.cta.tag') ?></div>
  <h2 class="section-title"><span data-i18n="goe.cta.h1a"><?= t('goe.cta.h1a') ?></span><br><em data-i18n="goe.cta.h1b"><?= t('goe.cta.h1b') ?></em></h2>
  <p class="section-body" data-i18n="goe.cta.body"><?= t('goe.cta.body') ?></p>
...
<div class="faq-item"><div class="faq-q" data-i18n="goe.faq.q2"><?= t('goe.faq.q2') ?></div><div class="faq-a" data-i18n="goe.faq.a2"><?= t('goe.faq.a2') ?></div></div>
<div class="faq-item"><div class="faq-q" data-i18n="goe.faq.q4"><?= t('goe.faq.q4') ?></div><div class="faq-a" data-i18n="goe.faq.a4"><?= t('goe.faq.a4') ?></div></div>
</footer>
