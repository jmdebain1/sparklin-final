...
<head>
  ...
  <title>Spark x Go-e – Borne 7-22kW</title>
...
<header class="hero">
  <div>
    <div class="hero-badge" data-i18n="goe.badge"><?= tr('goe.badge') ?></div>
    <h1 data-i18n="goe.hero.h1a"><?= tr('goe.hero.h1a') ?><em data-i18n="goe.hero.h1b"><?= tr('goe.hero.h1b') ?></em>
    </h1>
    <p class="hero-sub">Développée en partenariat avec go-e (Autriche), la Spark x Go-e est la borne de charge accélérée de l'écosystème Sparklin. Robuste, connectée, elle est supervisée depuis le même Spark Pilot que vos Spark Plus.</p>
    <div class="hero-actions">
      <a href="/contact/" class="btn-primary" data-i18n="pilot.hero.cta1"><?= tr('pilot.hero.cta1') ?></a>
      <a href="#goe-versions" class="btn-outline">CORE vs Pro →</a>
    </div>
    <div class="hero-chips" style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;margin-top:20px;">
      <span class="chip"><span class="chip-dot"></span>7,4 à 22 kW</span>
      <span class="chip"><span class="chip-dot"></span>Monophasée</span>
      <span class="chip"><span class="chip-dot"></span>Triphasée</span>
      <span class="chip"><span class="chip-dot"></span>Écran intégré</span>
      <span class="chip"><span class="chip-dot"></span>Price-Performance Winner Auto Bild &amp; P3 Wallbox Test</span>
      <span class="chip"><span class="chip-dot"></span>Installation simple</span>
    </div>
  </div>
...
<div class="trust-bar">
  <div class="trust-item"><strong>7,4 à 22 kW</strong></div>
...
<!-- ══ BLOC CORE vs PRO ══ -->
<section id="goe-versions" style="padding:80px clamp(20px,5vw,80px);background:var(--bg-off);">
  <div class="sk-wrap">
    <div style="text-align:center;margin-bottom:48px;">
      <span class="section-label">Deux versions</span>
      <h2 style="font-family:var(--font-display);font-size:clamp(1.8rem,3vw,2.4rem);font-weight:800;color:var(--dark);margin-top:8px;" data-i18n="goe.core_pro.h2"><?= tr('goe.core_pro.h2') ?><br><em data-i18n="goe.core_pro.sub"><?= tr('goe.core_pro.sub') ?></em></h2>
      <p style="font-size:15px;color:var(--text-mid);max-width:560px;margin:16px auto 0;line-height:1.75;">La diff&eacute;rence cl&eacute; entre les deux versions : le compteur MID — indispensable pour la facturation des kWh et des remboursements certifi&eacute;s.</p>
    </div>

    <div class="goe-versions-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:24px;max-width:900px;margin:0 auto;">

      <!-- CORE -->
      <div style="background:#fff;border:2px solid var(--border);border-radius:20px;padding:36px;display:flex;flex-direction:column;gap:20px;">
        <div>
          <div style="display:inline-flex;align-items:center;gap:8px;background:var(--bg-off);border-radius:100px;padding:5px 14px;margin-bottom:16px;">
            <span style="font-size:13px;">⚡</span>
            <span style="font-size:12px;font-weight:700;color:var(--dark);" data-i18n="goe.core.name"><?= tr('goe.core.name') ?></span>
          </div>
          <div style="font-family:var(--font-display);font-size:2.2rem;font-weight:800;color:var(--dark);margin-bottom:4px;" data-i18n="gamme.s3.chip1a"><?= tr('gamme.s3.chip1a') ?></div>
          <div style="font-size:14px;color:var(--text-mid);" data-i18n="goe.core.sub"><?= tr('goe.core.sub') ?></div>
        </div>
        <p style="font-size:14px;color:var(--text-mid);line-height:1.7;">La version standard. Parfaite pour les flottes d'entreprise avec gestion centralisée, les parkings à rotation rapide et les sites où la facturation au forfait suffit.</p>
        <ul style="list-style:none;display:flex;flex-direction:column;gap:10px;">
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;"><span style="color:#22C55E;font-weight:700;">✓</span> 7 à 22 kW · triphasé 32 A</li>
          
          
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;"><span style="color:#22C55E;font-weight:700;">✓</span> Câble Type 2 5m · verrouillable</li>
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;"><span style="color:#22C55E;font-weight:700;">✓</span> App Sparklin · badge RFID</li>
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;"><span style="color:var(--text-light);">—</span> <span style="color:var(--text-light);" data-i18n="goe.core.no_mid"><?= tr('goe.core.no_mid') ?></span></li>
        </ul>
        <div style="margin-top:auto;padding:14px 18px;background:var(--bg-off);border-radius:12px;font-size:12px;color:var(--text-mid);">
          <strong style="color:var(--dark);" data-i18n="ui.ideal_for"><?= tr('ui.ideal_for') ?></strong> flottes internes, parkings relais, sites industriels, facturation au forfait ou à l'abonnement.
        </div>
      </div>

      <!-- PRO -->
      <div style="background:var(--dark);border:2px solid var(--orange);border-radius:20px;padding:36px;display:flex;flex-direction:column;gap:20px;position:relative;overflow:hidden;">
        <div style="position:absolute;top:18px;right:18px;background:var(--orange);color:#fff;font-size:10px;font-weight:700;padding:4px 12px;border-radius:100px;text-transform:uppercase;letter-spacing:.08em;" data-i18n="ui.recommended"><?= tr('ui.recommended') ?></div>
        <div>
          <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,.1);border-radius:100px;padding:5px 14px;margin-bottom:16px;">
            <span style="font-size:13px;">🏅</span>
            <span style="font-size:12px;font-weight:700;color:#fff;">go-e Pro</span>
          </div>
          <div style="font-family:var(--font-display);font-size:2.2rem;font-weight:800;color:#fff;margin-bottom:4px;" data-i18n="gamme.s3.chip1a"><?= tr('gamme.s3.chip1a') ?></div>
          <div style="font-size:14px;color:rgba(255,255,255,.5);" data-i18n="goe.pro.sub"><?= tr('goe.pro.sub') ?></div>
        </div>
        <p style="font-size:14px;color:rgba(255,255,255,.65);line-height:1.7;">La version Pro ajoute un compteur MID certifié — obligatoire pour la facturation juridiquement opposable, le remboursement URSSAF des frais de charge à domicile, et la conformité LOM pour les bornes ouvertes au public.</p>
        <ul style="list-style:none;display:flex;flex-direction:column;gap:10px;">
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;color:#fff;"><span style="color:var(--orange);font-weight:700;">✓</span> 7 à 22 kW · triphasé 32 A</li>
          
          
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;color:#fff;"><span style="color:var(--orange);font-weight:700;">✓</span> Câble Type 2 5m · verrouillable</li>
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;color:#fff;"><span style="color:var(--orange);font-weight:700;">✓</span> App Sparklin · badge RFID</li>
          <li style="display:flex;align-items:center;gap:10px;font-size:13px;color:#fff;"><span style="color:var(--orange);font-weight:800;">✦</span> <strong data-i18n="gamme.s2.chip2"><?= tr('gamme.s2.chip2') ?></strong> — facturation opposable</li>
        </ul>
        <div style="margin-top:auto;padding:14px 18px;background:rgba(255,255,255,.07);border-radius:12px;font-size:12px;color:rgba(255,255,255,.6);">
          <strong style="color:#fff;" data-i18n="ui.ideal_for"><?= tr('ui.ideal_for') ?></strong> remboursement URSSAF, bornes publiques LOM, parkings hôteliers, collectivités, facturation au kWh.
        </div>
      </div>
    ...
    <div style="text-align:center;margin-top:32px;">
      <p style="font-size:13px;color:var(--text-light);margin-bottom:16px;">Vous hésitez entre CORE et Pro ? Notre équipe vous conseille selon votre contexte réglementaire.</p>
      <a href="/contact/" class="btn-primary" data-i18n="ui.request_advice"><?= tr('ui.request_advice') ?></a>
    </div>
  </div>
</section>
...
<section class="intro-section">
  <div class="intro-text reveal">
    <span class="section-label" data-i18n="splus.concept.label"><?= tr('splus.concept.label') ?></span>
    <h2 data-i18n="goe.ecosystem.h2"><?= tr('goe.ecosystem.h2') ?><br><em data-i18n="goe.ecosystem.h2b"><?= tr('goe.ecosystem.h2b') ?></em></h2>
    <p>La Spark x go-e s'intègre dans le même écosystème Spark Pilot que vos Spark Plus. Gérez un parc mixte depuis un seul tableau de bord — load balancing entre bornes lentes et rapides inclus.</p>
    <ul class="feature-list">
      <li>✓ Parc mixte go-e + Spark Plus sur Spark Pilot</li>
      <li>✓ Load balancing intelligent cross-bornes</li>
      <li>✓ Facturation unifiée pour tous les utilisateurs</li>
...
<section class="pillars-section" style="background:var(--bg-off);">
  <div class="pillars-header reveal">
    <div>
      <span class="section-label">Pourquoi go-e</span>
      <h2 class="section-title">La charge accélérée sans compromis.</h2>
    </div>
    <p class="section-body">La go-e est conçue pour les environnements exigeants : flottes intensives, parkings ouverts, rotations rapides.</p>
  </div>
  <div class="pillars-grid">
    <div class="pillar-card reveal">
      <h3>Puissance triphasée jusqu'à 22 kW</h3>
      <p>Rechargez une voiture standard en 1h30. Adapté aux rotations rapides de flotte, parkings relais et zones de livraison.</p>
    </div>
    <div class="pillar-card reveal">
      <h3>Toutes conditions, toutes saisons</h3>
      <p>Certifiée IP66 / IK08, opérationnelle de -25° à 40°C. Parfaite pour les parkings extérieurs, sites industriels et zones exposées.</p>
    </div>
    <div class="pillar-card reveal">
      <h3>Câble Type 2S de 6 mètres</h3>
      <p>Câble intégré verrouillable, compatible tous véhicules électriques du marché européen. Aucun accessoire requis.</p>
    </div>
    <div class="pillar-card reveal">
      <h3>Supervisée depuis Spark Pilot</h3>
      <p>Gestion unifiée avec vos Spark Plus depuis un seul tableau de bord. Load balancing entre bornes lentes et rapides inclus.</p>
    </div>
    <div class="pillar-card reveal">
      <h3>Reconnue par les tests indépendants</h3>
      <p>Price-Performance Winner Auto Bild et P3 Wallbox Test. La go-e s'impose comme la référence du marché sur son segment.</p>
    </div>
  </div>
</section>

<section class="specs-section" id="goe-specs">
  <div class="specs-layout">
    <div class="specs-list">
      <span class="section-label" data-i18n="s1.specs.h2"><?= tr('s1.specs.h2') ?></span>
      <h2 class="section-title" data-i18n="gamme.s3.name"><?= tr('gamme.s3.name') ?></h2>
      <div class="spec-row"><span class="spec-name">Puissance</span><span class="spec-val">7,4 à 22 kW (mono + triphasé)</span></div>
      <div class="spec-row"><span class="spec-name">Connecteur</span><span class="spec-val">Type 2S — câble 6 mètres</span></div>
      <div class="spec-row"><span class="spec-name">Certification</span><span class="spec-val">CE</span></div>
      <div class="spec-row"><span class="spec-name">Indices</span><span class="spec-val">IP66 · IK08</span></div>
      <div class="spec-row"><span class="spec-name">Communication</span><span class="spec-val">WiFi / 4G / RJ45</span></div>
      <div class="spec-row"><span class="spec-name">Protocole</span><span class="spec-val">OCPP 1.6 &amp; 2.0</span></div>
      <div class="spec-row"><span class="spec-name">Température</span><span class="spec-val">-25° à 40°C</span></div>
      <div class="spec-row"><span class="spec-name">Garantie</span><span class="spec-val">2 ans, support inclus</span></div>
    </div>
    </div>
...
<section class="compare-banner">
  <div class="compare-banner-text">
    <h3>Comparez toute la gamme Sparklin</h3>
    <p>La go-e est la bonne borne pour les flottes intensives et les parkings à forte rotation. Pour les stationnements longue durée, Spark Plus ou Spark 1 offrent un meilleur rapport usage/coût.</p>
  </div>
  <div class="compare-cards">
    <a class="compare-card" href="/spark-1/"><div class="compare-card-name" data-i18n="gamme.s1.name"><?= tr('gamme.s1.name') ?></div><div class="compare-card-sub">3,7 kW · Prise supervisée</div><div class="compare-card-badge" data-i18n="ui.discover"><?= tr('ui.discover') ?></div></a>
    <a class="compare-card" href="/spark-plus/"><div class="compare-card-name" data-i18n="gamme.s2.name"><?= tr('gamme.s2.name') ?></div><div class="compare-card-sub">3,7 kW · Premium &amp; MID</div><div class="compare-card-badge" data-i18n="ui.discover"><?= tr('ui.discover') ?></div></a>
    <div class="compare-card current"><div class="compare-card-name" data-i18n="gamme.s3.name"><?= tr('gamme.s3.name') ?></div><div class="compare-card-sub">7–22 kW · Accélérée</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);">Votre page</div></div>
  </div>
</section>

<section class="faq-section" style="background:var(--bg-off);padding:80px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    <span class="section-label">FAQ</span>
    <h2 class="section-title" style="margin-bottom:40px;">Questions fréquentes</h2>
    <div class="faq-list">
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Quelle est la différence entre CORE et Pro ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>La seule différence est le compteur MID certifié de la version Pro. Le MID est obligatoire pour émettre des factures juridiquement opposables au kWh — indispensable pour le remboursement URSSAF des frais de charge à domicile et pour les bornes ouvertes au public (conformité LOM).</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Peut-on mixer go-e et Spark Plus sur le même site ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Oui, c'est même l'usage recommandé : Spark Plus pour les stationnements longue durée, go-e pour les rotations rapides. Tout se supervise depuis un seul Spark Pilot avec load balancing cross-bornes.</p></div></div>
      <div class="faq-item"><button class="faq-question" onclick="toggleFaq(this)"><span>Quel triphasé est requis pour 22 kW ?</span><span class="faq-icon">+</span></button><div class="faq-answer"><p>Une alimentation triphasée 32 A est nécessaire pour atteindre 22 kW. La borne est réglable de 6 A (1,38 kW) à 32 A (22 kW) selon la puissance disponible — Spark Pilot gère ce réglage dynamiquement.</p></div></div>
    </div>
  </div>
</section>

<section class="cta-close">
  <div class="made-tag">⚡ Spark x go-e &nbsp;·&nbsp; Partenariat Sparklin × go-e Austria</div>
  <h2 class="section-title">Accélérez votre recharge.<br><em>Demandez un devis.</em></h2>
  <p class="section-body">Nos experts vous conseillent sur le bon mix Spark Plus / go-e CORE / go-e Pro pour votre parc.</p>
  <div class="cta-close-actions">
    <a href="/contact/" class="btn-primary-light" data-i18n="pilot.hero.cta1"><?= tr('pilot.hero.cta1') ?></a>
    <a href="/spark-pilot/" class="btn-ghost" data-i18n="hero.cta2"><?= tr('hero.cta2') ?></a>
  </div>
</section>
...
<div class="faq-item"><div class="faq-q">Peut-on mixer Go-e et Spark Plus sur le même site ?</div><div class="faq-a">Oui, c'est m&ecirc;me l'usage recommand&eacute; : Spark Plus pour les stationnements longue dur&eacute;e, go-e pour les rotations rapides. Tout se supervise depuis un seul Spark Pilot.</div></div>
<div class="faq-item"><div class="faq-q">Comment installer ma borne ? Quel triphasé est requis ?</div><div class="faq-a">La borne Spark x Go-e est monophas&eacute;e et triphas&eacute;e. Si vous souhaitez une puissance de 7,4 kW, la borne pourra &ecirc;tre install&eacute;e en monophas&eacute;. Pour une recharge 11-22 kW, il faudra une alimentation et un raccordement en triphas&eacute;. Si vous pr&eacute;voyez une hausse future des besoins, la borne peut &ecirc;tre install&eacute;e en triphas&eacute;e, et limit&eacute;e &agrave; 7,4 kW depuis le Spark Pilot, permettant de changer facilement la puissance sans refaire l'installation.</div></div>
</footer>
