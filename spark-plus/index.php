...
<head>
  ...
  <title><?= tr('meta.sparkplus.title') ?></title>
  <meta name="description" content="<?= tr('meta.sparkplus.desc') ?>" data-i18n-meta="meta.sparkplus.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.sparkplus.title'),'desc'=>tr('meta.sparkplus.desc')]); ?>
</head>
<body>
...
<header class="hero" style="background:var(--bg-off);">
  <div>
    ...
    <div class="hero-chips" style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;margin-top:20px;">
      <span class="chip"><span class="chip-dot"></span><span data-i18n="splus.chip1"><?= tr('splus.chip1') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="splus.chip2"><?= tr('splus.chip2') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="splus.chip3"><?= tr('splus.chip3') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="splus.chip4"><?= tr('splus.chip4') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="splus.chip5"><?= tr('splus.chip5') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="splus.chip6"><?= tr('splus.chip6') ?></span></span>
    </div>
  </div>
...
<div class="trust-bar">
  ...
  <div class="trust-item"><strong data-i18n="splus.trust5"><?= tr('splus.trust5') ?></strong></div>
...
<section class="intro-section">
  <div class="intro-text reveal">
    ...
    <p data-i18n="splus.intro.body"><?= tr('splus.intro.body') ?></p>
    ...
    <div style="margin-top:24px;">
      <a href="/spark-pilot/" class="btn-primary" data-i18n="splus.discover_pilot"><?= tr('splus.discover_pilot') ?></a>
    </div>
  </div>
...
<section class="pillars-section" style="background:var(--bg-off);">
  <div class="pillars-header reveal">
    <div>
      <span class="section-label" data-i18n="pilot.feat.h2"><?= tr('pilot.feat.h2') ?></span>
      <h2 class="section-title" data-i18n="splus.mgmt.h2"><?= tr('splus.mgmt.h2') ?></h2>
    </div>
    <p class="section-body" data-i18n="splus.mgmt.body"><?= tr('splus.mgmt.body') ?></p>
  </div>
  <div class="pillars-grid">
    <div class="pillar-card reveal">
      <div class="pillar-icon">💳</div>
      <h3 data-i18n="splus.f1.title"><?= tr('splus.f1.title') ?></h3>
      <p data-i18n="splus.f1.desc"><?= tr('splus.f1.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <div class="pillar-icon">⚡</div>
      <h3 data-i18n="splus.f2.title"><?= tr('splus.f2.title') ?></h3>
      <p data-i18n="splus.f2.desc"><?= tr('splus.f2.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <div class="pillar-icon">👥</div>
      <h3 data-i18n="splus.f3.title"><?= tr('splus.f3.title') ?></h3>
      <p data-i18n="splus.f3.desc"><?= tr('splus.f3.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <div class="pillar-icon">📊</div>
      <h3 data-i18n="splus.f4.title"><?= tr('splus.f4.title') ?></h3>
      <p data-i18n="splus.f4.desc"><?= tr('splus.f4.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <div class="pillar-icon">🔌</div>
      <h3 data-i18n="splus.f5.title"><?= tr('splus.f5.title') ?></h3>
      <p data-i18n="splus.f5.desc"><?= tr('splus.f5.desc') ?></p>
    </div>
    <div class="pillar-card reveal">
      <div class="pillar-icon">📱</div>
      <h3 data-i18n="splus.f6.title"><?= tr('splus.f6.title') ?></h3>
      <p data-i18n="splus.f6.desc"><?= tr('splus.f6.desc') ?></p>
    </div>
  </div>
</section>
...
<section class="specs-section" id="splus-specs">
  <div class="specs-layout">
    <div class="specs-list">
      <span class="section-label" data-i18n="splus.specs.label"><?= tr('splus.specs.label') ?></span>
      ...
      <div class="spec-row"><span class="spec-name" data-i18n="s1.spec.warranty"><?= tr('s1.spec.warranty') ?></span><span class="spec-val"><?= tr('splus.spec.warranty.v') ?></span></div>
    </div>
...
<section class="intro-section" style="background:var(--bg-off);">
  ...
  <div class="intro-text reveal">
    ...
    <h2 data-i18n="s1.pilot.h2a"><?= tr('s1.pilot.h2a') ?><br><em data-i18n="s1.pilot.h2b"><?= tr('s1.pilot.h2b') ?></em></h2>
    <p data-i18n="splus.pilot.body"><?= tr('splus.pilot.body') ?></p>
    <a href="/spark-pilot/" class="btn-primary" style="display:inline-block;margin-top:16px;" data-i18n="splus.discover_pilot"><?= tr('splus.discover_pilot') ?></a>
  </div>
</section>
...
<section class="faq-section" style="padding:80px clamp(20px,5vw,80px);">
  <div class="sk-wrap sk-wrap--narrow">
    ...
    <h2 class="section-title" style="margin-bottom:36px;" data-i18n="splus.faq.h2"><?= tr('splus.faq.h2') ?></h2>
    <div class="faq-list">
      <div class="faq-item">
        <button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="splus.faq.q1"><?= tr('splus.faq.q1') ?></span><span class="faq-icon">+</span></button>
        <div class="faq-answer"><p data-i18n="splus.faq.a1"><?= tr('splus.faq.a1') ?></p></div>
      </div>
      <div class="faq-item">
        <button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="splus.faq.q2"><?= tr('splus.faq.q2') ?></span><span class="faq-icon">+</span></button>
        <div class="faq-answer"><p data-i18n="splus.faq.a2"><?= tr('splus.faq.a2') ?></p></div>
      </div>
      <div class="faq-item">
        <button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="splus.faq.q3"><?= tr('splus.faq.q3') ?></span><span class="faq-icon">+</span></button>
        <div class="faq-answer"><p data-i18n="splus.faq.a3"><?= tr('splus.faq.a3') ?></p></div>
      </div>
      <div class="faq-item">
        <button class="faq-question" onclick="toggleFaq(this)"><span data-i18n="splus.faq.q4"><?= tr('splus.faq.q4') ?></span><span class="faq-icon">+</span></button>
        <div class="faq-answer"><p data-i18n="splus.faq.a4"><?= tr('splus.faq.a4') ?></p></div>
      </div>
    </div>
  </div>
</section>
...
<section class="compare-banner">
  <div class="compare-banner-text" style="text-align:center;">
    <h3 data-i18n="splus.cmp.h3"><?= tr('splus.cmp.h3') ?></h3>
    <p data-i18n="splus.cmp.body"><?= tr('splus.cmp.body') ?></p>
  </div>
  <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
    <a class="compare-card" href="/spark-1/"><div class="compare-card-name" data-i18n="gamme.s1.name"><?= tr('gamme.s1.name') ?></div><div class="compare-card-sub" data-i18n="pilot.cmp.sub1"><?= tr('pilot.cmp.sub1') ?></div><div class="compare-card-badge" data-i18n="splus.cmp.discover"><?= tr('splus.cmp.discover') ?></div></a>
    <div class="compare-card current"><div class="compare-card-name" data-i18n="gamme.s2.name"><?= tr('gamme.s2.name') ?></div><div class="compare-card-sub" data-i18n="splus.cmp.sub2"><?= tr('splus.cmp.sub2') ?></div><div class="compare-card-badge" style="background:rgba(255,255,255,.2);" data-i18n="s1.cmp.current"><?= tr('s1.cmp.current') ?></div></div>
    <a class="compare-card" href="/spark-go-e/"><div class="compare-card-name" data-i18n="gamme.s3.name"><?= tr('gamme.s3.name') ?></div><div class="compare-card-sub" data-i18n="splus.cmp.sub3"><?= tr('splus.cmp.sub3') ?></div><div class="compare-card-badge" data-i18n="splus.cmp.discover"><?= tr('splus.cmp.discover') ?></div></a>
    <a class="compare-card" href="/spark-pilot/"><div class="compare-card-name">Spark Pilot</div><div class="compare-card-sub" data-i18n="splus.cmp.sub4"><?= tr('splus.cmp.sub4') ?></div><div class="compare-card-badge" data-i18n="splus.cmp.discover"><?= tr('splus.cmp.discover') ?></div></a>
  </div>
</section>

<!-- ══ CTA ══ -->
<section class="cta-close">
  <div class="made-tag" data-i18n="splus.cta.tag"><?= tr('splus.cta.tag') ?></div>
  <h2 class="section-title" data-i18n="s1.cta.h2a"><?= tr('s1.cta.h2a') ?><br><em data-i18n="s1.cta.h2b"><?= tr('s1.cta.h2b') ?></em></h2>
  <p class="section-body" data-i18n="splus.cta.body"><?= tr('splus.cta.body') ?></p>
  <div class="cta-close-actions">
    <a href="/contact/" class="btn-primary" data-i18n="pilot.hero.cta1"><?= tr('pilot.hero.cta1') ?></a>
    <a href="/spark-pilot/" class="btn-outline" style="color:#fff;border-color:rgba(255,255,255,.35);" data-i18n="splus.discover_pilot2"><?= tr('splus.discover_pilot2') ?></a>
  </div>
</section>
...
<footer class="site-footer">
  <div class="footer-grid">
    ...
    <div class="footer-brand">
      ...
      <button class="sk-lang-opt sk-lang-opt-dark" data-lang="fr"<?= lang()==='fr'?' style="background:rgba(255,255,255,.10);font-weight:700;color:#fff;"':'' ?> href="?lang=fr" title="Français"><span>Français</span></button>
      <button class="sk-lang-opt sk-lang-opt-dark" data-lang="en"<?= lang()==='en'?' style="background:rgba(255,255,255,.10);font-weight:700;color:#fff;"':'' ?> href="?lang=en" title="English"><span>English</span></button>
      <button class="sk-lang-opt sk-lang-opt-dark" data-lang="de"<?= lang()==='de'?' style="background:rgba(255,255,255,.10);font-weight:700;color:#fff;"':'' ?> href="?lang=de" title="Deutsch"><span>Deutsch</span></button>
      <button class="sk-lang-opt sk-lang-opt-dark" data-lang="es"<?= lang()==='es'?' style="background:rgba(255,255,255,.10);font-weight:700;color:#fff;"':'' ?> href="?lang=es" title="Español"><span>Español</span></button>
      <button class="sk-lang-opt sk-lang-opt-dark" data-lang="th"<?= lang()==='th'?' style="background:rgba(255,255,255,.10);font-weight:700;color:#fff;"':'' ?> href="?lang=th" title="ภาษาไทย"><span>ภาษาไทย</span></button>
      <button class="sk-lang-opt sk-lang-opt-dark" data-lang="ms"<?= lang()==='ms'?' style="background:rgba(255,255,255,.10);font-weight:700;color:#fff;"':'' ?> href="?lang=ms" title="Bahasa Melayu"><span>Bahasa Melayu</span></button>
      <button class="sk-lang-opt sk-lang-opt-dark" data-lang="id"<?= lang()==='id'?' style="background:rgba(255,255,255,.10);font-weight:700;color:#fff;"':'' ?> href="?lang=id" title="Bahasa Indonesia"><span>Bahasa Indonesia</span></button>
      </div>
    </div>
    </div>
