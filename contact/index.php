...
<section class="contact-section" style="padding:80px clamp(20px,5vw,80px);">
  <div class="sk-wrap contact-layout" style="display:grid;grid-template-columns:1.2fr 0.8fr;gap:64px;align-items:start;">
    <div>
      ...
      <p style="color:var(--text-mid);margin-bottom:40px;font-size:15px;line-height:1.75;">Remplissez ce formulaire — notre équipe vous répond sous 48h avec une proposition adaptée.</p>
      <form name="contact" data-supabase="true" method="POST" action="/contact/" style="display:flex;flex-direction:column;gap:20px;">
        ...
        <div><label style="display:block;font-size:12px;font-weight:600;color:var(--text-mid);margin-bottom:6px;" data-i18n="contact.f.company"><?= tr('contact.f.company') ?></label><input type="text" name="entreprise" placeholder="Nom de votre société" style="width:100%;padding:12px 16px;border:1.5px solid var(--border);border-radius:10px;font-family:inherit;font-size:14px;outline:none;transition:border .15s;" onfocus="this.style.borderColor='var(--orange)'" onblur="this.style.borderColor='var(--border)'"/></div>
        <div><label style="display:block;font-size:12px;font-weight:600;color:var(--text-mid);margin-bottom:6px;" data-i18n="contact.form.type"><?= tr('contact.form.type') ?></label><select name="type_besoin" style="width:100%;padding:12px 16px;border:1.5px solid var(--border);border-radius:10px;font-family:inherit;font-size:14px;outline:none;background:#fff;"><option value="" data-i18n="contact.f.select"><?= tr('contact.f.select') ?></option><option>Parking entreprise</option><option data-i18n="contact.f.type1"><?= tr('contact.f.type1') ?></option><option data-i18n="contact.f.type2"><?= tr('contact.f.type2') ?></option><option data-i18n="contact.f.type3"><?= tr('contact.f.type3') ?></option><option>Autre</option></select></div>
        <div><label style="display:block;font-size:12px;font-weight:600;color:var(--text-mid);margin-bottom:6px;" data-i18n="contact.form.stations"><?= tr('contact.form.stations') ?></label><input type="text" name="nb_bornes" placeholder="ex: 10–20 bornes" style="width:100%;padding:12px 16px;border:1.5px solid var(--border);border-radius:10px;font-family:inherit;font-size:14px;outline:none;transition:border .15s;" onfocus="this.style.borderColor='var(--orange)'" onblur="this.style.borderColor='var(--border)'"/></div>
        <div><label style="display:block;font-size:12px;font-weight:600;color:var(--text-mid);margin-bottom:6px;" data-i18n="contact.form.message"><?= tr('contact.form.message') ?></label><textarea name="message" rows="4" placeholder="Décrivez votre projet…" style="width:100%;padding:12px 16px;border:1.5px solid var(--border);border-radius:10px;font-family:inherit;font-size:14px;outline:none;resize:vertical;transition:border .15s;" onfocus="this.style.borderColor='var(--orange)'" onblur="this.style.borderColor='var(--border)'"></textarea></div>
