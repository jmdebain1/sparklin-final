...
<head>
  ...
  <title><?= tr('meta.cas_collab.title') ?></title>
  <meta name="description" content="<?= tr('meta.cas_collab.desc') ?>" data-i18n-meta="meta.cas_collab.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.cas_collab.title'),'desc'=>tr('meta.cas_collab.desc')]); ?>
</head>
<body>
...
<div class="trust-bar"><div class="trust-item">⚖️ <span data-i18n="cas.collab.trust1"><?= tr('cas.collab.trust1') ?></span></div><div class="trust-item">🧾 <span data-i18n="cas.collab.trust2"><?= tr('cas.collab.trust2') ?></span></div><div class="trust-item">✅ <span data-i18n="cas.collab.trust3"><?= tr('cas.collab.trust3') ?></span></div><div class="trust-item">⏱️ <span data-i18n="cas.collab.trust4"><?= tr('cas.collab.trust4') ?></span></div><div class="trust-item">🔌 <span data-i18n="cas.collab.trust5"><?= tr('cas.collab.trust5') ?></span></div></div>

  <!-- INTRO NARRATIVE -->
  <section class="intro-section">
    <div class="intro-text reveal">
      <span class="section-label" data-i18n="cas.shared.context"><?= tr('cas.shared.context') ?></span>
      <h2 data-i18n="cas.collab.intro.h2"><?= tr('cas.collab.intro.h2') ?></h2>
      <p data-i18n="cas.collab.intro.p1"><?= tr('cas.collab.intro.p1') ?></p><p data-i18n="cas.collab.intro.p2"><?= tr('cas.collab.intro.p2') ?></p>
    </div>
  ...
  <section class="cas-problem">
    <div class="sk-wrap">
      <div class="reveal">
        ...
        <h2 class="section-title" data-i18n="cas.collab.prob.h2"><?= tr('cas.collab.prob.h2') ?></h2>
        <p class="section-body" data-i18n="cas.collab.prob.sub"><?= tr('cas.collab.prob.sub') ?></p>
      </div>
      <div class="cas-problem-grid reveal">

        <div class="cas-obstacle"><h4 data-i18n="cas.collab.obs1.title"><?= tr('cas.collab.obs1.title') ?></h4><p data-i18n="cas.collab.obs1.body"><?= tr('cas.collab.obs1.body') ?></p></div>

        <div class="cas-obstacle"><h4 data-i18n="cas.collab.obs2.title"><?= tr('cas.collab.obs2.title') ?></h4><p data-i18n="cas.collab.obs2.body"><?= tr('cas.collab.obs2.body') ?></p></div>

        <div class="cas-obstacle"><h4 data-i18n="cas.collab.obs3.title"><?= tr('cas.collab.obs3.title') ?></h4><p data-i18n="cas.collab.obs3.body"><?= tr('cas.collab.obs3.body') ?></p></div>

        <div class="cas-obstacle"><h4 data-i18n="cas.collab.obs4.title"><?= tr('cas.collab.obs4.title') ?></h4><p data-i18n="cas.collab.obs4.body"><?= tr('cas.collab.obs4.body') ?></p></div>
  ...
  <section class="cas-solution">
    <div class="sk-wrap">
      <div class="reveal">
        <span class="section-label" data-i18n="cas.collab.sol.label"><?= tr('cas.collab.sol.label') ?></span>
        <h2 class="section-title" data-i18n="cas.collab.sol.h2"><?= tr('cas.collab.sol.h2') ?></h2>
        <p class="section-body" style="margin-bottom:0;" data-i18n="cas.collab.sol.sub"><?= tr('cas.collab.sol.sub') ?></p>
      </div>
      <div class="cas-solution-steps">

        <div class="cas-step reveal">
          <div class="cas-step-num">1</div>
          <div class="cas-step-content"><h3 data-i18n="cas.collab.step1.title"><?= tr('cas.collab.step1.title') ?></h3><p data-i18n="cas.collab.step1.p1"><?= tr('cas.collab.step1.p1') ?></p><p data-i18n="cas.collab.step1.p2"><?= tr('cas.collab.step1.p2') ?></p><p data-i18n="cas.collab.step1.p3"><?= tr('cas.collab.step1.p3') ?></p></div>
        </div>

        <div class="cas-step reveal">
          <div class="cas-step-num">2</div>
          <div class="cas-step-content"><h3 data-i18n="cas.collab.step2.title"><?= tr('cas.collab.step2.title') ?></h3><p data-i18n="cas.collab.step2.p1"><?= tr('cas.collab.step2.p1') ?></p><p data-i18n="cas.collab.step2.p2"><?= tr('cas.collab.step2.p2') ?></p><p data-i18n="cas.collab.step2.p3"><?= tr('cas.collab.step2.p3') ?></p></div>
        </div>

        <div class="cas-step reveal">
          <div class="cas-step-num">3</div>
          <div class="cas-step-content"><h3 data-i18n="cas.collab.step3.title"><?= tr('cas.collab.step3.title') ?></h3><p data-i18n="cas.collab.step3.p1"><?= tr('cas.collab.step3.p1') ?></p><p data-i18n="cas.collab.step3.p2"><?= tr('cas.collab.step3.p2') ?></p></div>
        </div>

        <div class="cas-step reveal">
          <div class="cas-step-num">4</div>
          <div class="cas-step-content"><h3 data-i18n="cas.collab.step4.title"><?= tr('cas.collab.step4.title') ?></h3><p data-i18n="cas.collab.step4.p1"><?= tr('cas.collab.step4.p1') ?></p><p data-i18n="cas.collab.step4.p2"><?= tr('cas.collab.step4.p2') ?></p></div>
        </div>
  ...
  <section class="pilot-section" style="background:var(--bg-off);">
    <div class="pilot-layout">
      <div>
        ...
        <h2 class="section-title reveal" data-i18n="cas.collab.pilot.h2"><?= tr('cas.collab.pilot.h2') ?></h2>
        <p class="section-body reveal" data-i18n="cas.collab.pilot.sub"><?= tr('cas.collab.pilot.sub') ?></p>
        <div class="pilot-features reveal">
          <div class="pilot-feature">
            <div class="pilot-feature-icon">👥</div>
            <div class="pilot-feature-text"><h4 data-i18n="cas.collab.pf1.title"><?= tr('cas.collab.pf1.title') ?></h4><p data-i18n="cas.collab.pf1.body"><?= tr('cas.collab.pf1.body') ?></p></div>
          </div>
          <div class="pilot-feature">
            <div class="pilot-feature-icon">🧾</div>
            <div class="pilot-feature-text"><h4 data-i18n="cas.collab.pf2.title"><?= tr('cas.collab.pf2.title') ?></h4><p data-i18n="cas.collab.pf2.body"><?= tr('cas.collab.pf2.body') ?></p></div>
          </div>
          <div class="pilot-feature">
            <div class="pilot-feature-icon">📊</div>
            <div class="pilot-feature-text"><h4 data-i18n="cas.collab.pf3.title"><?= tr('cas.collab.pf3.title') ?></h4><p data-i18n="cas.collab.pf3.body"><?= tr('cas.collab.pf3.body') ?></p></div>
          </div>
          <div class="pilot-feature">
            <div class="pilot-feature-icon">🔔</div>
            <div class="pilot-feature-text"><h4 data-i18n="cas.collab.pf4.title"><?= tr('cas.collab.pf4.title') ?></h4><p data-i18n="cas.collab.pf4.body"><?= tr('cas.collab.pf4.body') ?></p></div>
          </div>
        </div>
      </div>
  ...
  <section class="cas-chiffres" id="collab-chiffres">
    <div class="sk-wrap">
      <div class="reveal">
        <span class="section-label" data-i18n="cas.collab.ex.label"><?= tr('cas.collab.ex.label') ?></span>
        <h2 class="section-title" data-i18n="cas.collab.ex.h2"><?= tr('cas.collab.ex.h2') ?></h2>
        <p class="section-body" style="margin-top:12px;" data-i18n="cas.collab.ex.sub"><?= tr('cas.collab.ex.sub') ?></p>
      </div>
      <div class="cas-table-wrap reveal" style="margin-top:32px;">
        <table style="width:100%;border-collapse:collapse;font-size:14px;font-family:var(--font-body);">
          <thead><tr style="border-bottom:2px solid var(--border-dark);"><th style="text-align:left;padding:14px 16px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-light);" data-i18n="cas.collab.tbl.col1"><?= tr('cas.collab.tbl.col1') ?></th><th style="text-align:center;padding:14px 16px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-light);" data-i18n="cas.collab.tbl.col2"><?= tr('cas.collab.tbl.col2') ?></th><th style="text-align:center;padding:14px 16px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-light);" data-i18n="cas.collab.tbl.col3"><?= tr('cas.collab.tbl.col3') ?></th></tr></thead>
          <tbody><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.collab.tbl.r1"><?= tr('cas.collab.tbl.r1') ?></td><td style="padding:14px 16px;text-align:center;" data-i18n="cas.collab.tbl.r1a"><?= tr('cas.collab.tbl.r1a') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);" data-i18n="cas.collab.tbl.r1b"><?= tr('cas.collab.tbl.r1b') ?></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.collab.tbl.r2"><?= tr('cas.collab.tbl.r2') ?></td><td style="padding:14px 16px;text-align:center;" data-i18n="cas.collab.tbl.r2a"><?= tr('cas.collab.tbl.r2a') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);" data-i18n="cas.collab.tbl.r2b"><?= tr('cas.collab.tbl.r2b') ?></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.collab.tbl.r3"><?= tr('cas.collab.tbl.r3') ?></td><td style="padding:14px 16px;text-align:center;" data-i18n="cas.collab.tbl.r3a"><?= tr('cas.collab.tbl.r3a') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);" data-i18n="cas.collab.tbl.r3b"><?= tr('cas.collab.tbl.r3b') ?></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.collab.tbl.r4"><?= tr('cas.collab.tbl.r4') ?></td><td style="padding:14px 16px;text-align:center;" data-i18n="cas.collab.tbl.r4a"><?= tr('cas.collab.tbl.r4a') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);" data-i18n="cas.collab.tbl.r4b"><?= tr('cas.collab.tbl.r4b') ?></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.collab.tbl.r5"><?= tr('cas.collab.tbl.r5') ?></td><td style="padding:14px 16px;text-align:center;">N/A</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);" data-i18n="cas.collab.tbl.r5b"><?= tr('cas.collab.tbl.r5b') ?></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-dark);"><strong data-i18n="cas.collab.tbl.r6"><?= tr('cas.collab.tbl.r6') ?></strong></td><td style="padding:14px 16px;text-align:center;"></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);font-weight:700;color:var(--orange);"><strong data-i18n="cas.collab.tbl.r6b"><?= tr('cas.collab.tbl.r6b') ?></strong></td></tr></tbody>
        </table>
      </div>
      <p style="font-size:13px;color:var(--text-light);margin-top:16px;font-style:italic;" class="reveal" data-i18n="cas.collab.ex.note"><?= tr('cas.collab.ex.note') ?></p>
    </div>
  </section>
  ...
  <section class="cas-reglementation">
    <div class="sk-wrap">
      <div class="reveal">
        ...
        <h2 class="section-title" data-i18n="cas.collab.reg.h2"><?= tr('cas.collab.reg.h2') ?></h2>
        <p class="section-body" style="margin-top:12px;" data-i18n="cas.collab.reg.sub"><?= tr('cas.collab.reg.sub') ?></p>
      </div>
      <div class="cas-reglementation-grid reveal">
        <div class="cas-regle-card"><h4 data-i18n="cas.collab.reg1.title"><?= tr('cas.collab.reg1.title') ?></h4><p data-i18n="cas.collab.reg1.body"><?= tr('cas.collab.reg1.body') ?></p></div>
        <div class="cas-regle-card"><h4 data-i18n="cas.collab.reg2.title"><?= tr('cas.collab.reg2.title') ?></h4><p data-i18n="cas.collab.reg2.body"><?= tr('cas.collab.reg2.body') ?></p></div>
        <div class="cas-regle-card"><h4 data-i18n="cas.collab.reg3.title"><?= tr('cas.collab.reg3.title') ?></h4><p data-i18n="cas.collab.reg3.body"><?= tr('cas.collab.reg3.body') ?></p></div>
        <div class="cas-regle-card"><h4 data-i18n="cas.collab.reg4.title"><?= tr('cas.collab.reg4.title') ?></h4><p data-i18n="cas.collab.reg4.body"><?= tr('cas.collab.reg4.body') ?></p></div>
      </div>
    </div>
  </section>
  ...
  <section class="faq-section">
    <div class="faq-layout">
      <div class="faq-header reveal"><span class="section-label">FAQ</span><h2 class="section-title" data-i18n="cas.collab.faq.h2"><?= tr('cas.collab.faq.h2') ?></h2></div>
      <div class="faq-list reveal">        <div class="faq-item">
          <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q1"><?= tr('support.collab.q1') ?><span class="faq-icon">+</span></button>
          <div class="faq-answer"><p data-i18n="cas.collab.faq.a1"><?= tr('cas.collab.faq.a1') ?></p></div>
        </div>        <div class="faq-item">
          <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q2"><?= tr('support.collab.q2') ?><span class="faq-icon">+</span></button>
          <div class="faq-answer"><p data-i18n="cas.collab.faq.a2"><?= tr('cas.collab.faq.a2') ?></p></div>
        </div>        <div class="faq-item">
          <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q3"><?= tr('support.collab.q3') ?><span class="faq-icon">+</span></button>
          <div class="faq-answer"><p data-i18n="cas.collab.faq.a3"><?= tr('cas.collab.faq.a3') ?></p></div>
        </div>        <div class="faq-item">
          <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q4"><?= tr('support.collab.q4') ?><span class="faq-icon">+</span></button>
          <div class="faq-answer"><p data-i18n="cas.collab.faq.a4"><?= tr('cas.collab.faq.a4') ?></p></div>
        </div>        <div class="faq-item">
          <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q5"><?= tr('support.collab.q5') ?><span class="faq-icon">+</span></button>
          <div class="faq-answer"><p data-i18n="cas.collab.faq.a5"><?= tr('cas.collab.faq.a5') ?></p></div>
        </div>        </div>
    </div>
  </section>
  ...
  <div class="compare-banner">
    ...
    <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
      ...
      <div class="compare-card current"><div class="compare-card-name" data-i18n="cas.collab.title"><?= tr('cas.collab.title') ?></div><div class="compare-card-sub">Domicile · MID</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);" data-i18n="cas.shared.your_page"><?= tr('cas.shared.your_page') ?></div></div>
  ...
  <section class="cta-close">
    <div class="made-tag" data-i18n="cas.collab.cta.tag"><?= tr('cas.collab.cta.tag') ?></div>
    <h2 class="section-title" data-i18n="cas.collab.cta.h2"><?= tr('cas.collab.cta.h2') ?></h2>
    <p class="section-body" data-i18n="cas.collab.cta.body"><?= tr('cas.collab.cta.body') ?></p>
    <div class="cta-close-actions">
      <a href="/contact/" class="btn-primary-light" data-i18n="hero.cta1"><?= tr('hero.cta1') ?></a>
      <a href="/contact/" class="btn-ghost" data-i18n="cas.shared.talk_expert"><?= tr('cas.shared.talk_expert') ?></a>
    </div>
  </section>
</main>
