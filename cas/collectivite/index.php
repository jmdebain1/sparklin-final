...
<head>
  ...
  <title>Collectivités — Cas client Sparklin | Sparklin</title>
...
<section class="cas-hero">
    <div>
      <div class="hero-badge" data-i18n="cas.coll.hero.badge"><?= tr('cas.coll.hero.badge') ?></div>
      <h1 data-i18n="cas.coll.h1a"><?= tr('cas.coll.h1a') ?><em data-i18n="cas.coll.h1b"><?= tr('cas.coll.h1b') ?></em></h1>
      <p>Une collectivité qui déploie des bornes de recharge publiques peut en faire un service rentable plutôt qu'un centre de coût. Le load balancing Sparklin élimine le besoin de renforcement électrique, des solutions adapt&eacute;es aux usages r&eacute;duisent les frais d’investissement, et un paiement en ligne g&eacute;n&egrave;re les revenus simplement.</p>
      <div style="display:flex;gap:14px;flex-wrap:wrap;"><a href="/contact/" class="btn-primary" data-i18n="pilot.hero.cta1"><?= tr('pilot.hero.cta1') ?></a><a href="#collectivite-chiffres" class="btn-outline" data-i18n="ui.see_comparison"><?= tr('ui.see_comparison') ?></a></div>
    </div>
    <div style="width:100%;min-height:400px;max-height:520px;overflow:hidden;border-radius:20px;">
      <img src="/assets/images/parking-right.jpg" alt="Parking public équipé de bornes Sparklin" style="width:100%;height:100%;object-fit:cover;object-position:center 10%;border-radius:20px;" loading="lazy"/>
    </div>
  </section>

  <div class="trust-bar"><div class="trust-item">🏛️ <span>Collectivit&eacute; <strong>op&eacute;rateur CPO</strong></span></div><div class="trust-item">💶 <span>CAPEX <strong>&divide;20</strong> vs bornes rapides</span></div><div class="trust-item">⚖️ <span>Conformit&eacute; <strong>loi LOM</strong></span></div><div class="trust-item">🌐 <span>Interop&eacute;rabilit&eacute; <</strong></span></div></div>

  <section class="intro-section" id="cas-collectivite-details">
    <div class="intro-text reveal">
      <span class="section-label" data-i18n="cas.shared.problem"><?= tr('cas.shared.problem') ?></span>
      <h2>Trois obstacles qui bloquent les projets de recharge publique.</h2>
      <p><strong style="color:var(--text-dark);" data-i18n="cas.coll.capex"><?= tr('cas.coll.capex') ?></strong> Une borne rapide de 22 &agrave; 50 kW co&ucirc;te entre 3 000 et 15 000 &euro; &agrave; l&rsquo;achat, sans compter le g&eacute;nie civil, le raccordement renforc&eacute; et la mise aux normes. Pour vingt places, la facture peut atteindre plusieurs centaines de milliers d&rsquo;euros avant d&rsquo;avoir charg&eacute; un seul v&eacute;hicule.</p>
      <p><strong style="color:var(--text-dark);">L&rsquo;OPEX est ing&eacute;rable.</strong> Les contrats de service sur des bornes rapides tournent souvent entre 400 et 800 &euro; par borne et par an. Multipli&eacute;s par vingt bornes, ces co&ucirc;ts r&eacute;currents repr&eacute;sentent un budget annuel que peu de collectivit&eacute;s ont anticip&eacute;.</p>
      <p><strong style="color:var(--text-dark);">Le mod&egrave;le &eacute;conomique ne tient pas.</strong> Avec un taux d&rsquo;utilisation r&eacute;el souvent inf&eacute;rieur &agrave; 20&nbsp;% et des recettes insuffisantes, l&rsquo;infrastructure devient un centre de co&ucirc;ts chronique &mdash; au d&eacute;triment d&rsquo;autres investissements publics.</p>
    </div>
    <div class="intro-image reveal" style="min-height:300px;aspect-ratio:4/3;">
      <img src="/assets/images/dashboard-imac.jpg" alt="Tableau de bord Spark Pilot &mdash; supervision parking public collectivit&eacute;"/>
    </div>
  </section>

  <div class="gallery-strip">
    <div><img src="/assets/images/borne-voiture-jaune.jpg" alt="Parking public &mdash; borne Sparklin en centre-ville"/></div>
    <div><img src="/assets/images/borne-voiture-blanche.jpg" alt="Borne Sparklin install&eacute;e en ext&eacute;rieur &mdash; usage collectivit&eacute;"/></div>
    <div><img src="/assets/images/borne-close-homme.jpg" alt="D&eacute;tail borne et c&acirc;ble Sparklin &mdash; parking public"/></div>
  </div>

  <section class="pillars-section">
    <div class="pillars-header reveal">
      <span class="section-label">La solution Sparklin</span>
      <h2 class="section-title">Trois piliers pour un service public de recharge &agrave; l&rsquo;&eacute;quilibre financier.</h2>
    </div>
    <div class="pillars-grid">
      <div class="pillar-card reveal">
        <div class="pillar-icon">💶</div>
        <h3>Un CAPEX r&eacute;duit au strict minimum</h3>
        <p>Les prises Sparklin fonctionnent en charge lente &agrave; 3,7 kW &mdash; moins de 300 &euro; l&rsquo;unit&eacute;, contre plusieurs milliers pour une borne rapide. Pas de renforcement de raccordement, pas de demande de puissance suppl&eacute;mentaire &agrave; Enedis, pas de tranch&eacute;es. La collectivit&eacute; s&rsquo;appuie sur son abonnement &eacute;lectrique existant et d&eacute;ploie ses points de charge en quelques jours, sans chantier lourd.</p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">📊</div>
        <h3>Un OPEX ma&icirc;tris&eacute; via Spark Pilot</h3>
        <p>Depuis une interface unique, la collectivit&eacute; visualise en temps r&eacute;el l&rsquo;&eacute;tat de chaque point de charge et les &eacute;ventuelles anomalies. La t&eacute;l&eacute;maintenance est int&eacute;gr&eacute;e&nbsp;: la grande majorit&eacute; des incidents se r&eacute;sout &agrave; distance. Le load balancing garantit que la consommation &eacute;lectrique ne d&eacute;passe jamais le plafond de souscription, m&ecirc;me quand toutes les prises sont simultan&eacute;ment en charge.</p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">🏛️</div>
        <h3>La collectivit&eacute; devient CPO</h3>
        <p>Sparklin propose aux collectivités de devenir elles-mêmes opérateur de leurs points de charge (CPO) via la plateforme, ou de déléguer ce rôle à Sparklin. Chaque session génère une recette directe, reversée automatiquement.</p>
      </div>
    </div>
  </section>
  ...
  <section class="specs-section" style="background:var(--bg-off);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;"><span class="section-label">Exemple chiffr&eacute;</span><h2 class="section-title">Parking public centre-ville &middot; 20 places &middot; rotation 3 v&eacute;hicules/place/jour</h2></div>
      <div class="reveal" style="overflow-x:auto;margin-bottom:32px;">
        <table style="width:100%;border-collapse:collapse;font-size:14px;font-family:var(--font-body);">
          ...
          <tbody>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">Co&ucirc;t mat&eacute;riel (10 points de charge)</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">3&nbsp;600&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">14&nbsp;000&nbsp;&euro;</td></tr>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">Travaux et installation</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">20&nbsp;000&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">37&nbsp;000&nbsp;&euro;</td></tr>
            ...
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">OPEX&nbsp;/ maintenance annuel</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">500&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">3&nbsp;000&nbsp;&euro;</td></tr>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">Recettes annuelles</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">2&nbsp;040&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">2&nbsp;040&nbsp;&euro;</td></tr>
            <tr style="border-bottom:1px solid var(--border);font-weight:600;"><td style="padding:14px 16px;color:var(--text-dark);"><strong>R&eacute;sultat annuel net</strong></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);font-weight:700;color:var(--orange);"><strong>+&nbsp;640&nbsp;&euro;</strong></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><strong>&minus;&nbsp;960&nbsp;&euro;</strong></td></tr>
          </tbody>
        </table>
      </div>
      <div class="reveal" style="background:rgba(232,86,58,0.05);border:1.5px solid rgba(232,86,58,0.15);border-radius:16px;padding:28px;">
        <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">Le mod&egrave;le Sparklin ne promet pas des recettes exceptionnelles. Il promet quelque chose de plus pr&eacute;cieux pour une collectivit&eacute;&nbsp;: <strong style="color:var(--text-dark);">la ma&icirc;trise des co&ucirc;ts et l&rsquo;absence de d&eacute;ficit chronique sur un service public.</strong> <em>Hypoth&egrave;ses&nbsp;: tarif 0,35 &euro;/kWh, session moyenne 8 kWh, taux d&rsquo;usage 20% conservateur, 300 jours/an.</em></p>
      </div>
    </div>
  </section>
  ...
  <section class="pilot-section" style="background:var(--bg-white);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;"><span class="section-label">R&eacute;glementation &amp; financement</span><h2 class="section-title">Anticiper les obligations LOM &mdash; avec du financement disponible.</h2></div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;" class="reveal">
        <div class="pillar-card"><div class="pillar-icon">⚖️</div><h3>Loi LOM &amp; ZFE</h3><p>La loi d&rsquo;orientation des mobilit&eacute;s fixe des obligations croissantes d&rsquo;&eacute;quipement des parkings publics en points de recharge. Les zones &agrave; faibles &eacute;missions (ZFE) acc&eacute;l&egrave;rent la demande. S&rsquo;&eacute;quiper maintenant, c&rsquo;est anticiper ces obligations sans les subir dans l&rsquo;urgence.</p></div>
        
        <div class="pillar-card"><div class="pillar-icon">🇪🇺</div><h3>Fonds europ&eacute;ens FEDER</h3><p>Selon les r&eacute;gions, des fonds europ&eacute;ens (FEDER, FEAMP) peuvent compl&eacute;ter le financement des infrastructures de recharge publiques. Les collectivit&eacute;s b&eacute;n&eacute;ficient d&rsquo;un acc&egrave;s prioritaire pour les projets contribuant &agrave; la transition &eacute;nerg&eacute;tique.</p></div>
        <div class="pillar-card"><div class="pillar-icon">🏛️</div></section>
    ...
    <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
      ...
      <div class="compare-card current"><div class="compare-card-name">Collectivité</div><div class="compare-card-sub">CPO · Mobilité</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);">Votre page</div></div>
    </div>
  </div>
