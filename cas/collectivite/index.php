...
<head>
  ...
  <title><?= tr('meta.cas_coll.title') ?></title>
  <meta name="description" content="<?= tr('meta.cas_coll.desc') ?>" data-i18n-meta="meta.cas_coll.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.cas_coll.title'),'desc'=>tr('meta.cas_coll.desc')]); ?>
</head>
<body>
...
<section class="cas-hero">
    <div>
      ...
      <p data-i18n="cas.coll.lead"><?= tr('cas.coll.lead') ?></p>
  ...
  <div class="trust-bar"><div class="trust-item">🏛️ <span data-i18n="cas.coll.trust1"><?= tr('cas.coll.trust1') ?></span></div><div class="trust-item">💶 <span data-i18n="cas.coll.trust2"><?= tr('cas.coll.trust2') ?></span></div><div class="trust-item">⚖️ <span data-i18n="cas.coll.trust3"><?= tr('cas.coll.trust3') ?></span></div><div class="trust-item">🌐 <span data-i18n="cas.coll.trust4"><?= tr('cas.coll.trust4') ?></span></div></div>
  ...
  <section class="intro-section" id="cas-collectivite-details">
    <div class="intro-text reveal">
      ...
      <h2 data-i18n="cas.coll.intro.h2"><?= tr('cas.coll.intro.h2') ?></h2>
      <p><strong style="color:var(--text-dark);" data-i18n="cas.coll.capex"><?= tr('cas.coll.capex') ?></strong> <span data-i18n="cas.coll.intro.p1"><?= tr('cas.coll.intro.p1') ?></span></p>
      <p data-i18n="cas.coll.intro.p2"><?= tr('cas.coll.intro.p2') ?></p>
      <p data-i18n="cas.coll.intro.p3"><?= tr('cas.coll.intro.p3') ?></p>
    </div>
    <div class="intro-image reveal" style="min-height:300px;aspect-ratio:4/3;">
      <img src="/assets/images/dashboard-imac.jpg" alt="Spark Pilot &mdash; fiche d&eacute;taill&eacute;e d'une borne avec g&eacute;olocalisation sur le parking de la collectivit&eacute;"/>
    </div>
  </section>
  ...
  <section class="pillars-section">
    <div class="pillars-header reveal">
      ...
      <h2 class="section-title" data-i18n="cas.coll.pillars.h2"><?= tr('cas.coll.pillars.h2') ?></h2>
    </div>
    <div class="pillars-grid">
      <div class="pillar-card reveal"><div class="pillar-icon">💶</div><h3 data-i18n="cas.coll.pillar1.title"><?= tr('cas.coll.pillar1.title') ?></h3><p data-i18n="cas.coll.pillar1.body"><?= tr('cas.coll.pillar1.body') ?></p></div>
      <div class="pillar-card reveal"><div class="pillar-icon">📊</div><h3 data-i18n="cas.coll.pillar2.title"><?= tr('cas.coll.pillar2.title') ?></h3><p data-i18n="cas.coll.pillar2.body"><?= tr('cas.coll.pillar2.body') ?></p></div>
      <div class="pillar-card reveal"><div class="pillar-icon">🏛️</div><h3 data-i18n="cas.coll.pillar3.title"><?= tr('cas.coll.pillar3.title') ?></h3><p data-i18n="cas.coll.pillar3.body"><?= tr('cas.coll.pillar3.body') ?></p></div>
    </div>
  </section>
    ...
    <div class="sk-wrap">
      ...
      <div class="reveal" style="overflow-x:auto;margin-bottom:32px;">
        <table style="width:100%;border-collapse:collapse;font-size:14px;font-family:var(--font-body);">
          ...
          <tbody><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.coll.tbl.r1"><?= tr('cas.coll.tbl.r1') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">3&nbsp;600&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">14&nbsp;000&nbsp;&euro;</td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.coll.tbl.r2"><?= tr('cas.coll.tbl.r2') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">20&nbsp;000&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">37&nbsp;000&nbsp;&euro;</td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.coll.tbl.r3"><?= tr('cas.coll.tbl.r3') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);"><span data-i18n="cas.coll.tbl.r3a"><?= tr('cas.coll.tbl.r3a') ?></span></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><span data-i18n="cas.coll.tbl.r3b"><?= tr('cas.coll.tbl.r3b') ?></span></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.coll.tbl.r4"><?= tr('cas.coll.tbl.r4') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">500&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">3&nbsp;000&nbsp;&euro;</td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.coll.tbl.r5"><?= tr('cas.coll.tbl.r5') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">2&nbsp;040&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">2&nbsp;040&nbsp;&euro;</td></tr><tr style="border-bottom:1px solid var(--border);font-weight:600;"><td style="padding:14px 16px;color:var(--text-dark);"><strong data-i18n="cas.coll.tbl.r6"><?= tr('cas.coll.tbl.r6') ?></strong></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);font-weight:700;color:var(--orange);"><strong>+&nbsp;640&nbsp;&euro;</strong></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><strong>&minus;&nbsp;960&nbsp;&euro;</strong></td></tr></tbody>
        </table>
      </div>
      <div class="reveal" style="background:rgba(232,86,58,0.05);border:1.5px solid rgba(232,86,58,0.15);border-radius:16px;padding:28px;">
        <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="cas.coll.note"><?= tr('cas.coll.note') ?></p>
      </div>
    </div>
  </section>
  ...
  <section class="pilot-section" style="background:var(--bg-white);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;"><span class="section-label" data-i18n="cas.coll.reg.label"><?= tr('cas.coll.reg.label') ?></span><h2 class="section-title" data-i18n="cas.coll.reg.h2"><?= tr('cas.coll.reg.h2') ?></h2></div>
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:20px;" class="reveal">
        <div class="pillar-card"><div class="pillar-icon">⚖️</div><h3 data-i18n="cas.coll.reg1.title"><?= tr('cas.coll.reg1.title') ?></h3><p data-i18n="cas.coll.reg1.body"><?= tr('cas.coll.reg1.body') ?></p></div>
        
        <div class="pillar-card"><div class="pillar-icon">🇪🇺</div><h3 data-i18n="cas.coll.reg2.title"><?= tr('cas.coll.reg2.title') ?></h3><p data-i18n="cas.coll.reg2.body"><?= tr('cas.coll.reg2.body') ?></p></div>
        <div class="pillar-card"><div class="pillar-icon">🏛️</div><h3 data-i18n="cas.coll.reg3.title"><?= tr('cas.coll.reg3.title') ?></h3><p data-i18n="cas.coll.reg3.body"><?= tr('cas.coll.reg3.body') ?></p></div>
      </div>
    </div>
  </section>
    ...
    <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
      ...
      <div class="compare-card current"><div class="compare-card-name">Collectivité</div><div class="compare-card-sub">CPO · Mobilité</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);" data-i18n="cas.shared.your_page"><?= tr('cas.shared.your_page') ?></div></div>
    </div>
