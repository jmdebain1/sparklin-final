...
<head>
  ...
  <title><?= tr('meta.cas_pme.title') ?></title>
  <meta name="description" content="<?= tr('meta.cas_pme.desc') ?>" data-i18n-meta="meta.cas_pme.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.cas_pme.title'),'desc'=>tr('meta.cas_pme.desc')]); ?>
</head>
<body>
...
<section class="cas-hero">
    <div>
      ...
      <h1 data-i18n="cas.pme.h1a"><?= tr('cas.pme.h1a') ?> <span data-i18n="cas.pme.h1b"><?= tr('cas.pme.h1b') ?></span></h1>
      <p data-i18n="cas.pme.lead"><?= tr('cas.pme.lead') ?></p>
  ...
  <div class="trust-bar"><div class="trust-item">⚡ <span data-i18n="cas.pme.trust1"><?= tr('cas.pme.trust1') ?></span></div><div class="trust-item">💶 <span data-i18n="cas.pme.trust2"><?= tr('cas.pme.trust2') ?></span></div><div class="trust-item">🗓️ <span data-i18n="cas.pme.trust3"><?= tr('cas.pme.trust3') ?></span></div><div class="trust-item">📊 <span data-i18n="cas.pme.trust4"><?= tr('cas.pme.trust4') ?></span></div></div>
  ...
  <section class="intro-section" id="cas-pme-details">
    <div class="intro-text reveal">
      ...
      <h2 data-i18n="cas.pme.intro.h2"><?= tr('cas.pme.intro.h2') ?></h2>
      <p data-i18n="cas.pme.intro.p1"><?= tr('cas.pme.intro.p1') ?></p><p data-i18n="cas.pme.intro.p2"><?= tr('cas.pme.intro.p2') ?></p><p data-i18n="cas.pme.intro.p3"><?= tr('cas.pme.intro.p3') ?></p><p data-i18n="cas.pme.intro.p4"><?= tr('cas.pme.intro.p4') ?></p>
    </div>
  ...
  <section class="pillars-section">
    <div class="pillars-header reveal">
      ...
      <h2 class="section-title" data-i18n="cas.pme.pillars.h2"><?= tr('cas.pme.pillars.h2') ?></h2>
      <p class="section-body" data-i18n="cas.pme.pillars.sub"><?= tr('cas.pme.pillars.sub') ?></p>
    </div>
    <div class="pillars-grid" style="grid-template-columns:repeat(2,1fr);">
      <div class="pillar-card reveal"><div class="pillar-icon">⚡</div><h3 data-i18n="cas.pme.pillar1.title"><?= tr('cas.pme.pillar1.title') ?></h3><p data-i18n="cas.pme.pillar1.body"><?= tr('cas.pme.pillar1.body') ?></p></div>
      <div class="pillar-card reveal"><div class="pillar-icon">💶</div><h3 data-i18n="cas.pme.pillar2.title"><?= tr('cas.pme.pillar2.title') ?></h3><p data-i18n="cas.pme.pillar2.body"><?= tr('cas.pme.pillar2.body') ?></p></div>
      <div class="pillar-card reveal"><div class="pillar-icon">🔑</div><h3 data-i18n="cas.pme.pillar3.title"><?= tr('cas.pme.pillar3.title') ?></h3><p data-i18n="cas.pme.pillar3.body"><?= tr('cas.pme.pillar3.body') ?></p></div>
      <div class="pillar-card reveal"><div class="pillar-icon">📊</div><h3 data-i18n="cas.pme.pillar4.title"><?= tr('cas.pme.pillar4.title') ?></h3><p data-i18n="cas.pme.pillar4.body"><?= tr('cas.pme.pillar4.body') ?></p></div>
    </div>
  </section>

  <section class="specs-section" id="pme-chiffres" style="background:var(--bg-off);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;">
        <span class="section-label" data-i18n="cas.collab.ex.label"><?= tr('cas.collab.ex.label') ?></span>
        <h2 class="section-title" data-i18n="cas.pme.spec.h2"><?= tr('cas.pme.spec.h2') ?></h2>
      </div>
      <div class="reveal" style="overflow-x:auto;margin-bottom:32px;">
        <table style="width:100%;border-collapse:collapse;font-size:14px;font-family:var(--font-body);">
          <thead><tr style="border-bottom:2px solid var(--border-dark);"><th style="text-align:left;padding:14px 16px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-light);" data-i18n="cas.collab.tbl.col1"><?= tr('cas.collab.tbl.col1') ?></th><th style="text-align:center;padding:14px 16px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-light);" data-i18n="cas.coll.tbl.col2"><?= tr('cas.coll.tbl.col2') ?></th><th style="text-align:center;padding:14px 16px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-light);" data-i18n="cas.coll.tbl.col3"><?= tr('cas.coll.tbl.col3') ?></th></tr></thead>
          <tbody><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.pme.tbl.r1"><?= tr('cas.pme.tbl.r1') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">4&nbsp;200&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">14&nbsp;000&nbsp;&euro;</td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.pme.tbl.r2"><?= tr('cas.pme.tbl.r2') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">22&nbsp;500&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">37&nbsp;000&nbsp;&euro;</td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.pme.tbl.r3"><?= tr('cas.pme.tbl.r3') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);"><span data-i18n="cas.pme.tbl.r3a"><?= tr('cas.pme.tbl.r3a') ?></span></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><span data-i18n="cas.pme.tbl.r3b"><?= tr('cas.pme.tbl.r3b') ?></span></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.pme.tbl.r4"><?= tr('cas.pme.tbl.r4') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);"><span data-i18n="cas.pme.tbl.r4a"><?= tr('cas.pme.tbl.r4a') ?></span></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><span data-i18n="cas.pme.tbl.r4b"><?= tr('cas.pme.tbl.r4b') ?></span></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.pme.tbl.r5"><?= tr('cas.pme.tbl.r5') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);"><span data-i18n="cas.pme.tbl.r5a"><?= tr('cas.pme.tbl.r5a') ?></span></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><span data-i18n="cas.pme.tbl.r5b"><?= tr('cas.pme.tbl.r5b') ?></span></td></tr><tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);" data-i18n="cas.pme.tbl.r6"><?= tr('cas.pme.tbl.r6') ?></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);"><span data-i18n="cas.pme.tbl.r6a"><?= tr('cas.pme.tbl.r6a') ?></span></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><span data-i18n="cas.pme.tbl.r6b"><?= tr('cas.pme.tbl.r6b') ?></span></td></tr><tr style="border-bottom:1px solid var(--border);font-weight:600;"><td style="padding:14px 16px;color:var(--text-dark);"><strong data-i18n="cas.pme.tbl.r7"><?= tr('cas.pme.tbl.r7') ?></strong></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);font-weight:700;color:var(--orange);"><strong>26&nbsp;700&nbsp;&euro;</strong></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><strong>51&nbsp;000&nbsp;&euro;</strong></td></tr></tbody>
        </table>
      </div>
      <div class="reveal" style="background:rgba(232,86,58,0.05);border:1.5px solid rgba(232,86,58,0.15);border-radius:16px;padding:28px;">
        <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="cas.pme.note"><?= tr('cas.pme.note') ?></p>
      </div>
    </div>
  </section>
  ...
  <section class="pilot-section" style="background:var(--bg-white);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;"><span class="section-label" data-i18n="cas.pme.reg.label"><?= tr('cas.pme.reg.label') ?></span><h2 class="section-title" data-i18n="cas.pme.reg.h2"><?= tr('cas.pme.reg.h2') ?></h2></div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;" class="reveal">
        <div class="pillar-card"><div class="pillar-icon">📋</div><h3 data-i18n="cas.pme.reg1.title"><?= tr('cas.pme.reg1.title') ?></h3><p data-i18n="cas.pme.reg1.body"><?= tr('cas.pme.reg1.body') ?></p></div>
        <div class="pillar-card"><div class="pillar-icon">⚖️</div><h3 data-i18n="cas.pme.reg2.title"><?= tr('cas.pme.reg2.title') ?></h3><p data-i18n="cas.pme.reg2.body"><?= tr('cas.pme.reg2.body') ?></p></div>
        <div class="pillar-card"><div class="pillar-icon">🧾</div><h3 data-i18n="cas.pme.reg3.title"><?= tr('cas.pme.reg3.title') ?></h3><p data-i18n="cas.pme.reg3.body"><?= tr('cas.pme.reg3.body') ?></p></div>
      </div>
    </div>
  </section>
    ...
    <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
      <div class="compare-card current"><div class="compare-card-name">PME</div><div class="compare-card-sub">Parking entreprise</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);" data-i18n="cas.shared.your_page"><?= tr('cas.shared.your_page') ?></div></div>
