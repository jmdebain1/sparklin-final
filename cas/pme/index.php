...
<head>
  ...
  <title>PME &amp; Entreprises — Cas client Sparklin | Sparklin</title>
...
<section class="cas-hero">
    <div>
      <div class="hero-badge" data-i18n="cas.pme.hero.badge"><?= tr('cas.pme.hero.badge') ?></div>
      <h1 data-i18n="cas.pme.h1a"><?= tr('cas.pme.h1a') ?><em>sans toucher</em> à votre abonnement EDF.</h1>
      <p>Le défi de l'équipement IRVE en entreprise, ce n'est pas le coût des bornes — c'est la puissance électrique. Avec Spark Pilot et le load balancing natif de Sparklin, vous déployez 15, 50 ou 140 bornes sans renégocier votre contrat EDF et sans travaux de renforcement.</p>
      <div style="display:flex;gap:14px;flex-wrap:wrap;"><a href="/contact/" class="btn-primary" data-i18n="pilot.hero.cta1"><?= tr('pilot.hero.cta1') ?></a><a href="#pme-chiffres" class="btn-outline" data-i18n="ui.see_example"><?= tr('ui.see_example') ?></a></div>
    </div>
    <div style="width:100%;min-height:400px;max-height:520px;overflow:hidden;border-radius:20px;">
      <img src="/assets/images/parking-right.jpg" alt="Parking entreprise équipé de bornes Sparklin" style="width:100%;height:100%;object-fit:cover;object-position:center 10%;border-radius:20px;" loading="lazy"/>
    </div>
  </section>

  <div class="trust-bar"><div class="trust-item">⚡ <span>Pas d&rsquo;augmentation de <strong>puissance Enedis</strong></span></div><div class="trust-item">💶 <span>CAPEX &agrave; partir de <strong data-i18n="cas.pme.cost"><?= tr('cas.pme.cost') ?></strong></span></div><div class="trust-item">🗓️ <span data-i18n="cas.pme.setup"><?= tr('cas.pme.setup') ?><strong>3 &agrave; 6 semaines</strong></span></div><div class="trust-item">📊 <span data-i18n="cas.pme.access"><?= tr('cas.pme.access') ?><strong data-i18n="cas.pme.tracking"><?= tr('cas.pme.tracking') ?></strong></span></div></div>

  <section class="intro-section" id="cas-pme-details">
    <div class="intro-text reveal">
      <span class="section-label" data-i18n="cas.shared.problem"><?= tr('cas.shared.problem') ?></span>
      <h2>Quatre obstacles que personne n&rsquo;avait anticip&eacute;s.</h2>
      <p><strong style="color:var(--text-dark);">L&rsquo;obstacle Enedis.</strong> Ajouter des bornes augmente la consommation du site. Si elle d&eacute;passe la puissance souscrite, il faut ren&eacute;gocier l&rsquo;abonnement et attendre qu&rsquo;Enedis intervienne. D&eacute;lai constat&eacute; : 6 &agrave; 12 mois dans les zones denses. Pour une PME qui voulait juste installer quelques bornes, c&rsquo;est une douche froide.</p>
      <p><strong style="color:var(--text-dark);">L&rsquo;obstacle budg&eacute;taire.</strong> Une borne 22 kW co&ucirc;te entre 1 500 et 4 000 &euro;. Multipli&eacute;e par dix emplacements, la facture d&eacute;passe 30 000 &euro; avant m&ecirc;me les travaux, le c&acirc;blage et le tableau &eacute;lectrique d&eacute;di&eacute;.</p>
      <p><strong style="color:var(--text-dark);">L&rsquo;obstacle op&eacute;rationnel.</strong> Qui g&egrave;re les bornes ? Qui d&eacute;cide qui charge et quand ? Comment &eacute;viter que les m&ecirc;mes salari&eacute;s monopolisent les prises ? Comment suivre les consommations pour les rembourser ou les refacturer ?</p>
      <p><strong style="color:var(--text-dark);">L&rsquo;obstacle technique invisible.</strong> Sans gestion intelligente, dix bornes de 7 kW actives simultan&eacute;ment peuvent d&eacute;passer le plafond de souscription EDF &mdash; avec des p&eacute;nalit&eacute;s pouvant atteindre plusieurs milliers d&rsquo;euros par mois.</p>
    </div>
    <div class="intro-image reveal" style="min-height:300px;aspect-ratio:4/3;">
      <img src="/assets/images/dashboard-laptop.jpg" alt="Responsable de site consultant le tableau de bord Spark Pilot"/>
    </div>
  </section>

  <div class="gallery-strip">
    <div><img src="/assets/images/borne-voiture-blanche.jpg" alt="Voiture &eacute;lectrique branch&eacute;e sur borne Sparklin"/></div>
    <div><img src="/assets/images/borne-close-homme.jpg" alt="D&eacute;tail borne Sparklin &mdash; c&acirc;ble Type 2 connect&eacute;"/></div>
    <div><img src="/assets/images/borne-voiture-jaune.jpg" alt="Vue parking entreprise avec borne de recharge Sparklin"/></div>
  </div>

  <section class="pillars-section">
    <div class="pillars-header reveal">
      <span class="section-label">La solution Sparklin</span>
      <h2 class="section-title">Ce que Sparklin change, point par point.</h2>
      <p class="section-body">Une r&eacute;ponse directe, technique et document&eacute;e &agrave; chacun des quatre obstacles.</p>
    </div>
    <div class="pillars-grid" style="grid-template-columns:repeat(2,1fr);">
      <div class="pillar-card reveal">
        <div class="pillar-icon">⚡</div>
        <h3>Le load balancing supprime l&rsquo;obstacle Enedis</h3>
        <p>Spark Pilot surveille en temps r&eacute;el la consommation &eacute;lectrique totale du site et r&eacute;partit la puissance disponible entre toutes les bornes actives. Si votre abonnement autorise 100 kW et que le b&acirc;timent en consomme 70, Spark Pilot distribue les 30 kW restants entre les v&eacute;hicules en charge &mdash; toutes les secondes, automatiquement. R&eacute;sultat : z&eacute;ro d&eacute;passement, z&eacute;ro p&eacute;nalit&eacute; EDF, z&eacute;ro intervention Enedis.</p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">💶</div>
        <h3>Un CAPEX divis&eacute; par cinq gr&acirc;ce &agrave; la charge lente</h3>
        <p>Un salari&eacute; qui arrive &agrave; 9h et repart &agrave; 18h dispose de neuf heures de charge. &Agrave; 3,7 kW, c&rsquo;est 33 kWh r&eacute;cup&eacute;r&eacute;s &mdash; suffisant pour recharger compl&egrave;tement la grande majorit&eacute; des v&eacute;hicules &eacute;lectriques du march&eacute;. Une Spark Plus revient &agrave; moins de 300 &euro;, contre 1 500 &agrave; 4 000 &euro; pour une borne 22 kW. Pour dix emplacements, l&rsquo;&eacute;cart de CAPEX est de l&rsquo;ordre de 25 000 &euro;.</p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">🔑</div>
        <h3>Une gestion des acc&egrave;s sans friction</h3>
        <p>Cr&eacute;ez des communaut&eacute;s, d&eacute;finissez des acc&egrave;s prioritaires, r&eacute;servez des bornes &agrave; un groupe d&rsquo;usagers. Spark Pilot s&rsquo;adapte &agrave; l&rsquo;organisation de l&rsquo;entreprise. Le responsable de site ajoute ou retire des acc&egrave;s en quelques secondes depuis l&rsquo;interface web. Chaque session est enregistr&eacute;e avec le nom du salari&eacute;, le v&eacute;hicule, la dur&eacute;e et l&rsquo;&eacute;nergie consomm&eacute;e.</p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">📊</div>
        <h3>Visibilit&eacute; totale pour le gestionnaire de flotte</h3>
        <p>Tableau de bord temps r&eacute;el, rapports mensuels exportables, vue multi-sites centralis&eacute;e. Les donn&eacute;es alimentent les reportings RSE, les d&eacute;clarations fiscales et les analyses de co&ucirc;t de possession. Pour les entreprises multi-sites, Spark Pilot centralise la supervision de l&rsquo;ensemble des parkings &mdash; si&egrave;ge, agences, prises domicile &mdash; depuis une interface unique.</p>
      </div>
    </div>
  </section>
  ...
  <section class="specs-section" style="background:var(--bg-off);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;">
        ...
        <h2 class="section-title">PME industrielle &middot; 45 salari&eacute;s &middot; 15 v&eacute;hicules &eacute;lectriques</h2>
      </div>
      <div class="reveal" style="overflow-x:auto;margin-bottom:32px;">
        <table style="width:100%;border-collapse:collapse;font-size:14px;font-family:var(--font-body);">
          <thead><tr style="border-bottom:2px solid var(--border-dark);">
              ...
              <th style="text-align:center;padding:14px 16px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-light);">Solution Sparklin</th>
              <th style="text-align:center;padding:14px 16px;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.06em;color:var(--text-light);">Bornes rapides classiques</th>
            </tr></thead>
          <tbody>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">Co&ucirc;t mat&eacute;riel (15 points de charge)</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">4&nbsp;200&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">14&nbsp;000&nbsp;&euro;</td></tr>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">Travaux et installation</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">22&nbsp;500&nbsp;&euro;</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">37&nbsp;000&nbsp;&euro;</td></tr>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">Ren&eacute;gociation abonnement EDF</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">Aucune</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">~&nbsp;2&nbsp;000&nbsp;&euro; + 6&nbsp;&agrave;&nbsp;12&nbsp;mois</td></tr>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">Abonnement Spark Pilot</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">~&nbsp;75&nbsp;&euro;&nbsp;/&nbsp;mois</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">~&nbsp;200&nbsp;&euro;&nbsp;/&nbsp;mois</td></tr>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">Risque de d&eacute;passement</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">Nul (load balancing)</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">&Eacute;lev&eacute; sans gestion</td></tr>
            <tr style="border-bottom:1px solid var(--border);"><td style="padding:14px 16px;color:var(--text-mid);">D&eacute;lai de mise en service</td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);">3&nbsp;&agrave;&nbsp;6&nbsp;semaines</td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);">6&nbsp;&agrave;&nbsp;12&nbsp;mois</td></tr>
            <tr style="border-bottom:1px solid var(--border);font-weight:600;"><td style="padding:14px 16px;color:var(--text-dark);"><strong>CAPEX TOTAL</strong></td><td style="padding:14px 16px;text-align:center;background:rgba(232,86,58,0.04);font-weight:700;color:var(--orange);"><strong>26&nbsp;700&nbsp;&euro;</strong></td><td style="padding:14px 16px;text-align:center;color:var(--text-mid);"><strong>51&nbsp;000&nbsp;&euro;</strong></td></tr>
          </tbody>
        </table>
      </div>
      <div class="reveal" style="background:rgba(232,86,58,0.05);border:1.5px solid rgba(232,86,58,0.15);border-radius:16px;padding:28px;">
        <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;"><strong style="color:var(--text-dark);">L&rsquo;&eacute;conomie de CAPEX repr&eacute;sente pour une PME plus de 30 000 &euro; r&eacute;investissables dans son c&oelig;ur de m&eacute;tier.</strong> Et le d&eacute;lai de mise en service r&eacute;duit de 6&ndash;12 mois &agrave; 3&ndash;6 semaines signifie concr&egrave;tement que vos salari&eacute;s rechargent cet &eacute;t&eacute;, pas l&rsquo;ann&eacute;e prochaine. <em>Hypoth&egrave;ses : Spark Plus &agrave; 300 &euro;/unit&eacute;, installation 200 &euro;/borne ; bornes rapides 2 000 &euro;/unit&eacute;, installation 500 &euro;/borne.</em></p>
      </div>
    </div>
  </section>
  ...
  <section class="pilot-section" style="background:var(--bg-white);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;"><span class="section-label">R&eacute;glementation &amp; aides</span><h2 class="section-title">Ce que dit la loi, et ce que &ccedil;a change pour votre budget.</h2></div>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;" class="reveal">
        <div class="pillar-card"><div class="pillar-icon">📋</div><h3>D&eacute;cret tertiaire</h3><p>Les b&acirc;timents tertiaires de plus de 1 000 m&sup2; ont des obligations de r&eacute;duction de consommation &eacute;nerg&eacute;tique. L&rsquo;installation de bornes avec load balancing contribue &agrave; la ma&icirc;trise de la consommation &eacute;lectrique du site et peut &ecirc;tre valoris&eacute;e dans le reporting OPERAT gr&acirc;ce aux exports de consommation.</p></div>
        <div class="pillar-card"><div class="pillar-icon">⚖️</div><h3>Loi LOM</h3><p>La loi d&rsquo;orientation des mobilit&eacute;s fixe des obligations croissantes d&rsquo;&eacute;quipement en bornes pour les parkings d&rsquo;entreprise lors des travaux de r&eacute;novation ou de construction. Anticiper &eacute;vite des mises en conformit&eacute; contraintes, souvent plus co&ucirc;teuses dans l&rsquo;urgence.</p></div>
        <div class="pillar-card"><div class="pillar-icon">🧾</div><h3>Avantages fiscaux</h3><p>Les co&ucirc;ts d&rsquo;installation et d&rsquo;exploitation sont d&eacute;ductibles dans des conditions favorables. Le remboursement des frais de charge aux salari&eacute;s, document&eacute; par les donn&eacute;es Spark Pilot, est exon&eacute;r&eacute; de charges sociales sous conditions de frais r&eacute;els justifi&eacute;s.</p></div>
      </div>
    </div>
  </section>
    ...
    <div class="compare-banner-text">
      <h3>Explorez d’autres cas d’usage Sparklin</h3>
      <p>Chaque contexte a ses sp&eacute;cificit&eacute;s. D&eacute;couvrez comment Sparklin r&eacute;pond aux enjeux des autres typologies de sites.</p>
    </div>
    <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
      <div class="compare-card current"><div class="compare-card-name">PME</div><div class="compare-card-sub">Parking entreprise</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);">Votre page</div></div>
      ...
      <a href="/contact/" class="btn-ghost">Contacter un conseiller</a>
