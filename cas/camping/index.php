...
<head>
  ...
  <title>Camping & Hébergement — Cas client Sparklin | Sparklin</title>
...
<section class="cas-hero">
    <div>
      ...
      <p>Les campings et hébergements de plein air accueillent de plus en plus de voyageurs en véhicule électrique. Sparklin vous permet d’installer des bornes accessibles en toute autonomie pour vos vacanciers et de facturer automatiquement chaque session.</p>
  ...
  <div class="trust-bar"><div class="trust-item">⛺ <span>Argument de <strong>r&eacute;servation</strong> diff&eacute;renciant</span></div><div class="trust-item">🌙 <span>Charge lente adapt&eacute;e aux <strong>s&eacute;jours nuit</strong></span></div><div class="trust-item">📅 <span>Revenus <strong>hors saison</strong></span></div><div class="trust-item">👤 <span data-i18n="app.trust2"><?= tr('app.trust2') ?><strong>anonyme</strong> &mdash; z&eacute;ro inscription</span></div><div class="trust-item"><span>Recharge <strong>sécurisée</strong></span></div></div>
  ...
  <section class="intro-section" id="cas-camping-details">
    <div class="intro-text reveal">
      ...
      <h2>Le campeur &eacute;lectrique&nbsp;: une client&egrave;le en forte croissance, une infrastructure souvent absente.</h2>
      <p>Les ventes de véhicules électriques progressent chaque année. Une part croissante de ces propriétaires sont aussi des campeurs — et ils cherchent des campings équipés pour recharger. Sur les plateformes de réservation, la présence de bornes de recharge devient un filtre de recherche au même titre que la piscine ou le wifi.</p><p>La bonne nouvelle : le camping est l’un des cas d’usage pour lesquels la charge lente est parfaitement adaptée. Même un campeur qui arrive le soir et repart le lendemain matin dispose de 8 à 10 heures de charge — suffisant pour récupérer 30 à 35 kWh, soit 200 à 250 km d’autonomie.</p><p>La Spark Plus répond exactement à ce besoin — à un coût qui rend l’investissement accessible, avec une puissance adaptée pour une installation sur l’emplacement et un retour financier visible dès la première saison.</p>
      <p>La bonne nouvelle&nbsp;: le camping est l&rsquo;un des cas d&rsquo;usage pour lesquels la charge lente est parfaitement adapt&eacute;e. Un campeur qui arrive le soir et repart le lendemain matin dispose de 8 &agrave; 10 heures de charge &mdash; suffisant pour r&eacute;cup&eacute;rer 30 &agrave; 35 kWh, soit 200 &agrave; 250 km d&rsquo;autonomie.</p>
      <p>La Spark Plus r&eacute;pond exactement &agrave; ce besoin &mdash; &agrave; un co&ucirc;t qui rend l&rsquo;investissement accessible m&ecirc;me pour un camping de taille modeste, avec un retour financier visible d&egrave;s la premi&egrave;re saison.</p>
    </div>
  ...
  <section class="pillars-section">
    <div class="pillars-header reveal">
      ...
      <h2 class="section-title">Un service de recharge qui fonctionne en saison et hors saison.</h2>
    </div>
    <div class="pillars-grid">
      <div class="pillar-card reveal">
        <div class="pillar-icon">👤</div>
        <h3>Paiement anonyme &mdash; z&eacute;ro friction pour le campeur de passage</h3>
        <p>La Spark Plus permet à un campeur de démarrer une session et de payer directement avec Google Pay ou Apple Pay, avec ou sans compte. Il branche, scanne le QR code, paie. C’est l’expérience la plus simple possible pour un utilisateur qui découvre la borne pour la première fois.</p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">📅</div>
        <h3>Des revenus qui continuent hors saison</h3>
        <p>En activant le QR Code, vos points de charge restent accessibles aux automobilistes même quand votre camping est fermé. Vous définissez dans Spark Pilot si l’accès hors saison est autorisé, à quel tarif et sur quels emplacements. Les revenus générés sont reversés automatiquement sur votre compte.</p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">🏷️</div>
        <h3>Tarification flexible et diff&eacute;renci&eacute;e</h3>
        <p>Tarif pr&eacute;f&eacute;rentiel pour vos campeurs enregistr&eacute;s (inclus dans la nuit&eacute;e ou non) et tarif public pour les visiteurs ext&eacute;rieurs. Spark Pilot g&egrave;re les deux simultan&eacute;ment. Vous pouvez proposer des forfaits nuit, des tarifs au kWh ou une combinaison selon la dur&eacute;e de s&eacute;jour &mdash; la politique tarifaire reste enti&egrave;rement sous votre contr&ocirc;le.</p>
      </div>
    </div>
  </section>
  ...
  <section class="specs-section" style="background:var(--bg-off);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;"><span class="section-label" data-i18n="ui.simulation"><?= tr('ui.simulation') ?></span><h2 class="section-title">Camping 3 &eacute;toiles &middot; 120 emplacements &middot; 10 bornes Spark Plus</h2></div>
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;" class="reveal">
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          ...
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;">10 Spark Plus install&eacute;es &middot; sans renforcement</p>
        </div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          <p style="font-family:var(--font-display);font-size:2.4rem;font-weight:800;color:var(--orange);line-height:1;">5 600 &euro;</p>
          <p style="font-size:14px;font-weight:500;color:var(--text-dark);margin-top:8px;">Revenus saison estim&eacute;s</p>
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;">90 nuits &middot; 70% taux usage &middot; 0,35 &euro;/kWh</p>
        </div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          ...
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;">R&eacute;seau </p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
      ...
      <div class="compare-card current"><div class="compare-card-name">Camping</div><div class="compare-card-sub">Accueil public</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);">Votre page</div></div>
