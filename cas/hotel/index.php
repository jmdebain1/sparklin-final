...
<head>
  ...
  <title>Hôtel & Commerce — Cas client Sparklin | Sparklin</title>
...
<section class="cas-hero">
    <div>
      <div class="hero-badge" data-i18n="cas.hotel.hero.badge"><?= tr('cas.hotel.hero.badge') ?></div>
      <h1 data-i18n="cas.hotel.h1a"><?= tr('cas.hotel.h1a') ?><em data-i18n="cas.hotel.h1b"><?= tr('cas.hotel.h1b') ?></em></h1>
      <p>Un hôtel ou un commerce qui installe des bornes de recharge ne fait pas que rendre service à ses clients — il génère des revenus passifs 24h/24 via le roaming GIREVE, améliore son score RSE et se différencie de la concurrence.</p>
      <div style="display:flex;gap:14px;flex-wrap:wrap;"><a href="/contact/" class="btn-primary" data-i18n="pilot.hero.cta1"><?= tr('pilot.hero.cta1') ?></a><a href="#hotel-chiffres" class="btn-outline" data-i18n="ui.see_roi"><?= tr('ui.see_roi') ?></a></div>
    </div>
    <div>
      <img src="/assets/images/borne-close-homme.jpg" alt="Borne Sparklin installée à l'entrée d'un hôtel"/>
    </div>
  </section>

  <div class="trust-bar"><div class="trust-item">⭐ <span>Am&eacute;liore votre <strong data-i18n="cas.hotel.booking"><?= tr('cas.hotel.booking') ?></strong></span></div><div class="trust-item">💰 <span>Revenus <strong>passifs automatis&eacute;s</strong></span></div><div class="trust-item">🗺️ <span>Visible sur <strong></strong></span></div><div class="trust-item">🔒 <span data-i18n="app.trust2"><?= tr('app.trust2') ?><strong>anonyme</strong> sans friction</span></div><div class="trust-item">🏷️ <span>Tarifs <strong>diff&eacute;renci&eacute;s</strong> clients / staff</span></div></div>

  <section class="intro-section" id="cas-hotel-details">
    <div class="intro-text reveal">
      <span class="section-label" data-i18n="cas.shared.context"><?= tr('cas.shared.context') ?></span>
      <h2>En 2025, un conducteur &eacute;lectrique choisit son h&ocirc;tel en fonction de la pr&eacute;sence d&rsquo;une borne.</h2>
      <p>Ce n&rsquo;est plus une anecdote &mdash; c&rsquo;est un crit&egrave;re de r&eacute;servation document&eacute; par les plateformes. Les conducteurs de v&eacute;hicules &eacute;lectriques repr&eacute;sentent une client&egrave;le &agrave; forte valeur ajout&eacute;e&nbsp;: CSP+, habitués des voyages d&rsquo;affaires, sensibles aux services premium. Ils cherchent activement les &eacute;tablissements &eacute;quip&eacute;s.</p>
      <p>Le probl&egrave;me&nbsp;: la plupart des h&ocirc;teliers ont essay&eacute; d&rsquo;installer des bornes rapides et ont d&eacute;couvert que l&rsquo;&eacute;quation &eacute;conomique ne tient pas. Sparklin propose une autre logique. Des bornes de charge lente, adapt&eacute;es aux dur&eacute;es de s&eacute;jour r&eacute;elles, &agrave; un co&ucirc;t dix fois inf&eacute;rieur, enti&egrave;rement supervis&eacute;es et mon&eacute;tis&eacute;es depuis une seule plateforme.</p>
      <p>Et si certains emplacements ont besoin de plus de puissance — s&eacute;minaires, s&eacute;jours courts, parking VIP, emplacement de direction — la Spark x go-e jusqu'&agrave; 22 kW garantit une charge compl&egrave;te en moins de 3h.</p>
    </div>
    <div class="intro-image reveal" style="min-height:300px;aspect-ratio:4/3;">
      <img src="/assets/images/dashboard-laptop.jpg" alt="Gestionnaire h&ocirc;tel consultant le tableau de bord Spark Pilot &mdash; revenus recharge clients"/>
    </div>
  </section>

  <div class="gallery-strip">
    <div><img src="/assets/images/borne-voiture-blanche.jpg" alt="Voiture &eacute;lectrique connect&eacute;e en ext&eacute;rieur d&rsquo;un &eacute;tablissement"/></div>
    <div><img src="/assets/images/borne-close-homme.jpg" alt="Borne Sparklin &mdash; d&eacute;tail connecteur Type 2"/></div>
    <div><img src="/assets/images/borne-exterieur-entree.jpg" alt="Spark Plus install&eacute;e &agrave; l&rsquo;entr&eacute;e d&rsquo;un b&acirc;timent"/></div>
  </div>

  <section class="pillars-section">
    <div class="pillars-header reveal">
      <span class="section-label" data-i18n="cas.shared.solution"><?= tr('cas.shared.solution') ?></span>
      <h2 class="section-title">Trois leviers pour transformer la recharge en actif rentable.</h2>
    </div>
    <div class="pillars-grid">
      <div class="pillar-card reveal">
        <div class="pillar-icon">💰</div>
        <h3>Mon&eacute;tisation automatique &mdash; z&eacute;ro gestion manuelle</h3>
        <p>Vous définissez votre tarif dans Spark Pilot (au kWh, ou forfait). Vos clients paient par CB sans contact, via l’application Sparklin, ou de façon totalement anonyme avec Google Pay ou Apple Pay. Les revenus sont reversés mensuellement sur votre compte, sans démarche pour vous.</p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">🗺️</div>
        <h3>Visibilit&eacute; </h3>
        <p>En activant l&rsquo;ouverture au public dans Spark Pilot, vos bornes sont automatiquement r&eacute;f&eacute;renc&eacute;es sur </p>
      </div>
      <div class="pillar-card reveal">
        <div class="pillar-icon">🏷️</div>
        <h3>Tarification diff&eacute;renci&eacute;e par profil</h3>
        <p>Tarif pr&eacute;f&eacute;rentiel ou inclus dans la chambre pour vos clients en s&eacute;jour, tarif standard pour les visiteurs de passage, acc&egrave;s gratuit pour votre personnel. Vous pouvez &eacute;galement proposer une recharge premium sur les emplacements Go-E plus puissants et une recharge standard sur les emplacements Spark Plus &mdash; une segmentation que vos clients comprennent et valorisent.</p>
      </div>
    </div>
  </section>
  ...
  <section class="specs-section" style="background:var(--bg-off);">
    <div class="sk-wrap">
      <div class="reveal" style="margin-bottom:40px;"><span class="section-label" data-i18n="ui.simulation"><?= tr('ui.simulation') ?></span><h2 class="section-title">H&ocirc;tel 3 &eacute;toiles &middot; 60 chambres &middot; 8 points de charge</h2></div>
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;" class="reveal">
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          <p style="font-family:var(--font-display);font-size:2.4rem;font-weight:800;color:var(--orange);line-height:1;">8 700 &euro;</p>
          <p style="font-size:14px;font-weight:500;color:var(--text-dark);margin-top:8px;">Revenus annuels estim&eacute;s</p>
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;">6 bornes Spark Plus &agrave; 0,35 &euro;/kWh &middot; 65% taux d&rsquo;occupation</p>
        </div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          <p style="font-family:var(--font-display);font-size:2.4rem;font-weight:800;color:var(--orange);line-height:1;">3 500 &euro;</p>
          <p style="font-size:14px;font-weight:500;color:var(--text-dark);margin-top:8px;">CAPEX total mat&eacute;riel</p>
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;">8 Spark Plus + installation &middot; sans renforcement &eacute;lectrique</p>
        </div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          <p style="font-family:var(--font-display);font-size:2.4rem;font-weight:800;color:var(--orange);line-height:1;">&lt; 6 mois</p>
          <p style="font-size:14px;font-weight:500;color:var(--text-dark);margin-top:8px;">Retour sur investissement</p>
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;">Hors aides Advenir d&eacute;duites</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
      ...
      <div class="compare-card current"><div class="compare-card-name">Hôtel</div><div class="compare-card-sub">Monétisation</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);">Votre page</div></div>
