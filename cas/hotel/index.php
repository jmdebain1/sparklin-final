...
<head>
  ...
  <title><?= tr('meta.cas_hotel.title') ?></title>
  <meta name="description" content="<?= tr('meta.cas_hotel.desc') ?>" data-i18n-meta="meta.cas_hotel.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.cas_hotel.title'),'desc'=>tr('meta.cas_hotel.desc')]); ?>
</head>
<body>
...
<section class="cas-hero">
    <div>
      ...
      <p data-i18n="cas.hotel.lead"><?= tr('cas.hotel.lead') ?></p>
  ...
  <div class="trust-bar"><div class="trust-item">⭐ <span data-i18n="cas.hotel.trust1"><?= tr('cas.hotel.trust1') ?></span></div><div class="trust-item">💰 <span data-i18n="cas.hotel.trust2"><?= tr('cas.hotel.trust2') ?></span></div><div class="trust-item">🗺️ <span data-i18n="cas.hotel.trust3"><?= tr('cas.hotel.trust3') ?></span></div><div class="trust-item">🔒 <span data-i18n="cas.hotel.trust4"><?= tr('cas.hotel.trust4') ?></span></div><div class="trust-item">🏷️ <span data-i18n="cas.hotel.trust5"><?= tr('cas.hotel.trust5') ?></span></div></div>
  ...
  <section class="intro-section" id="cas-hotel-details">
    <div class="intro-text reveal">
      ...
      <h2 data-i18n="cas.hotel.intro.h2"><?= tr('cas.hotel.intro.h2') ?></h2>
      <p data-i18n="cas.hotel.intro.p1"><?= tr('cas.hotel.intro.p1') ?></p><p data-i18n="cas.hotel.intro.p2"><?= tr('cas.hotel.intro.p2') ?></p><p data-i18n="cas.hotel.intro.p3"><?= tr('cas.hotel.intro.p3') ?></p>
    </div>
  ...
  <section class="pillars-section">
    <div class="pillars-header reveal">
      ...
      <h2 class="section-title" data-i18n="cas.hotel.pillars.h2"><?= tr('cas.hotel.pillars.h2') ?></h2>
    </div>
    <div class="pillars-grid">
      <div class="pillar-card reveal"><div class="pillar-icon">💰</div><h3 data-i18n="cas.hotel.pillar1.title"><?= tr('cas.hotel.pillar1.title') ?></h3><p data-i18n="cas.hotel.pillar1.body"><?= tr('cas.hotel.pillar1.body') ?></p></div>
      <div class="pillar-card reveal"><div class="pillar-icon">🗺️</div><h3 data-i18n="cas.hotel.pillar2.title"><?= tr('cas.hotel.pillar2.title') ?></h3><p data-i18n="cas.hotel.pillar2.body"><?= tr('cas.hotel.pillar2.body') ?></p></div>
      <div class="pillar-card reveal"><div class="pillar-icon">🏷️</div><h3 data-i18n="cas.hotel.pillar3.title"><?= tr('cas.hotel.pillar3.title') ?></h3><p data-i18n="cas.hotel.pillar3.body"><?= tr('cas.hotel.pillar3.body') ?></p></div>
    </div>
  </section>
  ...
  <section class="specs-section" id="hotel-chiffres" style="background:var(--bg-off);">
    <div class="sk-wrap">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;" class="reveal">
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          ...
          <p style="font-size:14px;font-weight:500;color:var(--text-dark);margin-top:8px;" data-i18n="cas.hotel.spec.c1_label"><?= tr('cas.hotel.spec.c1_label') ?></p>
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;" data-i18n="cas.hotel.spec.c1_sub"><?= tr('cas.hotel.spec.c1_sub') ?></p>
        </div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          <p style="font-family:var(--font-display);font-size:2.4rem;font-weight:800;color:var(--orange);line-height:1;">3 500 &euro;</p>
          <p style="font-size:14px;font-weight:500;color:var(--text-dark);margin-top:8px;" data-i18n="cas.hotel.spec.c2_label"><?= tr('cas.hotel.spec.c2_label') ?></p>
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;" data-i18n="cas.hotel.spec.c2_sub"><?= tr('cas.hotel.spec.c2_sub') ?></p>
        </div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:14px;padding:28px;text-align:center;">
          <p style="font-family:var(--font-display);font-size:2.4rem;font-weight:800;color:var(--orange);line-height:1;" data-i18n="cas.hotel.spec.c3_val"><?= tr('cas.hotel.spec.c3_val') ?></p>
          <p style="font-size:14px;font-weight:500;color:var(--text-dark);margin-top:8px;" data-i18n="cas.hotel.spec.c3_label"><?= tr('cas.hotel.spec.c3_label') ?></p>
          <p style="font-size:12px;color:var(--text-light);margin-top:4px;font-weight:300;" data-i18n="cas.hotel.spec.c3_sub"><?= tr('cas.hotel.spec.c3_sub') ?></p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="compare-cards" style="display:flex;flex-wrap:wrap;gap:12px;justify-content:center;">
      ...
      <div class="compare-card current"><div class="compare-card-name">Hôtel</div><div class="compare-card-sub">Monétisation</div><div class="compare-card-badge" style="background:rgba(255,255,255,0.2);" data-i18n="cas.shared.your_page"><?= tr('cas.shared.your_page') ?></div></div>
