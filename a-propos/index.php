...
<head>
  ...
  <title><?= tr('meta.apropos.title') ?></title>
  <meta name="description" content="<?= tr('meta.apropos.desc') ?>" data-i18n-meta="meta.apropos.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.apropos.title'),'desc'=>tr('meta.apropos.desc')]); ?>
</head>
<body>
...
<header class="hero" style="background:var(--bg-off);">
  <div style="display:flex;flex-direction:column;gap:24px;">
    ...
    <h1 style="font-family:var(--font-display);font-size:clamp(2rem,3.8vw,3.2rem);font-weight:800;line-height:1.1;letter-spacing:-.03em;color:var(--dark);" data-i18n="about.hero.h1a"><?= tr('about.hero.h1a') ?> <em style="font-style:normal;color:var(--orange);" data-i18n="about.hero.h1b"><?= tr('about.hero.h1b') ?></em><span data-i18n="about.hero.h1c"><?= t('about.hero.h1c') ?></span></h1>
    <p class="hero-sub" style="color:var(--text-mid);" data-i18n="about.hero.sub"><?= t('about.hero.sub') ?></p>
    <div class="hero-chips">
      <span class="chip"><span class="chip-dot"></span><span data-i18n="about.chip1"><?= t('about.chip1') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="about.chip2"><?= t('about.chip2') ?></span></span>
      <span class="chip"><span class="chip-dot"></span><span data-i18n="about.chip3"><?= t('about.chip3') ?></span></span>
  ...
  <div class="sk-wrap" style="max-width:900px;">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:start;">
      <div>
        ...
        <p style="font-size:16px;color:var(--text-mid);line-height:1.8;font-weight:300;" data-i18n="about.conviction.p2"><?= t('about.conviction.p2') ?></p>
      </div>
      <div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:16px;padding:32px;border-left:4px solid var(--orange);">
          <p style="font-size:15px;font-style:italic;color:var(--text-mid);line-height:1.75;margin-bottom:16px;" data-i18n="about.conviction.quote"><?= t('about.conviction.quote') ?></p>
    ...
    <div style="display:flex;flex-direction:column;gap:0;">
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="about.m1.p"><?= t('about.m1.p') ?></p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="about.m2.p"><?= t('about.m2.p') ?></p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="about.m3.p"><?= t('about.m3.p') ?></p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="about.m4.p"><?= t('about.m4.p') ?></p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;line-height:1.6;color:var(--text-mid);margin-top:6px;" data-i18n="about.m5.p"><?= t('about.m5.p') ?></p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="about.m6.p"><?= t('about.m6.p') ?></p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="about.m7.p"><?= t('about.m7.p') ?></p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="about.m8.p"><?= t('about.m8.p') ?></p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;">
        ...
        <div style="padding-left:24px;">
          ...
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;" data-i18n="about.m9.p"><?= t('about.m9.p') ?></p>
        </div>
      </div>
  ...
  <div class="sk-wrap" style="max-width:900px;">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
      <div style="background:var(--bg-white);border:1px solid var(--border);border-radius:16px;padding:28px;">
        ...
        <p style="font-size:14px;line-height:1.6;color:var(--text-mid);" data-i18n="about.m5.p"><?= t('about.m5.p') ?></p>
      </div>
      <div style="background:var(--bg-white);border:1px solid var(--border);border-radius:16px;padding:28px;">
        <div style="font-family:var(--font-display);font-size:11px;font-weight:700;color:var(--orange);letter-spacing:.08em;text-transform:uppercase;margin-bottom:12px;" data-i18n="about.share.tmg.label"><?= t('about.share.tmg.label') ?></div>
        <div style="font-size:18px;font-weight:700;color:var(--text-dark);margin-bottom:10px;">TMG</div>
        <p style="font-size:14px;line-height:1.6;color:var(--text-mid);" data-i18n="about.share.tmg.p"><?= t('about.share.tmg.p') ?></p>
      </div>
    </div></div>
  </div>
</section>
...
<section style="padding:80px clamp(24px,5vw,80px);background:var(--bg-white);">
  <div class="sk-wrap" style="max-width:1060px;">
    <span class="section-label" data-i18n="about.values.h2"><?= t('about.values.h2') ?></span>
    <h2 style="font-family:var(--font-display);font-size:clamp(1.6rem,2.8vw,2.2rem);font-weight:800;color:var(--dark);margin:12px 0 48px;" data-i18n="about.values.title"><?= t('about.values.title') ?></h2>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px;">
      <div style="background:var(--bg-off);border:1.5px solid var(--border);border-radius:16px;padding:28px;">
        ...
        <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:10px;" data-i18n="about.val1.title"><?= t('about.val1.title') ?></div>
        <p style="font-size:13.5px;color:var(--text-mid);line-height:1.7;font-weight:300;" data-i18n="about.val1.p"><?= t('about.val1.p') ?></p>
      </div>
      <div style="background:var(--bg-off);border:1.5px solid var(--border);border-radius:16px;padding:28px;">
        ...
        <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:10px;" data-i18n="about.val2.title"><?= t('about.val2.title') ?></div>
        <p style="font-size:13.5px;color:var(--text-mid);line-height:1.7;font-weight:300;" data-i18n="about.val2.p"><?= t('about.val2.p') ?></p>
      </div>
      <div style="background:var(--bg-white);border:1px solid var(--border);border-radius:16px;padding:28px;">
        ...
        <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--text-dark);margin-bottom:8px;" data-i18n="about.val3.title"><?= t('about.val3.title') ?></div>
        <p style="font-size:13.5px;line-height:1.6;color:var(--text-mid);" data-i18n="about.val3.p"><?= t('about.val3.p') ?></p>
      </div>
  </div>
</section>
...
<section style="padding:80px clamp(24px,5vw,80px);background:var(--bg-white);">
  <div class="sk-wrap" style="max-width:1060px;">
    <div style="text-align:center;margin-bottom:48px;">
      <span class="section-label" data-i18n="about.eco.h2"><?= t('about.eco.h2') ?></span>
      <h2 style="font-family:var(--font-display);font-size:clamp(1.6rem,2.8vw,2.2rem);
                 font-weight:800;color:var(--dark);margin:12px 0 14px;" data-i18n="about.eco.title"><?= t('about.eco.title') ?></h2>
      <p style="font-size:15px;color:var(--text-mid);max-width:520px;margin:0 auto;
                line-height:1.75;font-weight:300;" data-i18n="about.eco.sub"><?= t('about.eco.sub') ?></p>
    </div>
    ...
    <p style="text-align:center;font-size:12px;color:var(--text-light);margin-top:28px;">
      <span data-i18n="about.eco.partner_q"><?= t('about.eco.partner_q') ?></span>
      <a href="/contact/" style="color:var(--orange);text-decoration:none;font-weight:600;" data-i18n="about.eco.partner_link"><?= t('about.eco.partner_link') ?></a>
    </p>
  </div>
</section>
...
<section class="cta-close">
  <div class="made-tag" data-i18n="about.cta.tag"><?= t('about.cta.tag') ?></div>
  <h2 class="section-title"><span data-i18n="about.cta.h2a"><?= t('about.cta.h2a') ?></span><br><em style="font-style:normal;color:var(--orange);" data-i18n="about.cta.h2b"><?= t('about.cta.h2b') ?></em></h2>
  <p class="section-body" data-i18n="about.cta.body"><?= t('about.cta.body') ?></p>
  <div class="cta-close-actions">
    <a href="/contact/" class="btn-primary-light" data-i18n="ui.contact_us"><?= tr('ui.contact_us') ?></a>
    <a href="/evenements/" class="btn-ghost" data-i18n="about.cta.events"><?= t('about.cta.events') ?></a>
  </div>
</section>
