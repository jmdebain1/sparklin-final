...
<head>
  ...
  <title>À propos — Sparklin | Qui sommes-nous ?</title>
...
<header class="hero" style="background:var(--bg-off);">
  <div style="display:flex;flex-direction:column;gap:24px;">
    <div class="hero-badge" data-i18n="about.badge"><?= tr('about.badge') ?></div>
    <h1 style="font-family:var(--font-display);font-size:clamp(2rem,3.8vw,3.2rem);font-weight:800;line-height:1.1;letter-spacing:-.03em;color:var(--dark);" data-i18n="about.hero.h1a"><?= tr('about.hero.h1a') ?><em style="font-style:normal;color:var(--orange);" data-i18n="about.hero.h1b"><?= tr('about.hero.h1b') ?></em> et ses propres bornes.</h1>
    <p class="hero-sub" style="color:var(--text-mid);">Chez Sparklin, le software et le hardware ne sont pas deux équipes séparées. Ils sont conçus ensemble, depuis le départ, pour que la prise, la plateforme et l'app fonctionnent comme un seul produit.</p>
    <div class="hero-chips">
      <span class="chip"><span class="chip-dot"></span>Nantes, France</span>
      <span class="chip"><span class="chip-dot"></span>Fondée en 2021</span>
      <span class="chip"><span class="chip-dot"></span>Hardware + Software</span>
      
    </div>
  </div>
  <div class="hero-visual">
    <img class="hero-img-main" src="/assets/images/parking-left.jpg" alt="Parking professionnel équipé de bornes Sparklin" style="object-fit:cover;border-radius:20px;width:100%;max-height:520px;"/>
  </div>
</header>
...
<section style="background:var(--bg-off);padding:80px clamp(24px,5vw,80px);">
  <div class="sk-wrap" style="max-width:900px;">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:start;">
      <div>
        <p style="font-size:16px;color:var(--text-mid);line-height:1.8;font-weight:300;margin-bottom:20px;">En 2021, le marché de la recharge électrique professionnelle ressemblait à un puzzle mal assemblé : des bornes d'un fabricant, un logiciel de supervision d'un autre, une app tierce, un installateur différent — et personne pour garantir que tout fonctionne ensemble.</p>
        <p style="font-size:16px;color:var(--text-mid);line-height:1.8;font-weight:300;">Sparklin a été fondée sur une conviction simple : les gestionnaires de parc méritent un seul interlocuteur, un seul tableau de bord, un seul numéro de téléphone quand quelque chose ne fonctionne pas.</p>
      </div>
      <div>
        <div style="background:var(--bg-white);border:1.5px solid var(--border);border-radius:16px;padding:32px;border-left:4px solid var(--orange);">
          <p style="font-size:15px;font-style:italic;color:var(--text-mid);line-height:1.75;margin-bottom:16px;">"Nous avons conçu la Spark Plus de la même façon qu'on développe un produit SaaS : en partant des cas d'usage réels des gestionnaires, pas des contraintes techniques des fournisseurs de composants."</p>
          <div style="font-size:12px;font-weight:600;color:var(--dark);text-transform:uppercase;letter-spacing:.06em;" data-i18n="about.founders"><?= tr('about.founders') ?></div>
          <div style="font-size:11px;color:var(--text-light);margin-top:4px;" data-i18n="about.location"><?= tr('about.location') ?></div>
        </div>
      </div>
    </div>
  </div>
...
<!-- ══ TIMELINE ══ -->
<section style="padding:80px clamp(24px,5vw,80px);background:var(--bg-white);">
  <div class="sk-wrap" style="max-width:900px;">
    <span class="section-label" data-i18n="about.history.h2"><?= tr('about.history.h2') ?></span>
    <h2 style="font-family:var(--font-display);font-size:clamp(1.6rem,2.8vw,2.2rem);font-weight:800;color:var(--dark);margin:12px 0 48px;" data-i18n="about.history.sub"><?= tr('about.history.sub') ?></h2>
    
    <div style="display:flex;flex-direction:column;gap:0;">

      <!-- Mars 2021 -->
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Mars<br>2021</div>
          <div style="width:1px;flex:1;background:var(--border);margin-top:10px;"></div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m1.title"><?= tr('about.m1.title') ?></div>
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">Sparklin est née du souhait d'une mobilité électrique plus soutenable, plus accessible et plus sécurisée. Thierry Jahier, ex-EDF et expert mobilité électrique au sein du groupe, créé avec Laurent Stéphan la société Sparklin.</p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Q1<br>2022</div>
          <div style="width:1px;flex:1;background:var(--border);margin-top:10px;"></div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m2.title"><?= tr('about.m2.title') ?></div>
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">Grâce à un partenariat stratégique avec EDF depuis le démarrage, la première solution Spark 1 a été soumise aux tests rigoureux du Lab R&amp;D EDF pour obtenir sa certification officielle.</p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Q2<br>2022</div>
          <div style="width:1px;flex:1;background:var(--border);margin-top:10px;"></div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m3.title"><?= tr('about.m3.title') ?></div>
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">Ce premier déploiement sur le terrain de la solution de recharge marque le démarrage officiel de la commercialisation de l'offre Sparklin. Un jalon fondateur pour l'équipe.</p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Q1<br>2023</div>
          <div style="width:1px;flex:1;background:var(--border);margin-top:10px;"></div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m4.title"><?= tr('about.m4.title') ?></div>
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">Sparklin décide d'internaliser l'ensemble des développements logiciels de sa plateforme de supervision, afin de maîtriser pleinement son architecture et sa roadmap produit.</p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Q2<br>2024</div>
          <div style="width:1px;flex:1;background:var(--border);margin-top:10px;"></div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m5.title"><?= tr('about.m5.title') ?></div>
          <p style="font-size:14px;line-height:1.6;color:var(--text-mid);margin-top:6px;">Spécialisé dans la conception d'IoT nouvelle génération, le groupe GNKGO accompagne Sparklin dans la conception de ses produits charge lente.</p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Q3<br>2024</div>
          <div style="width:1px;flex:1;background:var(--border);margin-top:10px;"></div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m6.title"><?= tr('about.m6.title') ?></div>
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">Sparklin élargit sa gamme avec la Spark 2 (7,4 kW monophasée), adaptée aux flottes d'entreprise à rotation rapide, et la Spark 3 (jusqu'à 22 kW triphasée), pensée pour les sites industriels et les parkings publics à fort trafic.</p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Q3<br>2025</div>
          <div style="width:1px;flex:1;background:var(--border);margin-top:10px;"></div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m7.title"><?= tr('about.m7.title') ?></div>
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">La plateforme de supervision Spark Pilot est entièrement refondue et rebaptisée Spark Pilot. Plus puissante, plus intuitive, elle intègre de nouveaux modules : load balancing avancé, </p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;border-bottom:1px solid var(--border);padding-bottom:32px;margin-bottom:32px;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Q4<br>2025</div>
          <div style="width:1px;flex:1;background:var(--border);margin-top:10px;"></div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m8.title"><?= tr('about.m8.title') ?></div>
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">La Spark Plus est lancée commercialement : première prise renforcée du marché à embarquer un compteur MID certifié, un écran e-ink et le Plug &amp; charge . Elle répond aux exigences de facturation opposable et aux obligations LOM 2024 pour les parkings professionnels.</p>
        </div>
      </div>
      ...
      <div style="display:grid;grid-template-columns:90px 1fr;gap:0;">
        <div style="display:flex;flex-direction:column;align-items:center;padding-top:4px;">
          <div style="font-family:var(--font-display);font-size:11px;font-weight:800;color:var(--orange);text-align:center;line-height:1.3;">Q1<br>2026</div>
        </div>
        <div style="padding-left:24px;">
          <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:8px;" data-i18n="about.m9.title"><?= tr('about.m9.title') ?></div>
          <p style="font-size:14px;color:var(--text-mid);line-height:1.75;font-weight:300;">Sparklin s'associe à go-e (Autriche) pour enrichir sa gamme avec deux bornes de charge accélérée : la Spark go-e Core (7–22 kW) et la Spark go-e Pro, version certifiée MID pour la facturation juridiquement opposable. Les deux modèles s'intègrent nativement dans Spark Pilot.</p>
        </div>
      </div>
...
<section style="padding:80px clamp(24px,5vw,80px);background:var(--bg-off);">
  <div class="sk-wrap" style="max-width:900px;">
    ...
    <h2 style="font-family:var(--font-display);font-size:clamp(1.6rem,2.8vw,2.2rem);font-weight:800;color:var(--dark);margin:12px 0 36px;" data-i18n="about.investors"><?= tr('about.investors') ?><br data-i18n="about.investors.b"><?= tr('about.investors.b') ?><em style="font-style:normal;color:var(--orange);">mobilité durable.</em></h2>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
      <div style="background:var(--bg-white);border:1px solid var(--border);border-radius:16px;padding:28px;">
        <div style="font-family:var(--font-display);font-size:11px;font-weight:700;color:var(--orange);letter-spacing:.08em;text-transform:uppercase;margin-bottom:12px;">Partenaire IoT</div>
        <div style="font-size:18px;font-weight:700;color:var(--text-dark);margin-bottom:10px;">GNKGO</div>
        <p style="font-size:14px;line-height:1.6;color:var(--text-mid);">Spécialisé dans la conception d'IoT nouvelle génération, le groupe GNKGO accompagne Sparklin dans la conception de ses produits charge lente.</p>
      </div>
      <div style="background:var(--bg-white);border:1px solid var(--border);border-radius:16px;padding:28px;">
        <div style="font-family:var(--font-display);font-size:11px;font-weight:700;color:var(--orange);letter-spacing:.08em;text-transform:uppercase;margin-bottom:12px;">Cybersécurité & Data</div>
        <div style="font-size:18px;font-weight:700;color:var(--text-dark);margin-bottom:10px;">TMG</div>
        <p style="font-size:14px;line-height:1.6;color:var(--text-mid);">Focus sur la protection des données et cybersécurité. TMG apporte son expertise et accompagne Sparklin dans la sécurisation de sa plateforme.</p>
      </div>
    </div></div>
  </div>
</section>
...
<section style="padding:80px clamp(24px,5vw,80px);background:var(--bg-white);">
  <div class="sk-wrap" style="max-width:1060px;">
    ...
    <h2 style="font-family:var(--font-display);font-size:clamp(1.6rem,2.8vw,2.2rem);font-weight:800;color:var(--dark);margin:12px 0 48px;">Nos valeurs.</h2>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px;">
      <div style="background:var(--bg-off);border:1.5px solid var(--border);border-radius:16px;padding:28px;">
        <div style="width:40px;height:40px;background:rgba(232,86,58,0.1);border-radius:10px;display:flex;align-items:center;justify-content:center;margin-bottom:16px;"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#E8563A" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v6M12 22v-6M4.93 4.93l4.24 4.24M14.83 14.83l4.24 4.24M2 12h6M22 12h-6M4.93 19.07l4.24-4.24M14.83 9.17l4.24-4.24"/></svg></div>
        <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:10px;">Intégration totale</div>
        <p style="font-size:13.5px;color:var(--text-mid);line-height:1.7;font-weight:300;">Hardware, software et support : un seul interlocuteur. Pas de finger-pointing entre fabricant, éditeur et intégrateur.</p>
      </div>
      <div style="background:var(--bg-off);border:1.5px solid var(--border);border-radius:16px;padding:28px;">
        <div style="width:40px;height:40px;background:rgba(232,86,58,0.1);border-radius:10px;display:flex;align-items:center;justify-content:center;margin-bottom:16px;"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#E8563A" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M7 20s0-8 5-11m2 11s0-8-5-11M12 20V9"/><path d="M6 6s3-3 6-1 6 1 6 1"/></svg></div>
        <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--dark);margin-bottom:10px;">Éco-conception réelle</div>
        <p style="font-size:13.5px;color:var(--text-mid);line-height:1.7;font-weight:300;">La Spark 1 a un cycle de vie 6× moins impactant qu'une borne classique. L'éco-conception est intégrée au cahier des charges, pas ajoutée en communication.</p>
      </div>
      <div style="background:var(--bg-white);border:1px solid var(--border);border-radius:16px;padding:28px;">
        <div style="width:40px;height:40px;background:rgba(232,86,58,0.1);border-radius:10px;display:flex;align-items:center;justify-content:center;margin-bottom:16px;"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#E8563A" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div>
        <div style="font-family:var(--font-display);font-size:16px;font-weight:700;color:var(--text-dark);margin-bottom:8px;">Ouvertures et standards</div>
        <p style="font-size:13.5px;line-height:1.6;color:var(--text-mid);">OCPP 1.6 et 2.0, MID — nous ne créons pas d'écosystèmes fermés. Nos bornes fonctionnent avec tous les opérateurs du marché.</p>
      </div>
  </div>
</section>
  ...
  <div class="sk-wrap" style="max-width:1060px;">
    <div style="text-align:center;margin-bottom:48px;">
      ...
      <h2 style="font-family:var(--font-display);font-size:clamp(1.6rem,2.8vw,2.2rem);
                 font-weight:800;color:var(--dark);margin:12px 0 14px;">Nos partenaires.</h2>
      <p style="font-size:15px;color:var(--text-mid);max-width:520px;margin:0 auto;
                line-height:1.75;font-weight:300;">
        Sparklin s'appuie sur un réseau de partenaires sélectionnés pour leur expertise
        en installation IRVE, distribution électrique et mobilité électrique.
      </p>
    </div>

    <!-- Grid 4 colonnes, largeur uniforme, fond blanc partout -->
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;align-items:stretch;">
            <a href="https://www.tessierelectricite.fr/" target="_blank" rel="noopener"
              style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:24px 20px;background:#fff;border:1.5px solid var(--border);border-radius:14px;text-decoration:none;transition:box-shadow .2s,transform .2s;min-height:110px;"
              onmouseover="this.style.boxShadow='0 8px 28px rgba(26,26,46,.12)';this.style.transform='translateY(-3px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
              <img src="/assets/images/logo-tessier.png" alt="Tessier Électricité"
                   style="max-height:44px;max-width:140px;width:auto;height:auto;object-fit:contain;" loading="lazy"/>
              <div style="font-size:11px;font-weight:600;color:var(--text-light);text-align:center;line-height:1.4;margin-top:2px;">Tessier Électricité</div>
            </a>
            <a href="https://www.sonepar.fr/fr-fr" target="_blank" rel="noopener"
              style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:24px 20px;background:#fff;border:1.5px solid var(--border);border-radius:14px;text-decoration:none;transition:box-shadow .2s,transform .2s;min-height:110px;"
              onmouseover="this.style.boxShadow='0 8px 28px rgba(26,26,46,.12)';this.style.transform='translateY(-3px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
              <img src="/assets/images/logo-sonepar.png" alt="Sonepar"
                   style="max-height:44px;max-width:140px;width:auto;height:auto;object-fit:contain;" loading="lazy"/>
              <div style="font-size:11px;font-weight:600;color:var(--text-light);text-align:center;line-height:1.4;margin-top:2px;">Sonepar</div>
            </a>
            <a href="https://www.carplug.com/sparklin-pied-pour-prises-spark-one-1-ou-2-prises" target="_blank" rel="noopener"
              style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:24px 20px;background:#fff;border:1.5px solid var(--border);border-radius:14px;text-decoration:none;transition:box-shadow .2s,transform .2s;min-height:110px;"
              onmouseover="this.style.boxShadow='0 8px 28px rgba(26,26,46,.12)';this.style.transform='translateY(-3px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
              <img src="/assets/images/logo-carplug.png" alt="CARPLUG"
                   style="max-height:44px;max-width:140px;width:auto;height:auto;object-fit:contain;" loading="lazy"/>
              <div style="font-size:11px;font-weight:600;color:var(--text-light);text-align:center;line-height:1.4;margin-top:2px;">CARPLUG</div>
            </a>
            <a href="https://www.lcds-mobility.com/" target="_blank" rel="noopener"
              style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:24px 20px;background:#fff;border:1.5px solid var(--border);border-radius:14px;text-decoration:none;transition:box-shadow .2s,transform .2s;min-height:110px;"
              onmouseover="this.style.boxShadow='0 8px 28px rgba(26,26,46,.12)';this.style.transform='translateY(-3px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
              <img src="/assets/images/logo-lcds.png" alt="LCDS Mobilités"
                   style="max-height:44px;max-width:140px;width:auto;height:auto;object-fit:contain;" loading="lazy"/>
              <div style="font-size:11px;font-weight:600;color:var(--text-light);text-align:center;line-height:1.4;margin-top:2px;">LCDS Mobilités</div>
            </a>
            <a href="https://www.sider.biz/boutique/sparklin" target="_blank" rel="noopener"
              style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:24px 20px;background:#fff;border:1.5px solid var(--border);border-radius:14px;text-decoration:none;transition:box-shadow .2s,transform .2s;min-height:110px;"
              onmouseover="this.style.boxShadow='0 8px 28px rgba(26,26,46,.12)';this.style.transform='translateY(-3px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
              <img src="/assets/images/logo-sider.png" alt="SIDER"
                   style="max-height:44px;max-width:140px;width:auto;height:auto;object-fit:contain;" loading="lazy"/>
              <div style="font-size:11px;font-weight:600;color:var(--text-light);text-align:center;line-height:1.4;margin-top:2px;">SIDER</div>
            </a>
            <a href="https://www.distrilec.fr/ProductCard/SPASP1F/prise-irve-connectee-3-7kw" target="_blank" rel="noopener"
              style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:24px 20px;background:#fff;border:1.5px solid var(--border);border-radius:14px;text-decoration:none;transition:box-shadow .2s,transform .2s;min-height:110px;"
              onmouseover="this.style.boxShadow='0 8px 28px rgba(26,26,46,.12)';this.style.transform='translateY(-3px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
              <img src="/assets/images/logo-distrilec.png" alt="Distrilec"
                   style="max-height:44px;max-width:140px;width:auto;height:auto;object-fit:contain;" loading="lazy"/>
              <div style="font-size:11px;font-weight:600;color:var(--text-light);text-align:center;line-height:1.4;margin-top:2px;">Distrilec</div>
            </a>
            <a href="https://www.royelec.fr/" target="_blank" rel="noopener"
              style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:24px 20px;background:#fff;border:1.5px solid var(--border);border-radius:14px;text-decoration:none;transition:box-shadow .2s,transform .2s;min-height:110px;"
              onmouseover="this.style.boxShadow='0 8px 28px rgba(26,26,46,.12)';this.style.transform='translateY(-3px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
              <img src="/assets/images/logo-royelec.png" alt="ROY Elec"
                   style="max-height:44px;max-width:140px;width:auto;height:auto;object-fit:contain;" loading="lazy"/>
              <div style="font-size:11px;font-weight:600;color:var(--text-light);text-align:center;line-height:1.4;margin-top:2px;">ROY Elec</div>
            </a>
    </div>

    <p style="text-align:center;font-size:12px;color:var(--text-light);margin-top:28px;">
      Vous êtes installateur ou distributeur&nbsp;?
      <a href="/contact/" style="color:var(--orange);text-decoration:none;font-weight:600;">
        Devenez partenaire Sparklin →
      </a>
    </p>
  </div>
</section>
...
<section class="cta-close">
  <div class="made-tag">🇫🇷 Sparklin SAS &nbsp;·&nbsp; Nantes, Pays de la Loire</div>
  <h2 class="section-title">Vous avez un projet IRVE ?<br><em style="font-style:normal;color:var(--orange);">Parlons-en.</em></h2>
  <p class="section-body">Nos équipes répondent sous 48h. Audit de site, devis sur mesure, accompagnement LOM 2024.</p>
  <div class="cta-close-actions">
    <a href="/contact/" class="btn-primary-light" data-i18n="ui.contact_us"><?= tr('ui.contact_us') ?></a>
    <a href="/evenements/" class="btn-ghost">Nous retrouver en salon</a>
  </div>
</section>
