...
<section style="background:var(--bg-white);padding:72px 0 40px;">
  <div class="sk-wrap">
    <span class="section-label" data-i18n="support.badge"><?= tr('support.badge') ?></span>
    <h1 class="section-title" style="margin-bottom:12px;" data-i18n="footer.lnk.support"><?= tr('footer.lnk.support') ?></h1>
    <p class="section-body" style="max-width:560px;margin-bottom:56px;">
      Retrouvez les r&eacute;ponses aux questions les plus fr&eacute;quentes sur les bornes Sparklin, la plateforme Spark Pilot et nos cas d&rsquo;usage. Une question non couverte ? <a href="/contact/" style="color:var(--orange);font-weight:500;" data-i18n="support.contact.label"><?= tr('support.contact.label') ?></a>.
    </p>

    <!-- QUICK LINKS -->
    <div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:64px;">
      <a href="#spark-plus" style="padding:8px 18px;background:var(--bg-off);border:1px solid var(--border);border-radius:100px;font-size:13px;font-weight:500;color:var(--dark);text-decoration:none;" data-i18n="gamme.s2.name"><?= tr('gamme.s2.name') ?></a>
      <a href="#spark-go-e" style="padding:8px 18px;background:var(--bg-off);border:1px solid var(--border);border-radius:100px;font-size:13px;font-weight:500;color:var(--dark);text-decoration:none;" data-i18n="gamme.s3.name"><?= tr('gamme.s3.name') ?></a>
      <a href="#spark-pilot" style="padding:8px 18px;background:var(--bg-off);border:1px solid var(--border);border-radius:100px;font-size:13px;font-weight:500;color:var(--dark);text-decoration:none;" data-i18n="footer.lnk.pilot"><?= tr('footer.lnk.pilot') ?></a>
      <a href="#collaborateurs" style="padding:8px 18px;background:var(--bg-off);border:1px solid var(--border);border-radius:100px;font-size:13px;font-weight:500;color:var(--dark);text-decoration:none;" data-i18n="cas.collab.title"><?= tr('cas.collab.title') ?></a>
      <a href="/contact/" style="padding:8px 18px;background:var(--orange);color:#fff;border-radius:100px;font-size:13px;font-weight:500;text-decoration:none;" data-i18n="ui.contact_support"><?= tr('ui.contact_support') ?></a>
    </div>

    <!-- SPARK PLUS -->
    <div id="spark-plus" style="scroll-margin-top:140px;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid var(--border);">
        <div style="width:40px;height:40px;border-radius:10px;background:rgba(232,86,58,.1);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;">⚡</div>
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:700;color:var(--dark);margin:0;">Spark Plus — Prise connect&eacute;e 3,7 kW</h2>
      </div>
      <div class="faq-layout">
        <div class="faq-list">
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">La Spark Plus nécessite-t-elle un renforcement de mon installation électrique ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Dans la grande majorité des cas, non. La Spark Plus fonctionne sur un circuit standard de 16A, présent dans quasiment toutes les installations tertiaires et résidentielles. Le load balancing de Spark Pilot garantit en outre que la consommation cumulée de vos bornes ne dépasse jamais votre puissance souscrite, même si plusieurs véhicules chargent simultanément. Nos experts réalisent un audit de votre installation avant tout déploiement pour confirmer la compatibilité.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Combien de temps faut-il pour recharger un véhicule avec une Spark Plus ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>À 3,7 kW, la Spark Plus délivre environ 3,7 kWh par heure de charge. Un véhicule avec une batterie de 40 kWh (type Renault Zoé) se recharge intégralement en 10 à 11 heures. Un véhicule avec une batterie de 75 kWh (type Tesla Model 3) récupère environ 33 kWh en 9 heures — suffisant pour couvrir 200 à 250 km d'autonomie supplémentaire. Pour un parking d'entreprise ou un hébergement touristique, ce rythme est parfaitement adapté aux durées de stationnement réelles.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Peut-on mélanger des Spark Plus et des bornes plus puissantes sur le même site ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Oui. Spark Pilot supervise l'ensemble du parc de bornes, quelle que soit la puissance installée. Vous pouvez déployer des Spark Plus pour la majorité des emplacements et quelques bornes 7 ou 22 kW pour les usages nécessitant une charge plus rapide — le load balancing s'applique à l'ensemble, et vous gérez tout depuis la même interface.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">La Spark Plus est-elle compatible avec toutes les voitures électriques ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>La Spark Plus est équipée d’une prise Type E, le standard domestique. Elle est compatible avec tous les véhicules électriques et hybrides rechargeables vendus en Europe, sans exception.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Comment fonctionne le remboursement des frais de charge pour mes collaborateurs ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>La certification MID du compteur intégré permet à Spark Pilot de calculer automatiquement le montant à rembourser chaque mois selon le tarif fixé par l’entreprise. Chaque kWh consommé est mesuré et horodaté de manière légalement opposable. Ces remboursements sont exonérés de charges sociales, sans approximation ni risque fiscal. Les données sont exportables directement vers votre logiciel de paie.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Comment se passe la maintenance d'une Spark Plus ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>La Spark Plus est supervisée en permanence par Spark Pilot. Les anomalies sont détectées automatiquement et une alerte est envoyée au gestionnaire du site et à l'équipe technique Sparklin. La grande majorité des incidents sont résolus à distance par télémaintenance, sans intervention physique. En cas d'intervention sur site, le réseau de partenaires certifiés Sparklin assure une prise en charge rapide sur l'ensemble du territoire.</p></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- SPARK GO-E -->
    <div id="spark-go-e" style="scroll-margin-top:140px;margin-top:56px;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid var(--border);">
        <div style="width:40px;height:40px;border-radius:10px;background:rgba(232,86,58,.1);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;">🔋</div>
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:700;color:var(--dark);margin:0;">Spark x go-e — Borne acc&eacute;l&eacute;r&eacute;e 7&ndash;22 kW</h2>
      </div>
      <div class="faq-layout">
        <div class="faq-list">
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">La Spark x go-e nécessite-t-elle un raccordement triphasé ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>La version 22 kW requiert un raccordement triphasé. La version 7,4 kW fonctionne en monophasé 32A, compatible avec la plupart des installations tertiaires existantes. Nos experts vérifient systématiquement la configuration électrique de votre site avant de recommander la puissance adaptée. Si vous prévoyez une hausse future des besoins, la borne peut être installée en triphasée, et limitée à 7,4 kW depuis le Spark Pilot, permettant de changer facilement la puissance sans avoir à refaire l’installation.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Peut-on mélanger des Go-E 7,4 kW et 22 kW sur un même site ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Oui, sans aucune contrainte. Spark Pilot gère des parcs hétérogènes avec des puissances différentes sur le même site. Le load balancing s'adapte automatiquement à la configuration réelle, quelle que soit la combinaison de bornes installées.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Combien de temps faut-il pour charger un véhicule avec une Go-E 22 kW ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>À pleine puissance, la Go-E 22 kW délivre environ 22 kWh par heure. Quelques exemples : Renault Zoé 40 kWh — charge complète en moins de 2h ; Peugeot e-208 50 kWh — charge à 80 % en 1h45 ; Tesla Model 3 75 kWh — récupération de 40 kWh (250 km) en moins de 2h. À noter : la puissance de charge acceptée dépend aussi de l'onboard charger du véhicule — certains modèles sont limités à 7,4 kW ou 11 kW même sur une borne 22 kW.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">La Go-E est-elle compatible avec toutes les voitures électriques ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>La Spark x go-e est équipée d’une prise ou d’un câble Type 2 S, le standard européen universel. Pour les véhicules acceptant le 22 kW triphasé (Renault Zoé, certaines Mercedes, BMW, Volkswagen), la charge se fait à pleine puissance. Pour les véhicules limités à 7,4 kW ou 11 kW en AC, la borne s’adapte automatiquement à la puissance maximale acceptée par le véhicule.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">La Spark x go-e peut-elle être installée en extérieur ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Oui. Certifiée IP66 et IK08 et conçue pour fonctionner de -25°C à +40°C, la Spark x go-e est prévue pour une installation extérieure dans toutes les conditions climatiques rencontrées en Europe.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Comment se passe la maintenance d'une Go-E ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Comme pour les Spark Plus, Spark Pilot surveille en permanence l'état de chaque borne Go-E. Les anomalies sont détectées et signalées automatiquement. La majorité des incidents sont résolus par télémaintenance. En cas d'intervention physique, le réseau de partenaires certifiés Sparklin intervient sur site dans les délais définis dans votre contrat de service.</p></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- SPARK PILOT -->
    <div id="spark-pilot" style="scroll-margin-top:140px;margin-top:56px;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid var(--border);">
        <div style="width:40px;height:40px;border-radius:10px;background:rgba(232,86,58,.1);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;">🖥️</div>
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:700;color:var(--dark);margin:0;">Spark Pilot — Plateforme de supervision</h2>
      </div>
      <div class="faq-layout">
        <div class="faq-list">
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Spark Pilot est-il inclus dans l'achat d'une borne Sparklin ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Oui, l'accès à Spark Pilot est inclus avec chaque borne Sparklin. Un abonnement mensuel s'applique pour les fonctionnalités avancées et les parcs de grande taille. Nos équipes vous présentent les conditions tarifaires adaptées à votre configuration lors du devis.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Puis-je gérer plusieurs sites depuis un seul compte Spark Pilot ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Oui. Spark Pilot a été conçu pour la gestion multi-sites. Vous pouvez centraliser l'ensemble de vos installations — que ce soient des parkings d'entreprise, des hôtels ou des sites industriels — dans un seul compte, avec des droits d'accès différenciés par site et par profil d'utilisateur.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Comment fonctionne la Partner API ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>La Partner API de Spark Pilot permet de créer une passerelle avec un environnement tiers : ERP, logiciel de paie, outil de reporting RSE, plateforme RH. Elle est accessible sur demande et accompagnée d'une documentation technique détaillée. Elle permet notamment d'automatiser les remboursements de frais de charge directement dans les flux de paie, ou d'alimenter des outils de reporting avec les données de consommation.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Mes données sont-elles partagées avec des tiers ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Non. Les données de la plateforme Spark Pilot sont chiffrées et hébergées exclusivement sur des serveurs en France. Sparklin respecte scrupuleusement le RGPD et les recommandations de la CNIL. Aucune donnée n'est vendue ni partagée avec des tiers à des fins commerciales. Les audits de sécurité réguliers menés par les équipes de TMG garantissent l'inviolabilité de la plateforme dans le temps.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Combien de temps faut-il pour migrer un parc de bornes existant vers Spark Pilot ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Pour un parc de bornes compatibles OCPP connectées au réseau, la migration se fait généralement en quelques heures à quelques jours selon la taille du parc. Nos équipes techniques accompagnent la migration et configurent le load balancing, les communautés d’utilisateurs et la politique tarifaire dès la mise en service.</p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">L'application Sparklin est-elle disponible sur iOS et Android ?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Oui. L’application Sparklin est disponible sur l’App Store (iOS) et le Google Play Store (Android). Elle permet aux utilisateurs de démarrer et arrêter leurs sessions de recharge, de suivre leur consommation en temps réel et de payer directement depuis leur smartphone.</p></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- COLLABORATEURS -->
    <div id="collaborateurs" style="scroll-margin-top:140px;margin-top:56px;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid var(--border);">
        <div style="width:40px;height:40px;border-radius:10px;background:rgba(232,86,58,.1);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;">🏠</div>
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:700;color:var(--dark);margin:0;" data-i18n="footer.lnk.collab"><?= tr('footer.lnk.collab') ?></h2>
      </div>
      <div class="faq-layout">
        <div class="faq-list">
          <div class="faq-item">
            ...
            <div class="faq-answer"><p>La Spark Plus est branch&eacute;e directement sur le circuit &eacute;lectrique du domicile et d&eacute;tect&eacute;e comme source d&eacute;di&eacute;e par son compteur MID int&eacute;gr&eacute;. Elle ne mesure que l&rsquo;&eacute;nergie qu&rsquo;elle d&eacute;livre elle-m&ecirc;me &agrave; la voiture. La consommation du foyer (lumi&egrave;re, &eacute;lectrom&eacute;nager, etc.) n&rsquo;est pas incluse dans le comptage.</p></div>
          </div>
          <div class="faq-item">
            ...
            <div class="faq-answer"><p>La grande majorit&eacute; des installations r&eacute;sidentielles sont compatibles. La Spark Plus fonctionne sur un circuit standard 16A, pr&eacute;sent dans quasiment tous les logements. Nos partenaires installateurs IRVE certifi&eacute;s r&eacute;alisent un diagnostic pr&eacute;alable &agrave; chaque domicile pour confirmer la compatibilit&eacute; et identifier d&rsquo;&eacute;ventuels ajustements n&eacute;cessaires.</p></div>
          </div>
          <div class="faq-item">
            ...
            <div class="faq-answer"><p>L&rsquo;acc&egrave;s du salari&eacute; est d&eacute;sactiv&eacute; en quelques secondes depuis le Spark Pilot, sans intervention physique sur la borne. La prise reste install&eacute;e au domicile et peut &ecirc;tre r&eacute;affect&eacute;e &agrave; un autre collaborateur ou r&eacute;cup&eacute;r&eacute;e selon votre politique interne.</p></div>
          </div>
          <div class="faq-item">
          ...
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)">Sparklin s&rsquo;occupe-t-il du d&eacute;p&ocirc;t des dossiers de subvention&nbsp;?<span class="faq-icon">+</span></button>
            <div class="faq-answer"><p>Oui. L&rsquo;installation de prises domicile dans le cadre d&rsquo;une politique de mobilit&eacute; d&rsquo;entreprise peut &ecirc;tre &eacute;ligible &agrave; des dispositifs d&rsquo;aide (aides r&eacute;gionales, dispositifs CEE). Sparklin accompagne ses clients dans l&rsquo;identification et le montage de ces dossiers avec ses partenaires installateurs certifi&eacute;s IRVE.</p></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- CTA -->
    <div style="margin-top:64px;padding:40px;background:var(--dark);border-radius:20px;text-align:center;">
      <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:var(--orange);margin-bottom:14px;" data-i18n="support.no_answer"><?= tr('support.no_answer') ?></div>
      <h2 style="color:#fff;font-family:var(--font-display);font-size:1.6rem;font-weight:700;margin-bottom:12px;" data-i18n="support.team_reply"><?= tr('support.team_reply') ?></h2>
      <p style="color:rgba(255,255,255,.6);margin-bottom:28px;" data-i18n="support.channels"><?= tr('support.channels') ?></p>
      <a href="/contact/" style="display:inline-flex;align-items:center;gap:8px;background:var(--orange);color:#fff;padding:14px 28px;border-radius:10px;font-size:15px;font-weight:600;text-decoration:none;" data-i18n="ui.contact_support"><?= tr('ui.contact_support') ?></a>
    </div>
