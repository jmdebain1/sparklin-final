...
<head>
  ...
  <title><?= tr('meta.support.title') ?></title>
  <meta name="description" content="<?= tr('meta.support.desc') ?>" data-i18n-meta="meta.support.desc"/>
  ...
  <?php require_once $_SERVER['DOCUMENT_ROOT'].'/includes/seo.php'; sk_seo_head(['title'=>tr('meta.support.title'),'desc'=>tr('meta.support.desc')]); ?>
</head>
<body>
...
<section style="background:var(--bg-white);padding:72px 0 40px;">
  <div class="sk-wrap">
    ...
    <p class="section-body" style="max-width:560px;margin-bottom:56px;">
      <span data-i18n="support.intro"><?= t('support.intro') ?></span> <a href="/contact/" style="color:var(--orange);font-weight:500;" data-i18n="support.contact.label"><?= tr('support.contact.label') ?></a>.
    </p>
    ...
    <div id="spark-plus" style="scroll-margin-top:140px;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid var(--border);">
        ...
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:700;color:var(--dark);margin:0;" data-i18n="support.splus.h2"><?= t('support.splus.h2') ?></h2>
      </div>
      <div class="faq-layout">
        <div class="faq-list">
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.splus.q1"><?= t('support.splus.q1') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.splus.a1"><?= t('support.splus.a1') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.splus.q2"><?= t('support.splus.q2') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.splus.a2"><?= t('support.splus.a2') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.splus.q3"><?= t('support.splus.q3') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.splus.a3"><?= t('support.splus.a3') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.splus.q4"><?= t('support.splus.q4') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.splus.a4"><?= t('support.splus.a4') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.splus.q5"><?= t('support.splus.q5') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.splus.a5"><?= t('support.splus.a5') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.splus.q6"><?= t('support.splus.q6') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.splus.a6"><?= t('support.splus.a6') ?></p></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="spark-go-e" style="scroll-margin-top:140px;margin-top:56px;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid var(--border);">
        <div style="width:40px;height:40px;border-radius:10px;background:rgba(232,86,58,.1);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;">🔋</div>
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:700;color:var(--dark);margin:0;" data-i18n="support.goe.h2"><?= t('support.goe.h2') ?></h2>
      </div>
      <div class="faq-layout">
        <div class="faq-list">
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.goe.q1"><?= t('support.goe.q1') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.goe.a1"><?= t('support.goe.a1') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.goe.q2"><?= t('support.goe.q2') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.goe.a2"><?= t('support.goe.a2') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.goe.q3"><?= t('support.goe.q3') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.goe.a3"><?= t('support.goe.a3') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.goe.q4"><?= t('support.goe.q4') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.goe.a4"><?= t('support.goe.a4') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.goe.q5"><?= t('support.goe.q5') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.goe.a5"><?= t('support.goe.a5') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.goe.q6"><?= t('support.goe.q6') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.goe.a6"><?= t('support.goe.a6') ?></p></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="spark-pilot" style="scroll-margin-top:140px;margin-top:56px;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;padding-bottom:16px;border-bottom:2px solid var(--border);">
        ...
        <h2 style="font-family:var(--font-display);font-size:1.5rem;font-weight:700;color:var(--dark);margin:0;" data-i18n="support.pilot.h2"><?= t('support.pilot.h2') ?></h2>
      </div>
      <div class="faq-layout">
        <div class="faq-list">
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.pilot.q1"><?= t('support.pilot.q1') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.pilot.a1"><?= t('support.pilot.a1') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.pilot.q2"><?= t('support.pilot.q2') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.pilot.a2"><?= t('support.pilot.a2') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.pilot.q3"><?= t('support.pilot.q3') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.pilot.a3"><?= t('support.pilot.a3') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.pilot.q4"><?= t('support.pilot.q4') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.pilot.a4"><?= t('support.pilot.a4') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.pilot.q5"><?= t('support.pilot.q5') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.pilot.a5"><?= t('support.pilot.a5') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.pilot.q6"><?= t('support.pilot.q6') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.pilot.a6"><?= t('support.pilot.a6') ?></p></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="collaborateurs" style="scroll-margin-top:140px;margin-top:56px;">
      ...
      <div class="faq-layout">
        <div class="faq-list">
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q1"><?= t('support.collab.q1') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.collab.a1"><?= t('support.collab.a1') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q2"><?= t('support.collab.q2') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.collab.a2"><?= t('support.collab.a2') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q3"><?= t('support.collab.q3') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.collab.a3"><?= t('support.collab.a3') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q4"><?= t('support.collab.q4') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.collab.a4"><?= t('support.collab.a4') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q5"><?= t('support.collab.q5') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.collab.a5"><?= t('support.collab.a5') ?></p></div>
          </div>
          <div class="faq-item">
            <button class="faq-question" onclick="toggleFaq(this)" data-i18n="support.collab.q6"><?= t('support.collab.q6') ?><span class="faq-icon">+</span></button>
            <div class="faq-answer"><p data-i18n="support.collab.a6"><?= t('support.collab.a6') ?></p></div>
          </div>
        </div>
      </div>
    </div>
